...
<div class="header corner full-size padding" style="margin-top:10px;text-align:center;">
    <?php
        ...
        {
            echo ($_ini->cluster($_GET['server'])) ? 'All servers from Cluster ' . $_GET['server'] : 'Server ' .
    $_GET['server'], ' did not respond !';
    }
    # All servers stats
    else
    {
...
<div class="container corner full-size padding">
    ...
    <br/>
    <br/>
    Please check above error message, your <a href="configure.php" class="green">configuration</a> or your server status
    and retry
</div>
<?php
}
...
<div class="container corner full-size padding">
    <span class="left">Error message</span>
    <br/>
    Maybe this server is not used, check your <a href="configure.php" class="green">configuration</a> or your server
    status and retry
</div>
<?php
}
