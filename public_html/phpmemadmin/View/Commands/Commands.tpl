<div style="float:left;">
    ...
    <div class="container corner full-size padding">
        <pre id="container" style="font-size:11px;overflow:auto;min-height:180px;max-height:500px;"
             class="full-size"></pre>
    </div>
                    ...
                    <form action="commands.php" onsubmit="return false">
                        ...
                        <div class="line" style="text-align:center;">
                            ...
                            <input class="header" type="submit"
                                   onclick="javascript:executeCommand('container');javascript:this.blur();"
            ...
            <tr valign="top">
                <td class="size-0 padding" style="padding-right:14px;">
                    ...
                    <div class="line" style="text-align:center;">
                        <hr/>
                        <input class="header" type="submit"
                               onclick="javascript:executeTelnet('container');javascript:this.blur();"
                               value="Execute Telnet Command"/>
                    </div>
                </td>
                <td class="padding" style="border-left:1px solid #ffffff;padding-left:14px;">
                    ...
                    <a href="http://github.com/memcached/memcached/blob/master/doc/protocol.txt" target="_blank"><span
    ...
    <div class="container corner full-size padding">
        <table>
            <tr valign="top">
                ...
                <td class="padding" style="border-left:1px solid #ffffff;padding-left:14px;">
                    <span class="red">Warning !</span><br/>This thing is only for debuging issue, do not use it in a
                    production environment as it can lock
                    or impact your memcached servers performances.
                    <br/>Also keep in mind that it does not list all keys. It lists keys up to a certain buffer size (1
                    or 2MB), and it list key that are expired.
                    <br/>
