...
**](https://clue.engineering/2020/introducing-ipv6-for-reactphp).
...
* Feature / Fix: Improve TLS 1.3 support.
  ...
  For example, this version ships with Ubuntu 18.10 (and newer) by default, meaning that recent installations support
  TLS 1.3 out of the box :shipit:
