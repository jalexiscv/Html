...
En la respuesta de transmisión, la función de devolución de llamada se llamará cada vez que se reciba una respuesta del
servidor. Las respuestas largas pueden dividirse en respuestas separadas, y puede comenzar a recibir respuestas más
rápido utilizando una transmisión de contenido.
```php
use GeminiAPI\Client;
use GeminiAPI\Resources\ModelName;
use GeminiAPI\Resources\Parts\TextPart;
