...
$chatGPT = new ChatGPT("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", $curlHandler, $cache);
$googleTranslator = new GoogleTranslator("AIzaSyApWZ9BWHUO8-HZrP5qla87kCEVEqix6YE", $curlHandler, $cache);
