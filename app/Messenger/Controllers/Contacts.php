...
class Contacts extends ModuleController
{
    ...
    {
        parent::__construct();
        $this->prefix = 'messenger-contacts';
    ...
    public function view(string $oid)
    {
        ...
        $this->component = $this->views . '\Contacts\View';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function list(string $rnd)
    {
        ...
        $this->component = $this->views . '\Contacts\List';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function create(string $rnd)
    {
        ...
        $this->component = $this->views . '\Contacts\Create';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function edit(string $oid)
    {
        ...
        $this->component = $this->views . '\Contacts\Edit';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function delete(string $oid)
    {
        ...
        $this->component = $this->views . '\Contacts\Delete';
        return (view($this->viewer, $this->get_Array()));
    }
