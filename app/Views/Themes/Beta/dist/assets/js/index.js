...
import {HeatGraph} from "./heatgraphs.js?v=8719000844";      // Renderiza gráficos de mapa de calor.
import {SidebarStart} from "./sidebarstart.js?v=8719000844";  // Controla la barra lateral izquierda.
import {SidebarEnd} from "./sidebarend.js?v=8719000844";      // Controla la barra lateral derecha.
import {Messenger} from "./messenger.js?v=8719000844";        // Gestiona la mensajería en tiempo real.
import {Apexcharts} from "./apexcharts.js?v=8719000844";       // Renderiza gráficos avanzados.
import {Crypt} from "./crypt.js?v=8719000844";                // Utilidades de encriptación.
import {Ui} from "./ui.js?v=8719000844";                     // Lógica general de la interfaz de usuario.
import {Excel} from "./excel.js?v=8719000844";               // Funcionalidades para exportar a Excel.
import {Modals} from "./modals.js?v=8719000844";              // Gestiona la interactividad de los modales.
