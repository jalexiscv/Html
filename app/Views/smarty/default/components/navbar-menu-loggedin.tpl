<div class="navbar-menu collapse navbar-collapse navbar-backdrop" id="navbarMenu">
    ...
    <div class="navbar-nav">
        <ul class="nav">
                        ...
                        <div class="col-lg-4 col-12 p-4 dropdown-clickable">
                            ...
                            <form class="my-3">
                                ...
                                <div class="form-group mb-4">
                                    <textarea class="form-control brc-primary-m2 border-l-2 text-grey-d1" rows="3"
                                              placeholder="Your message..."></textarea>
                                </div>

                                <div class="text-center">
                                    <button type="reset" class="btn btn-smd btn-wide btn-secondary text-110">Reset
                                    </button>
                                    <button type="button" class="btn btn-smd btn-wide btn-primary text-110">Send
                                    </button>
                                </div>
                            </form>
            ...
            <li class="nav-item dropdown dropdown-mega">
                <a class="nav-link dropdown-toggle pl-lg-3 pr-lg-4" data-toggle="dropdown" href="#" role="button"
                   aria-haspopup="true" aria-expanded="false">
                ...
                <div class="shadow dropdown-menu dropdown-animated animated-1 dropdown-xs p-0 bg-white brc-warning-l1 border-x-1 border-b-1">
                    ...
                    <div class="px-4 py-2">
                        ...
                        <div class="progress mt-2">
                            <div class="progress-bar bgc-info" role="progressbar" style="width: 60%;" aria-valuenow="60"
            ...
            <li class="nav-item dropdown order-first order-lg-last">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
                   aria-expanded="false">
                    <img id="id-navbar-user-image"
                         class="d-none d-lg-inline-block radius-round border-2 brc-white-tp1 mr-2" src="{$avatar}"
                         alt="{$alias}" width="36">
                    <span class="d-inline-block d-lg-none d-xl-inline-block">
                        <span class="text-90" id="id-user-welcome">{lang("App.Welcome")},</span>
                        <span class="nav-user-name">@{$alias}</span>
                    </span>
                ...
                <div class="dropdown-menu dropdown-caret dropdown-menu-right dropdown-animated brc-primary-m3">
                    ...
                    <a href="/social/users/view/{$alias}?session={session_id()}"
                       class="dropdown-item btn btn-outline-grey btn-h-lighter-primary btn-a-lighter-primary">
                        <i class="fa fa-user text-primary-m1 text-105 mr-1"></i>{Lang("App.Profile")}
                    </a>
                    <a class="dropdown-item btn btn-outline-grey btn-h-lighter-success btn-a-lighter-success" href="#"
                       data-toggle="modal" data-target="#id-ace-settings-modal"><i
                                class="fa fa-cog text-success-m1 text-105 mr-1"></i>{Lang("App.Settings")}</a>
                    ...
                    <a class="dropdown-item btn btn-outline-grey btn-h-lighter-secondary btn-a-lighter-secondary"
                       data-toggle="modal" data-target="#modal-logout"><i
                                class="fa fa-power-off text-warning-d1 text-105 mr-1"></i>{Lang("App.Logout")}</a>
                </div>
            </li><!-- /.nav-item:last -->
