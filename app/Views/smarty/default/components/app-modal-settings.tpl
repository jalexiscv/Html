<div id="id-ace-settings-modal" class="my-1 my-lg-2 modal modal-nb ace-aside aside-right aside-offset aside-below-nav"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content w-auto flex-grow-1 pb-1px radius-0 radius-l-2 border-y-2 border-l-1 brc-default-m3 bgc-white-tp1 shadow">
            ...
            <div class="modal-body mx-md-2" ace-scroll='{literal}{"smooth": true, "lock": true}{/literal}'>
                        ...
                        <div class="bgc-secondary-tp2 radius-1 py-1 px-1 mb-3 mt-1 text-center">
                            <div class="d-flex btn-group btn-group-toggle align-self-end flex-wrap justify-content-center mx-auto align-items-center my-2 flex-equal-sm"
                                ...
                                <label class="active btn btn-xs border-0 sidebar-lightblue d-style my-1px">
                                    ...
                                    <input type="radio" name="sidebar-light" value="lightblue" autocomplete="off"
                                           checked/>
                                </label>
                        ...
                        <div class="bgc-secondary-tp2 radius-1 py-1 px-1 mb-3 mt-1 text-center">
                            <div class="d-flex btn-group btn-group-toggle align-self-end flex-wrap justify-content-center mx-auto align-items-center my-2 flex-equal-sm"
                                ...
                                <label class="active btn btn-xs border-0 navbar-lightblue d-style my-1px">
                                    <i class="fa fa-check text-muted v-active"></i>
                                    <input type="radio" name="navbar-light" value="lightblue" autocomplete="off"
                                           checked/>
                                </label>
                    ...
                    <div class="mt-2 d-none d-xl-flex flex-column flex-md-row justify-content-md-between align-items-md-center">
                        ...
                        <div class="w-50 btn-group btn-group-toggle flex-row flex-wrap fl1ex-md-nowrap"
                            ...
                            <label class="btn btn-sm btn-outline-info rounded-0 mx-0 mt-n1px active">
                                Only Content
                                <input type="radio" name="boxed-layout" value="only-content" autocomplete="off"
                                       checked/>
                            </label>
                        </div>
                    </div>
                ...
                <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center">
                    ...
                    <div class="align-self-end w-75">
                        <select autocomplete="off" id="id-change-font"
                    ...
                    <div class="mt-2 d-none d-xl-flex justify-content-between align-items-center">
                        ...
                        <div class="btn-group btn-group-toggle flex-row" data-toggle="buttons">
                            <label class="btn btn-sm btn-outline-red active mx-0">
                                Expand
                                <input type="radio" name="sidebar-collapsed" value="expandable" autocomplete="off"
                                       checked/>
                            </label>
        ...
        <div class="aside-header align-self-start mt-1 mt-md-5 text-right">
            <button type="button" class="btn btn-warning btn-lg shadow-sm pl-2 radius-l-2" data-toggle="modal"
