<!--[social-modals-signin-signup]-->
<div class="position-tl ml-3 mt-0 mt-lg-0">
    <a href="#" class="btn btn-light-default btn-h-light-default btn-a-light-default btn-bgc-tp" data-toggle="tab"
...
<div class="d-lg-none text-secondary-m1 my-0 text-center">
    <i class="fa fa-leaf text-success-m2 text-200 mb-0"></i>
    <h1 class="text-170">
...
<form autocomplete="off" class="form-row mt-0">
    <div class="form-group col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
        <div class="d-flex align-items-center input-floating-label text-success brc-success-m2">
            <input placeholder="Email" type="email" class="form-control form-control-lg pr-4 shadow-none"
                   id="id-signup-email"/>
    ...
    <div class="form-group col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 mt-0">
        <div class="d-flex align-items-center input-floating-label text-success brc-success-m2">
            <input placeholder="Username" type="text" class="form-control form-control-lg pr-4 shadow-none"
    ...
    <div class="form-group col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 mt-0">
        <div class="d-flex align-items-center input-floating-label text-success brc-success-m2">
            <input placeholder="Password" type="password" class="form-control form-control-lg pr-4 shadow-none"
    ...
    <div class="form-group col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 mt-0">
        <div class="d-flex align-items-center input-floating-label text-success brc-success-m2">
            <input placeholder="Confirm Password" type="password" class="form-control form-control-lg pr-4 shadow-none"
    ...
    <div class="form-group col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 mt-0">
        <label class="d-inline-block mt-0 mb-0 text-secondary-d2">
        ...
        <button type="button" class="btn btn-success btn-block px-4 btn-bold mt-0 mb-0">
            Sign Up
        </button>
    </div>
</form>
...
<div class="form-row w-100">
    <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 d-flex flex-column align-items-center justify-content-center">
        ...
        <hr class="brc-default-l2 mt-0 mb-0 w-100"/>

        <div class="p-0 px-md-2 text-dark-tp4 my-0">
            Already a member?
        ...
        <hr class="brc-default-l2 w-100 mb-0"/>
        <div class="mt-n4 bgc-white-tp2 px-3  text-secondary-d3 text-90">Or Register Using</div>
