<div class="main-container">
    ...
    <div role="main" class="main-content">
        ...
        {if $main_template=="c8c4"}
            {include file="social/mains/c8c4.tpl"}
        {elseif $main_template=="c6c6"}
            {include file="social/mains/c6c6.tpl"}
        {elseif $main_template=="c9c3"}
            {include file="social/mains/c9c3.tpl"}
        {elseif $main_template=="c10c2"}
            {include file="social/mains/c10c2.tpl"}
        {elseif $main_template=="c6c3c3"}
            {include file="social/mains/c6c3c3.tpl"}
        {elseif $main_template=="c12"}
            {include file="social/mains/c12.tpl"}
        {elseif $main_template=="user-profile"}
            {include file="users/profile.tpl"}
        {else}
            {include file="social/mains/c0c0.tpl"}
        {/if}
