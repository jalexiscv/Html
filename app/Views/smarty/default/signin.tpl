...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{base_url("themes/default/application/views/default/pages/partials/page-login/@page-style.css")}">
</head>
<body>
{if isset($page_trace)}
    {$page_trace}
...
<div class="body-container">
                                        ...
                                        <div class="carousel-item active minw-100 h-100">
                                            ...
                                            <div style="background-image: url(assets/image/login-bg-1.svg);"
                                                ...
                                                <div class="mt-5 mx-4 text-120 text-dark-tp4 text-justify">
                                                    Join our community to make friends,<br/> meet experts &amp; receive
                                                    exclusive offers!
                                                    <hr class="mb-1"/>
                                                    <div>
                            ...
                            <div class="col-12 col-lg-7 py-lg-5 bgc-white px-0">
                                ...
                                <div class="tab-content tab-sliding border-0 p-0" data-swipe="right">
                                    <div class="tab-pane active show mh-100 px-3 px-lg-0 pb-3" id="id-tab-login">
                                        ...
                                        {form_open('signin',array("class"=>"form-row mt-4"))}
                                        <input type="hidden" name="submited" value="{time()}"/>
                                        {if isset($page_message)}
                                            <div class="form-group col-md-6 offset-md-3">
                                                <div class="d-flex align-items-center input-floating-label text-blue-m1 brc-blue-m2">
                                                    {if $page_message["type"]=="error"}
                                                        {include file="alerts/light-danger.tpl" message=$page_message["message"]}
                                                    {/if}
                                                </div>
                                            </div>
                                        {/if}
                                        <div class="form-group col-md-6 offset-md-3">
                                            <div class="d-flex align-items-center input-floating-label text-blue-m1 brc-blue-m2">
                                                {if isset($smarty.post.user)}
                                                    <input value="{$smarty.post.user}" name="user" type="text"
                                                ...
                                                <label class="floating-label text-grey-l1 text-100 ml-n3"
                                                       for="id-login-username">{lang("App.Username")}</label>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6 offset-md-3 mt-2 mt-md-1">
                                            <div class="d-flex align-items-center input-floating-label text-blue-m1 brc-blue-m2">
                                                ...
                                                <label class="floating-label text-grey-l1 text-100 ml-n3"
                                                       for="id-login-password">{lang("App.Password")}</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-12 col-md-6 offset-md-3 d-flex flex-column align-items-center justify-content-center">
                                                ...
                                                <div class="mt-n4 bgc-white-tp2 px-3 py-1 text-default-d1 text-90">{lang("App.Or-Get-Started-Using")}</div>
                                                <div class="my-2">
                                                    <button type="button"
                                    ...
                                    <div class="tab-pane mh-100 px-3 px-lg-0 pb-3" id="id-tab-signup"
                                        ...
                                        <div class="position-tl ml-3 mt-3 mt-lg-0">
                                            <a href="#" class="btn btn-light-default bg-transparent" data-toggle="tab"
                                               data-target="#id-tab-login"><i class="fa fa-arrow-left"></i></a>
                                        </div>
                                        <div class="d-none d-lg-block col-md-6 offset-md-3 mt-lg-4 px-0">
                                            <h4 class="text-dark-tp4 border-b-1 brc-grey-l1 pb-1 text-130">
                                        ...
                                        <form action="{current_url()}" method="POST" class="form-row mt-4">
                                    ...
                                    Premium
                                            ...
                                            <div class="form-group col-md-6 offset-md-3 mt-2">
                                                <label class="d-inline-block mt-3 mb-0 text-secondary-d2">
                                                    ...
                                                    <span class="text-secondary-d2">I have read and agree to <a href="#"
                                                                                                                class="text-blue">terms</a></span>
                                                </label>
                                        ...
                                        <div class="form-row w-100">
                                            <div class="col-12 col-md-6 offset-md-3 d-flex flex-column align-items-center justify-content-center">
                                                ...
                                                <hr class="brc-default-m4 w-100 mb-2"/>
                                                <div class="mt-n4 bgc-white-tp2 px-3 py-1 text-default-d1 text-90">Or
                                                    Register Using
                                                </div>
                                                <div class="mt-2 mb-3">
                                                    <button type="button"
    ...
    <script type="text/javascript"
            src="{base_url("themes/default/application/views/default/pages/partials/page-login/@page-script.js")}"></script>
</div><!-- /.body-container -->
</body>
</html>