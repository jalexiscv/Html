{if isset($css)}
<div class="alert alert-danger bgc-danger-l3 brc-danger-m2 d-flex align-items-center {$css}" role="alert">
    {else}
    <div class="alert alert-danger bgc-danger-l3 brc-danger-m2 d-flex align-items-center" role="alert">
        {/if}
