    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active" data-href="{$slide["link"]}">
            ...
            <div class="carousel-item" data-href="{$slide["link"]}">
                {/if}
                <div class="over"></div>
                <img src="https://storage.googleapis.com/cloud-engine{$slide["portrait"]}" class="w-100"/>
                <div class="container">
                    <div class="carousel-caption text-center visually-hidden">
                        <h2 class="visually-hidden">{$slide["title"]}</h2>
                        <p class="visually-hidden">{$slide["description"]}</p>
                        {if $slide["link"]}
                            <a class="ads-link stretched-link" href="{$slide["link"]}">Más
                                información</a>
                        {/if}
                    </div>
                </div>
