<div class="card-zensspace pt-4 px-0">
    <div class="card-header zenspace-card-header justify-content-center text-center"><b>Advertencia</b></div>
    <div class="card-block special-card pt-3 py-0">
        <center>
            <i class="fas fa-exclamation-triangle fa-4x text-warning-d4 float-left mr-4 mt-1 mb-4"></i>
        </center>
