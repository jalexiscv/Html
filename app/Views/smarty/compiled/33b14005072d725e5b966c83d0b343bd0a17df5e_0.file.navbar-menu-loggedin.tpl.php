...
/* Smarty version 3.1.36, created on 2020-11-08 07:39:01
  from 'C:\xampp\htdocs\Higgs-dominance\app\Views\smarty\default\components\navbar-menu-loggedin.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array(
    'version' => '3.1.36',
    'unifunc' => 'content_5fa7e6e5667c59_89205140',
    'has_nocache_code' => false,
    'file_dependency' =>
        array(
            '33b14005072d725e5b966c83d0b343bd0a17df5e' =>
                array(
                    0 => 'C:\\xampp\\htdocs\\Higgs-dominance\\app\\Views\\smarty\\default\\components\\navbar-menu-loggedin.tpl',
                    1 => 1603112501,
                    2 => 'file',
                ),
        ),
    ...
    function content_5fa7e6e5667c59_89205140(Smarty_Internal_Template $_smarty_tpl)
    {
        ?>
                            ...
                            <div class="row mx-0">
                                ...
                                <div class="col-lg-4 col-12 p-2 p-lg-3 p-xl-4 d-flex align-items-center">
                                    <div class="list-group mt-3 mx-auto px-0">
                                        ...
                                        <a href="#"
                                           class="list-group-item list-group-item-action bgc-success-l1 bgc-h-success-l2">
                                ...
                                <div class="bgc-white col-lg-4 col-12 p-4">
                                    <h5 class="text-blue-m1">
                                        <i class="fas fa-bullhorn mr-1 text-grey-m2"></i>
                                        Notifications
                                    </h5>

                                    <div>
                                        <div class="media mt-2 px-3 pt-1 border-l-2 brc-purple-m2">
                                            <span class="d-block bgc-purple-tp2 radius-1 mr-3 p-3"><i
                                                        class="fa fa-user text-white text-150"></i></span>
                                        ...
                                        <div class="media mt-2 px-3 pt-1 border-l-2 brc-warning-m2">
                                            <span class="d-block bgc-warning-tp2 radius-1 mr-3 p-3"><i
                                                        class="fa fa-user text-white text-150"></i></span>
                                            <div class="media-body pb-0 mb-0 text-90 text-muted">
                                        ...
                                        <div class="media mt-2 px-3 pt-1 border-l-2 brc-success-m2">
                                            <span class="d-block bgc-success-tp2 radius-1 mr-3 p-3"><i
                                                        class="fa fa-user text-white text-150"></i></span>
                                            <div class="media-body pb-0 mb-0 text-90 text-muted">
                                ...
                                <div class="col-lg-4 col-12 p-4 dropdown-clickable">
                                    ...
                                    <form class="my-3">
                                        ...
                                        <div class="text-center">
                                            <button type="reset" class="btn btn-smd btn-wide btn-secondary text-110">
                                                Reset
                                            </button>
                                            <button type="button" class="btn btn-smd btn-wide btn-primary text-110">
                                                Send
                                            </button>
                                        </div>
                                    </form>
                        ...
                        <a class="nav-link dropdown-toggle pl-lg-3 pr-lg-4" data-toggle="dropdown" href="#"
                           role="button" aria-haspopup="true" aria-expanded="false">
                            ...
                            <span id="id-navbar-badge1"
                                  class="badge badge-sm badge-warning radius-round text-80 border-1 brc-white-tp5">3</span>
                        ...
                        <div
                            ...
                            <div class="tab-content tab-sliding p-0">
                                ...
                                <div class="tab-pane mh-none show active px-md-1 pt-1" id="navbar-notif-tab-1"
                                    ...
                                    <a href="#"
                                       class="mb-0 py-3 border-0 list-group-item text-blue-m2 text-uppercase text-center text-85 font-bold">
                                    ...
                                    <div ace-scroll=''>
                                        <a href="#"
                                           class="d-flex mb-0 border-0 list-group-item list-group-item-action btn-h-lighter-secondary">
                                            <img src="/themes/bs5/img/avatars/avatar-neutral.png" width="48"
                                        ...
                                        <a href="#"
                                           class="d-flex mb-0 border-0 list-group-item list-group-item-action btn-h-lighter-secondary">
                                            <img src="/themes/default/assets/image/avatar/avatar3.png" width="48"
                                                 class="align-self-start border-2 brc-primary-m3 p-1px mr-2 radius-round"/>
                                            <div>
                                        ...
                                        <a href="#"
                                           class="d-flex mb-0 border-0 list-group-item list-group-item-action btn-h-lighter-secondary">
                                            <img src="/themes/default/assets/image/avatar/avatar4.png" width="48"
                                                 class="align-self-start border-2 brc-primary-m3 p-1px mr-2 radius-round"/>
                                            <div>
                                        ...
                                        <a href="#"
                                           class="d-flex mb-0 border-0 list-group-item list-group-item-action btn-h-lighter-secondary">
                                            <img src="/themes/default/assets/image/avatar/avatar2.png" width="48"
                                                 class="align-self-start border-2 brc-primary-m3 p-1px mr-2 radius-round"/>
                                            <div>
                                        ...
                                        <a href="#"
                                           class="d-flex mb-0 border-0 list-group-item list-group-item-action btn-h-lighter-secondary">
                                            <img src="/themes/default/assets/image/avatar/avatar5.png" width="48"
                                                 class="align-self-start border-2 brc-primary-m3 p-1px mr-2 radius-round"/>
                                            <div>
                                                <span class="text-blue-m1 font-bolder">Fred:</span>
                                                <span
                                                        class="text-grey text-90">Vestibulum id penatibus et auctor  ...</span>
                                                <br/>
                                                <span class="text-grey-m2 text-85">
                                                  <i class="far fa-clock"></i>
                                                  10:09 am
                        ...
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"
                           aria-haspopup="true" aria-expanded="false">
                            <img id="id-navbar-user-image"
                                 class="d-none d-lg-inline-block radius-round border-2 brc-white-tp1 mr-2"
                                 src="<?php echo $_smarty_tpl->tpl_vars['avatar']->value; ?>
" alt="<?php echo $_smarty_tpl->tpl_vars['alias']->value; ?>
" width="36">
                            <span class="d-inline-block d-lg-none d-xl-inline-block">
                        <span class="text-90" id="id-user-welcome"><?php echo lang("App.Welcome"); ?>
,</span>
                        <span class="nav-user-name">@<?php echo $_smarty_tpl->tpl_vars['alias']->value; ?>
</span>
                    </span>
                        ...
                        <div class="dropdown-menu dropdown-caret dropdown-menu-right dropdown-animated brc-primary-m3">
                            <div class="d-none d-lg-block d-xl-none">
                                <div class="dropdown-header">
                                    @<?php echo $_smarty_tpl->tpl_vars['alias']->value; ?>

                                </div>
                                <div class="dropdown-divider"></div>
                            </div>

                            <a href="/social/users/view/<?php echo $_smarty_tpl->tpl_vars['alias']->value; ?>
?session=<?php echo session_id(); ?>
" class="dropdown-item btn btn-outline-grey btn-h-lighter-primary btn-a-lighter-primary">
                                <i class="fa fa-user text-primary-m1 text-105 mr-1"></i><?php echo Lang("App.Profile"); ?>

                            </a>
                            <a class="dropdown-item btn btn-outline-grey btn-h-lighter-success btn-a-lighter-success"
                               href="#" data-toggle="modal" data-target="#id-ace-settings-modal"><i
                                        class="fa fa-cog text-success-m1 text-105 mr-1"></i><?php echo Lang("App.Settings"); ?>
                            </a>
                            ...
                            <a class="dropdown-item btn btn-outline-grey btn-h-lighter-secondary btn-a-lighter-secondary"
                               data-toggle="modal" data-target="#modal-logout"><i
                                        class="fa fa-power-off text-warning-d1 text-105 mr-1"></i><?php echo Lang("App.Logout"); ?>
                            </a>
                        </div>
                    </li><!-- /.nav-item:last -->
        ...
        </div><!-- /.navbar-menu.navbar-collapse --><?php }
}
