...
$chead->assign("image", "/themes/assets/images/logos/modulo-history.png");
...
$options = array(
    array("href" => "/history/general/list/" . lpk(), "title" => "Historial", "icon" => "fa-history"),
    array("href" => "/history/user/list/" . lpk(), "title" => "Usuarios", "icon" => "fa-pennant"),
);
...
foreach ($options as $option) {
    ...
    $card->assign("body", "<i class=\"icon-grayblue far {$option["icon"]} fa-4x\"></i>");
    $card->assign("footer", "<a href=\"{$option["href"]}\" class=\"w-100 btn btn-lg btn-outline-grayblue\">Acceder</a>");
