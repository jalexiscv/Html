...
$table = array(
    'id' => 'table-' . lpk(),
    'data-url' => '/application/api/stats/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('text' => lang('App.Create'), 'href' => '/application/stats/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'stat' => array('text' => lang('App.stat'), 'class' => 'text-center'),
        'instance' => array('text' => lang('App.instance'), 'class' => 'text-center'),
        'module' => array('text' => lang('App.module'), 'class' => 'text-center'),
        'object' => array('text' => lang('App.object'), 'class' => 'text-center'),
        'ip' => array('text' => lang('App.ip'), 'class' => 'text-center'),
        ...
        'log' => array('text' => lang('App.log'), 'class' => 'text-center'),
...
$smarty->assign('header', lang('Application.stats-list-title'));
$smarty->assign('body', '');
