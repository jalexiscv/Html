...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Application.stats-edit-errors-title"));
    $cerrors->assign("message", lang("Application.stats-edit-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "application/stats-edit-errors-message.mp3");
