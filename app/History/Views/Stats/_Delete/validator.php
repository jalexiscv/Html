...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Application.stats-delete-errors-title"));
    $cerrors->assign("message", lang("Application.stats-delete-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "application/stats-delete-errors-message.mp3");
