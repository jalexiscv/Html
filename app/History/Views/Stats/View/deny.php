...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Application.stats-view-denied-title"));
    $smarty->assign("message", lang("Application.stats-view-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "application/stats-view-denied-message.mp3");
