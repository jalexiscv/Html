...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Application\Views\Stats\List\index.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$data['permissions'] = array('singular' => false, "plural" => 'history-stats-view-all');
...
history_logger(array(
    ...
    "reference" => "COMPONENT",
    "object" => "GENERAL",
    "log" => "El usuario accede al <a href=\"/history/general/list/{$oid}\" target=\"_blank\"> listado histórico general</a> del Módulo History",
));
/*
* -----------------------------------------------------------------------------
* [Build]
