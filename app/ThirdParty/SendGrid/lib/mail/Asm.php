...
class Asm implements JsonSerializable
{
    ...
    public function setGroupId($group_id)
    {
        if ($group_id instanceof GroupId) {
            ...
            if (!is_int($group_id)) {
                throw new TypeException('$group_id must be an instance of Twilio SendGrid\Mail\GroupId or of type int.');
            }
    ...
    public function setGroupsToDisplay($groups_to_display)
    {
        if ($groups_to_display instanceof GroupsToDisplay) {
            ...
            if (!is_array($groups_to_display)) {
                throw new TypeException('$groups_to_display must be an instance of Twilio SendGrid\Mail\GroupsToDisplay or of type array.');
            }
