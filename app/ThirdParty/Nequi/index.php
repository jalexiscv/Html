...
<div class="content p-2">
    ...
    <p>
        A continuación podrás encontrar ejemplos prácticos de cómo integrarte con Nequi Conecta, las API y servicios de
        última generación que Nequi tiene para tu negocio.
    </p>
</div>
<div class="columns is-desktop">
    ...
    <div class="column is-half-desktop">
        <div class="container p-2">
            ...
            <h2 class="subtitle is-6">A continuación puede ver sus variables de configuración, asegúrese de que todas
                tengan un valor correcto.</h2>
            <fieldset disabled>
                <div class="field is-horizontal">
                    ...
                    <div class="field-body">
                        <div class="field">
                            <div class="control">
                                <input value="<?php echo $appCfg->getClientId() ?>" class="input is-small" type="text"
                ...
                <div class="field is-horizontal">
                    ...
                    <div class="field-body">
                        <div class="field">
                            <div class="control">
                                <input value="<?php echo $appCfg->getClientSecret() ?>" class="input is-small"
                                       type="text" placeholder="Small sized input">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="field is-horizontal">
                    ...
                    <div class="field-body">
                        <div class="field">
                            <div class="control">
                                <input value="<?php echo $appCfg->getAuthUri() ?>" class="input is-small" type="text"
                                       placeholder="Small sized input">
                            </div>
                        </div>
                    </div>
                ...
                <div class="field is-horizontal">
                    ...
                    <div class="field-body">
                        <div class="field">
                            <div class="control">
                                <input value="<?php echo $appCfg->getApiBasePath() ?>" class="input is-small"
                                       type="text" placeholder="Small sized input">
                            </div>
                        </div>
                    </div>
