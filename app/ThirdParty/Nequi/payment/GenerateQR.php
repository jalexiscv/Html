...
class GenerateQR
{
    ...
    public static function call()
    {
        ...
        $headers = array('Content-Type' => 'application/json', 'Accept' => 'application/json', 'Authorization' => $authController->getToken(true), 'x-api-key' => $appCfg->getApiKey());
        $endpoint = $appCfg->getApiBasePath() . self::RestEndpoint;
        $body = json_encode(array('RequestMessage' => array('RequestHeader' => array('Channel' => 'PQR03-C001', 'RequestDate' => '2020-01-14T10:26:12.654Z', 'MessageID' => '1234567890', 'ClientID' => $appCfg->getClientId(), 'Destination' => array('ServiceName' => 'PaymentsService', 'ServiceOperation' => 'generateCodeQR', 'ServiceRegion' => 'C001', 'ServiceVersion' => '1.2.0')), 'RequestBody' => array('any' => array('generateCodeQRRQ' => array('code' => 'NIT_1', 'value' => '10000', 'reference1' => 'Referencia numero 1', 'reference2' => 'Referencia numero 2', 'reference3' => 'Referencia numero 3'))))));
