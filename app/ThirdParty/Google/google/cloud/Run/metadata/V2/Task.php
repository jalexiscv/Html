...
status (2.google.rpc.StatusB�A
	exit_code (B�A2�
Tasks�
GetTask#.google.cloud.run.v2.GetTaskRequest.google.cloud.run.v2.Task"L�Aname���?=/v2/{name=projects/*/locations/*/jobs/*/executions/*/tasks/*}�
	ListTasks%.google.cloud.run.v2.ListTasksRequest&.google.cloud.run.v2.ListTasksResponse"N�Aparent���?=/v2/{parent=projects/*/locations/*/jobs/*/executions/*}/tasksF�Arun.googleapis.com�A.https://www.googleapis.com/auth/cloud-platformBQ
