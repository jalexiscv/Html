...
planned_location
 (2*.maps.fleetengine.delivery.v1.LocationInfoB�AD
target_time_window
 (2(.maps.fleetengine.delivery.v1.TimeWindow?

attributes (2+.maps.fleetengine.delivery.v1.TaskAttribute:b�A_
+fleetengine.googleapis.com/TaskTrackingInfo0providers/{provider}/taskTrackingInfo/{tracking}B�
#google.maps.fleetengine.delivery.v1BTaskTrackingInfoProtoPZIcloud.google.com/go/maps/fleetengine/delivery/apiv1/deliverypb;deliverypb�CFED�#Google.Maps.FleetEngine.Delivery.V1�#Google\\Maps\\FleetEngine\\Delivery\\V1�\'Google::Maps::FleetEngine::Delivery::V1bproto3'
            , true);
