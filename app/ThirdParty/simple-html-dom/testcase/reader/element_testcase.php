...
assert($dom->find('div', 0) == $str);
$str = <<<HTML
<html><head><script async src="https://arc.io/widget.min.js#egTcsPVR"></script></head><body><br><span>foo</span></body></html>
HTML;
$dom->load($str);
assert($dom == $str);
$str = <<<HTML
<html><head><script async src="https://arc.io/widget.min.js#egTcsPVR"></script></head><body><br><span>bar</span></body></html>
HTML;
$dom->find('span', 0)->innertext = 'bar';
assert($dom == $str);
$str = <<<HTML
<html><head>ok<script async src="https://arc.io/widget.min.js#egTcsPVR"></script></head><body><br><span>bar</span></body></html>
HTML;
