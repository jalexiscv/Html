...
for ($i = 0; $i < $count; ++$i) {
    ...
    if (((float)$eu + (float)$es - (float)$bu - (float)$bs) * 1000 > $max) $max = ((float)$eu + (float)$es - (float)$bu - (float)$bs) * 1000;
    if (((float)$eu + (float)$es - (float)$bu - (float)$bs) * 1000 < $min) $min = ((float)$eu + (float)$es - (float)$bu - (float)$bs) * 1000;
