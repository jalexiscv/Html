...
$rviews = array(
    ...
    "messenger-denied" => "{$views}\Denied\index",
    "messenger-home" => "{$views}\Home\index",
    //[Messages]----------------------------------------------------------------------------------------
    "messenger-messages-home" => "$views\Messages\Home\index",
    "messenger-messages-inbox" => "$views\Messages\Inbox\index",
    "messenger-messages-outbox" => "$views\Messages\Outbox\index",
    "messenger-messages-list" => "$views\Messages\List\index",
    "messenger-messages-view" => "$views\Messages\View\index",
    "messenger-messages-create" => "$views\Messages\Create\index",
    "messenger-messages-edit" => "$views\Messages\Edit\index",
    "messenger-messages-delete" => "$views\Messages\Delete\index",
    //[others]----------------------------------------------------------------------------------------------------------
);
