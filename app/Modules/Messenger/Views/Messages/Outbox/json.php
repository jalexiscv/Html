 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Messenger\Views\Messages\List\json.php]
...
foreach ($list as $item) {
    //[Buttons]---------------------------------------------------------------------------------------------------------
    $viewer = "{$component}/view/{$item["message"]}";
    $editor = "{$component}/edit/{$item["message"]}";
    $deleter = "{$component}/delete/{$item["message"]}";
