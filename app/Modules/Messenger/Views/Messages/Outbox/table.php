...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/messenger/api/messages/json/outbox/' . lpk(),
    'buttons' => array(
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang('Messages.outbox-list-title'),
    "header-back" => $back,
    "alert" => array("icon" => ICON_INFO,
        "type" => "info",
        "title" => lang('Messages.alert-outbox-list-title'),
        "message" => lang('Messages.alert-outbox-list-message')),
    "content" => $table,
));
echo($card);
?>
