...
$mdm = model("App\Modules\Messenger\Models\Messenger_Modules");
$mdcxm = model("App\Modules\Messenger\Models\Messenger_Clients_Modules");
$module = 'messenger';
...
if ($cxm == "authorized") {
		$routes->group($module,
				['namespace' => $namespace],
				function ($subroutes) {
						$subroutes->add('/', 'Messenger::index');
						$subroutes->add('/home', 'Messenger::index');
						$subroutes->add('home/(:any)', 'Messenger::home/$1');
		...
		$routes->group($module,
				['namespace' => $namespace],
				function ($subroutes) {
						$subroutes->add('/', 'Messenger::denied');
						$subroutes->add('(:any)', 'Messenger::denied');
				}
		);
}
}
