...
return [
    // - Messages fields
    "label_message" => "Código de mensaje",
    "label_type" => "Tipo de mensaje",
    "label_from" => "Remitente",
    "label_to" => "Destinatario",
    "label_subject" => "Asunto",
    "label_content" => "Contenido del mensaje",
    "label_priority" => "Prioridad del mensaje",
    "label_date" => "Fecha de envío",
    "label_time" => "Hora de envío",
    "label_author" => "Autor del mensaje",
    ...
    "help_message" => "Automático",
    "help_type" => "Seleccione una opción",
    "help_from" => "Correo electrónico del remitente",
    "help_to" => "Correo electrónico del destinatario",
    "help_subject" => "Obligatorio",
    "help_content" => "Obligatorio",
    "help_priority" => "Seleccione una opción",
    "help_date" => "Automático",
    "help_time" => "Automático",
    "help_author" => "author",
    ...
    //outbox
    "outbox-list-title" => "Listado de mensajes enviados",
    "alert-outbox-list-title" => "Listado de mensajes enviados",
    "alert-outbox-list-message" => "Listado de mensajes enviados",
];
