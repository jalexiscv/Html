...
$data['model'] = model("App\Modules\Organization\Models\Organization_Macroprocesses");
$data['permissions'] = array('singular' => 'organization-macroprocesses-delete', "plural" => 'organization-macroprocesses-delete-all');
