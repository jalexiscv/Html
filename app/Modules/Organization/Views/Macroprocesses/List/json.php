...
//[Asignations]---------------------------------------------------------------------------------------------------------
$data = array();
$component = '/organization/macroprocesses';
foreach ($list as $item) {
    //[Buttons]---------------------------------------------------------------------------------------------------------
    $viewer = "/organization/processes/list/{$item["macroprocess"]}";
    $editor = "{$component}/edit/{$item["macroprocess"]}";
    $deleter = "{$component}/delete/{$item["macroprocess"]}";
