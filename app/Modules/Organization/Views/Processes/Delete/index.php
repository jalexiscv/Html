...
$data['model'] = model("App\Modules\Organization\Models\Organization_Processes");
$data['permissions'] = array('singular' => 'organization-processes-delete', "plural" => 'organization-processes-delete-all');
