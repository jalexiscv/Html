...
//[Asignations]---------------------------------------------------------------------------------------------------------
$data = array();
$component = '/organization/subprocesses';
foreach ($list as $item) {
    //[Buttons]---------------------------------------------------------------------------------------------------------
    $viewer = "/organization/positions/list/{$item["subprocess"]}";
    $editor = "{$component}/edit/{$item["subprocess"]}";
    $deleter = "{$component}/delete/{$item["subprocess"]}";
