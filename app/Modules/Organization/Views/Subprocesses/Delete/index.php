...
$data['model'] = model("App\Modules\Organization\Models\Organization_Subprocesses");
$data['permissions'] = array('singular' => 'organization-subprocesses-delete', "plural" => 'organization-subprocesses-delete-all');
