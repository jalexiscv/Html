 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Users\Config\Routes.php]
...
$mdm = model("App\Modules\Users\Models\Users_Modules");
$mdcxm = model("App\Modules\Users\Models\Users_Clients_Modules");
$module = 'users';
...
if ($cxm == "authorized") {
    $routes->group($module,
        ['namespace' => $namespace],
        function ($subroutes) {
            $subroutes->add('/', 'Users::index');
            $subroutes->add('/me', 'Users::index');
            $subroutes->add('me/(:any)', 'Users::me/$1');
