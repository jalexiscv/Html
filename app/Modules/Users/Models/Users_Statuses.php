...
class Users_Statuses extends Model
{
     ...
     *      'status'=>['type'=>'ENUM','constraint'=>['online','offline'],'default'=>'pending',],
     *   ];
     */
    private function exec_TableRegenerate()
    {
        if (!$this->get_TableExist()) {
            ...
            $fields = [
                ...
                'heartbeat' => ['type' => 'DATETIME', 'null' => FALSE],
                'value' => ['type' => 'ENUM', 'constraint' => ['online', 'offline'], 'default' => 'offline',],
