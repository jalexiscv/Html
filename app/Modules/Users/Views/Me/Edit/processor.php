...
$l["back"] = "/users/me/view/" . lpk();
$l["edit"] = "/users/me/edit/" . lpk();
...
if (is_array($row)) {
    ...
    $c = $bootstrap->get_Card("success", array(
        ...
        "title" => lang("Security.users-edit-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Security.users-edit-success-message"), $alias),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Security.users-edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Security.users-edit-noexist-message"), $d['user']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
