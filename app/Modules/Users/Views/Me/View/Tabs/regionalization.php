...
$institutions = $minstitutions->get_Institution($r["agreement_institution"]);
...
$f->fields["agreement_institution"] = $f->get_FieldView("agreement_institution", array("value" => $r["agreement_institution"] . ": " . $institution_name, "data" => $institutions, "proportion" => "col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"));
//[buttons]-------------------------------------------------------------------------------------------------------------
