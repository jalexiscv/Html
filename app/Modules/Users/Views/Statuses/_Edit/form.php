...
//[vars]----------------------------------------------------------------------------------------------------------------
$r = $model->where('status', $oid)->first();
$r["status"] = $f->get_Value("status", $row["status"]);
$r["heartbeat"] = $f->get_Value("heartbeat", $row["heartbeat"]);
...
$f->fields["heartbeat"] = $f->get_FieldText("heartbeat", array("value" => $r["heartbeat"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$card = $bootstrap->get_Card("create", array(
    "title" => lang("Users.statuses-edit-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
