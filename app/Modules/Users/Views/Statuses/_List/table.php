 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Users\Views\Statuses\List\table.php]
...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/users/api/statuses/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('icon' => ICON_ADD, 'text' => lang('App.Create'), 'href' => '/users/statuses/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'status' => array('text' => lang('App.status'), 'class' => 'text-center'),
        'heartbeat' => array('text' => lang('App.heartbeat'), 'class' => 'text-center'),
