...
class Disa_Statuses extends Model
{

    protected $table = "disa_statuses";
    ...
    public function regenerate()
    {
        ...
        $fields = [
            ...
            'value' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
            'observations' => ['type' => 'TEXT', 'null' => FALSE],
            'author' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE], 'created_at' => ['type' => 'TIMESTAMP', 'null' => TRUE], 'updated_at' => ['type' => 'TIMESTAMP', 'null' => TRUE], 'deleted_at' => ['type' => 'TIMESTAMP', 'null' => TRUE]];
    ...
    /**
     * Retorna el ultimo estado conocido de un objeto
     * @return type
     */
    public function get_Status($id)
    {
        $row = $this->where('object', $id)->orderBy('created_at', 'DESC')->first();
        if (is_array($row)) {
            return ($row);
        } else {
            return (false);
