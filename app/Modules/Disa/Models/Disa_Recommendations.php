...
class Disa_Recommendations extends Model
{
    protected $table = "disa_recommendations";
    ...
    public function regenerate()
    {
        ...
        $fields = [
            'recommendation' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
            'reference' => ['type' => 'VARCHAR', 'constraint' => 32, 'null' => FALSE],
