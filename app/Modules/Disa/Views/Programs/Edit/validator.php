...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.programs-edit-errors-title"));
    $smarty->assign("message", lang("Disa.programs-edit-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/programs-edit-errors-message.mp3");
