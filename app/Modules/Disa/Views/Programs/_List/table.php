...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Disa\Views\Programs\List\table.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$table = array(
    'id' => 'table-' . lpk(),
    'data-url' => '/disa/api/programs/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('text' => lang('App.Create'), 'href' => '/disa/programs/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
...
$smarty->assign('header', lang('Disa.programs-list-title'));
$smarty->assign('body', '');
