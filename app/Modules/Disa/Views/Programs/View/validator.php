...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.programs-view-errors-title"));
    $smarty->assign("message", lang("Disa.programs-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/programs-view-errors-message.mp3");
