...
*/
if ($f->run_Validation()) {
    $c = view($component . '\View\processor', $parent->get_Array());
} else {
    $errors = $f->validation->listErrors();
    $smarty = service("smarty");
    $smarty->set_Mode("bs5x");
    $smarty->assign("title", lang("Disa.institutional-view-errors-title"));
    $smarty->assign("message", lang("Disa.institutional-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/institutional-view-errors-message.mp3");
    $c = $smarty->view('alerts/danger.tpl');
    $c .= view($component . '\View\form', $parent->get_Array());
}
/*
* -----------------------------------------------------------------------------
* [Build]
