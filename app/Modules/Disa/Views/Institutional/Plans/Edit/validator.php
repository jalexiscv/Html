...
*/
if ($f->run_Validation()) {
    $c = view($component . '\Edit\processor', $parent->get_Array());
} else {
    $errors = $f->validation->listErrors();
    $smarty = service("smarty");
    $smarty->set_Mode("bs5x");
    $smarty->assign("title", lang("Disa.institutional-plans-edit-errors-title"));
    $smarty->assign("message", lang("Disa.institutional-plans-edit-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/institutional-plans-edit-errors-message.mp3");
    $c = $smarty->view('alerts/danger.tpl');
    $c .= view($component . '\Edit\form', $parent->get_Array());
}
/*
* -----------------------------------------------------------------------------
* [Build]
