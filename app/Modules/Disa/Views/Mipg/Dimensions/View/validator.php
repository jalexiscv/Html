...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.dimensions-view-errors-title"));
    $smarty->assign("message", lang("Disa.dimensions-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/dimensions-view-errors-message.mp3");
