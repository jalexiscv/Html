                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="/disa/mipg/dimensions/create/<?php echo(lpk()); ?>">Crear</a>
                                </li>
                                <li>
                        ...
                        <!--<li class="nav-item"><a class="nav-link " aria-current="page" href="/disa/mipg/dimensions/home/<?php echo(lpk()); ?>">Dimensiones</a></li>//-->
                    </ul>
                    <div class="d-flex">
                    </div>
                </div>
