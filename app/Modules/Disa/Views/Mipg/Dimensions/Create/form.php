...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Disa\Views\Dimensions\Creator\form.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$f->fields["cancel"] = $f->get_Cancel("cancel", array("href" => "/disa/mipg/dimensions/home/" . lpk(), "text" => lang("App.Cancel"), "type" => "secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
...
history_logger(array(
    ...
    "reference" => "COMPONENT",
    "object" => "DIMENSIONS",
    "log" => "El usuario accese a la creación de <a href=\"/disa/mipg/dimensions/create/{$oid}\" target==\"_blank\">una nueva dimensión<a> en el Módulo MiPG",
));
...
$smarty->assign("header", lang("Disa.dimensions-create-title"));
