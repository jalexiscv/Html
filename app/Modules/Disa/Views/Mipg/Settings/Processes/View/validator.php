...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.processes-view-errors-title"));
    $smarty->assign("message", lang("Disa.processes-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/processes-view-errors-message.mp3");
