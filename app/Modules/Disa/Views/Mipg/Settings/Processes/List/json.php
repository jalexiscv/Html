...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Disa\Views\Processes\List\json.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$macroprocesos = model('App\Modules\Disa\Models\Disa_Macroprocesses');
...
foreach ($list as $item) {
    ...
    $lview->attr('href', '/disa/settings/processes/view/' . $item["process"]);
    ...
    $leditor->attr('href', '/disa/settings/processes/edit/' . $item["process"]);
    ...
    $ldeleter->attr('href', '/disa/settings/processes/delete/' . $item["process"]);
    ...
    $row["macroprocess"] = $macroprocesos->get_Name($item["macroprocess"]);
    $row["name"] = $item["name"];
