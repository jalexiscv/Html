...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Disa\Views\Processes\List\table.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$table = array(
    'id' => 'table-' . lpk(),
    'data-url' => '/disa/mipg/api/processes/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('text' => lang('App.Create'), 'href' => '/disa/settings/processes/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'process' => array('text' => lang('App.Process'), 'class' => 'text-center', 'visible' => 'false'),
        'macroprocess' => array('text' => lang('App.Macroprocess'), 'class' => 'text-center'),
...
$card->assign('header', lang('Disa.processes-list-title'));
...
history_logger(array(
    ...
    "description" => "El usuario <b>@" . $authentication->get_Alias() . "</b> accedio al listado general de procesos.",
    "code" => "",
));
?>