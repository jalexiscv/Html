...
* -----------------------------------------------------------------------------
*/
$f->fields["process"] = $f->get_FieldText("process", array("value" => $r["process"], "proportion" => "col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12", "readonly" => true));
$f->fields["macroprocess"] = $f->get_FieldSelect("macroprocess", array("value" => $r["macroprocess"], "data" => $macroprocesses, "proportion" => "col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12"));
...
$f->fields["cancel"] = $f->get_Cancel("cancel", array("href" => "/disa/settings/processes/list/" . pk(), "text" => lang("App.Cancel"), "type" => "secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
...
$smarty->assign("header", lang("Disa.processes-edit-title"));
