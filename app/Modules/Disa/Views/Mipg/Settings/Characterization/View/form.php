...
$f->fields["edit"] = $f->get_Cancel("edit", array("href" => "/disa/settings/characterization/create/" . lpk(), "text" => lang("App.Edit"), "type" => "primary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
$f->fields["continue"] = $f->get_Button("continue", array("href" => "/disa/settings/home/" . lpk(), "text" => lang("App.Continue"), "class" => "btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
...
$smarty->assign("header", lang("Disa.characterizations-view-title"));
