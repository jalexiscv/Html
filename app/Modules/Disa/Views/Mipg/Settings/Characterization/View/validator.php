...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.characterizations-view-errors-title"));
    $smarty->assign("message", lang("Disa.characterizations-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/characterizations-view-errors-message.mp3");
