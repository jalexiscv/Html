...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Disa.positions-view-denied-title"));
    $smarty->assign("message", lang("Disa.positions-view-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", "/disa/settings/positions/list/" . lpk());
    $smarty->assign("voice", "disa/positions-view-denied-message.mp3");
