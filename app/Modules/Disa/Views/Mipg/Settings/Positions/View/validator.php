...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.positions-view-errors-title"));
    $smarty->assign("message", lang("Disa.positions-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/positions-view-errors-message.mp3");
