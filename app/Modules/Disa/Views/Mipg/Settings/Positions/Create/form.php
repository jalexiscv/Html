...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Disa\Views\Positions\Creator\form.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$r["subprocess"] = $f->get_Value("subprocess");
...
$f->fields["subprocess"] = $f->get_FieldSelect("subprocess", array("value" => $r["subprocess"], "data" => $subprocesses, "proportion" => "col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12"));
...
$smarty->assign("header", lang("Disa.positions-create-title"));
...
history_logger(array(
    ...
    "description" => "Accedio al formulario de <a target=\"_blank\" href=\"/disa/settings/positions/create/" . lpk() . "\">creación de cargos</a>.",
    "code" => "",
));
?>
