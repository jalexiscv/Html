...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Disa.positions-delete-denied-title"));
    $smarty->assign("message", lang("Disa.positions-delete-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", "/disa/settings/positions/list/" . lpk());
    $smarty->assign("voice", "disa/positions-delete-denied-message.mp3");
