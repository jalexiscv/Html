...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Disa\Views\Positions\Delete\form.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$message = sprintf(lang("Disa.positions-delete-message"), $name);
$cancel = "/disa/settings/positions/list/" . lpk();
/*
 * -----------------------------------------------------------------------------
 * [Fields]
 * -----------------------------------------------------------------------------
...
$smarty->assign("header", sprintf(lang("Disa.positions-delete-title"), $name));
$smarty->assign("message", sprintf(lang("Disa.positions-delete-message"), $name));
$smarty->assign("form", $f);
$smarty->assign("continue", null);
$smarty->assign("voice", "disa/positions-delete-errors-message.mp3");
...
history_logger(array(
    ...
    "description" => "Accedio al formulario de <b>eliminación del cargo</b> <a target=\"_blank\" href=\"/disa/settings/positions/view/" . $oid . "\">" . $name . "</a>.",
    "code" => "",
));
?>