...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.positions-edit-errors-title"));
    $smarty->assign("message", lang("Disa.positions-edit-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/positions-edit-errors-message.mp3");
