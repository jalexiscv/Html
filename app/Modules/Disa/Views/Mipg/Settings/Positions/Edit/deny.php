...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Disa.positions-edit-denied-title"));
    $smarty->assign("message", lang("Disa.positions-edit-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", "/disa/settings/positions/list/" . lpk());
    $smarty->assign("voice", "disa/positions-edit-denied-message.mp3");
