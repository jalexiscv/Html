...
$smarty->assign("header", lang("Disa.positions-edit-title"));
...
history_logger(array(
    ...
    "description" => "Accedio al formulario de <b>edición del cargo</b> <a target=\"_blank\" href=\"/disa/settings/positions/view/" . $oid . "\">" . $r["name"] . "</a>.",
    "code" => "",
));
?>
