...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Disa\Views\Positions\List\table.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$table = array(
    'id' => 'table-' . lpk(),
    'data-url' => '/disa/mipg/api/positions/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('text' => lang('App.Create'), 'href' => '/disa/settings/positions/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'position' => array('text' => lang('App.Position'), 'class' => 'text-center', 'visible' => false),
...
$card->assign('header', lang('Disa.positions-list-title'));
...
history_logger(array(
    ...
    "description" => "Accedio al <a href=\"/disa/settings/positions/list/" . lpk() . "\">listado general de cargos</a>.",
    "code" => "",
));
?>
