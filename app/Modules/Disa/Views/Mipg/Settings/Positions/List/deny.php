...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Disa.positions-list-denied-title"));
    $smarty->assign("message", lang("Disa.positions-list-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", "/disa");
    $smarty->assign("voice", "disa/positions-list-denied-message.mp3");
