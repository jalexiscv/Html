...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Disa\Views\Positions\List\json.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
foreach ($list as $item) {
    ...
    $lview->attr('href', '/disa/settings/positions/view/' . $item["position"]);
    ...
    $leditor->attr('href', '/disa/settings/positions/edit/' . $item["position"]);
    ...
    $ldeleter->attr('href', '/disa/settings/positions/delete/' . $item["position"]);
    ...
    $row["subprocess"] = $subprocesses->get_name($item["subprocess"]);
    $row["name"] = $item["name"];
