...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.macroprocesses-edit-errors-title"));
    $smarty->assign("message", lang("Disa.macroprocesses-edit-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/macroprocesses-edit-errors-message.mp3");
