...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Disa\Views\Macroprocesses\List\json.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
foreach ($list as $item) {
    ...
    $lview->attr('href', '/disa/settings/macroprocesses/view/' . $item["macroprocess"]);
    $lview->attr('target', '_self');
    $lview->content(array($iview, " " . "Ver"));
    $leditor = HtmlTag::tag('a');
    $leditor->attr('class', 'btn btn-outline-secondary');
    $leditor->attr('href', '/disa/settings/macroprocesses/edit/' . $item["macroprocess"]);
    ...
    $ldeleter->attr('href', '/disa/settings/macroprocesses/delete/' . $item["macroprocess"]);
    ...
    /* Build */
    $row["macroprocess"] = $item["macroprocess"];
    $row["name"] = $item["name"];
