...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.macroprocesses-view-errors-title"));
    $smarty->assign("message", lang("Disa.macroprocesses-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/macroprocesses-view-errors-message.mp3");
