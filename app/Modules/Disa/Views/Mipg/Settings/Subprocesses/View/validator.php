...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.subprocesses-view-errors-title"));
    $smarty->assign("message", lang("Disa.subprocesses-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/subprocesses-view-errors-message.mp3");
