...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Disa\Views\Subprocesses\Editor\form.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$r["process"] = $row["process"] . ": " . urldecode($mprocesses->get_Name($row["process"]));
$r["name"] = $row["name"];
...
$f->fields["subprocess"] = $f->get_FieldView("subprocess", array("value" => $r["subprocess"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "readonly" => true));
$f->fields["process"] = $f->get_FieldView("process", array("value" => $r["process"], "data" => $processes, "proportion" => "col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12"));
...
$f->fields["cancel"] = $f->get_Cancel("cancel", array("href" => "/disa/settings/subprocesses/list/" . lpk(), "text" => lang("App.Cancel"), "type" => "secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
$f->fields["submit"] = $f->get_Button("submit", array("href" => "/disa/settings/subprocesses/edit/" . $oid, "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-left"));
/** groups * */
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["subprocess"] . $f->fields["process"])));
...
$smarty->assign("header", lang("Disa.subprocesses-view-title"));
