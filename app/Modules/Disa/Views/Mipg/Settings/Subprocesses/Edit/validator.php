...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.subprocesses-edit-errors-title"));
    $smarty->assign("message", lang("Disa.subprocesses-edit-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/subprocesses-edit-errors-message.mp3");
