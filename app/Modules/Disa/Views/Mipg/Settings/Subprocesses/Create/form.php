...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Disa\Views\Subprocesses\Creator\form.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$back = "/disa/settings/subprocesses/list/" . lpk();
...
$f->fields["process"] = $f->get_FieldSelect("process", array("value" => $r["process"], "data" => $processes, "proportion" => "col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12"));
...
$smarty->assign("header", lang("Disa.subprocesses-create-title"));
