...
$category = $mcategories->withDeleted()->find($oid);
            ...
            <div class="container-fluid p-0">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item-divider"></li>
                        <li class="nav-item"><a class="nav-link " aria-current="page" href="#">Componentes</a></li>
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownOptions">
                                <li><a class="dropdown-item" href="/disa/mipg/categories/create/<?php echo($oid); ?>">Crear</a>
                                </li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
