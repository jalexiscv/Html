...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Disa\Views\Categories\Creator\form.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$order = $categories->get_CountByComponent($oid);

/** request **/
$r["category"] = $f->get_Value("category", pk());
$r["component"] = $oid;
$r["order"] = $f->get_Value("order", $order + 1);
...
$f->fields["cancel"] = $f->get_Cancel("cancel", array("href" => "/disa/mipg/categories/list/{$oid}", "text" => lang("App.Cancel"), "type" => "secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
$f->fields["submit"] = $f->get_Submit("submit", array("value" => lang("App.Create"), "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-left"));
/** groups * */

$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["component"] . $f->fields["category"] . $f->fields["order"])));
...
$smarty->assign("header", lang("Disa.categories-create-title"));
