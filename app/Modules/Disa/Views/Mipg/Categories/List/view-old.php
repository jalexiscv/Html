...
history_logger(array(
    ...
    "description" => "El usuario <b>@" . $authentication->get_Alias() . "</b> accedió al listado de <b>categorias</b> del componente <b><a href=\"/disa/mipg/categories/list/{$oid}\" target=\"_blank\">{$component_name}</a></b>",
    "code" => "",
));
echo($row->render());
?>