...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.categories-edit-errors-title"));
    $smarty->assign("message", lang("Disa.categories-edit-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/categories-edit-errors-message.mp3");
