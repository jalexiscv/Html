...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.categories-view-errors-title"));
    $smarty->assign("message", lang("Disa.categories-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/categories-view-errors-message.mp3");
