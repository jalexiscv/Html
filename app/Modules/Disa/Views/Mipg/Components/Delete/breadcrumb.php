...
$component = $mcomponents->withDeleted()->find($oid);
...
//echo("<br><b>Politica</b>: {$politic["politic"]}");
//echo("<br><b>Dimensión</b>: {$politic["dimension"]}");
            ...
            <div class="container-fluid p-0">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownPolitics">
                                <?php foreach ($politics as $key => $value) { ?>
                                    <li><a class="dropdown-item"
                                           href="/disa/mipg/diagnostics/list/<?php echo($value["politic"]); ?>"><?php echo(urldecode($value["name"])); ?></a>
                                    </li>
                                <?php } ?>
                                <li>
                                    <hr class="dropdown-divider">
                        ...
                        <li class="nav-item-divider"></li>
                        <li class="nav-item"><a class="nav-link " aria-current="page" href="#">Autodiagnósticos</a></li>
                        <li class="nav-item-divider"></li>
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownOptions">
                                <li><a class="dropdown-item"
                                       href="/disa/mipg/components/create/<?php echo($politic["politic"]); ?>">Crear</a>
                                </li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
