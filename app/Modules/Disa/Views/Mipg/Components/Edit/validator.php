...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.components-edit-errors-title"));
    $smarty->assign("message", lang("Disa.components-edit-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/components-edit-errors-message.mp3");
