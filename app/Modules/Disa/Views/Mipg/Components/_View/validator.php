...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.components-view-errors-title"));
    $smarty->assign("message", lang("Disa.components-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/components-view-errors-message.mp3");
