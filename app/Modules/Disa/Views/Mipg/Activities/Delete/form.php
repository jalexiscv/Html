...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Disa\Views\Activities\Delete\form.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$r = $model->find($oid);
$name = urldecode($r["category"]);
$message = sprintf(lang("Disa.activities-delete-message"), $name);
$cancel = "/disa/mipg/activities/list/{$r["category"]}";
/*
 * -----------------------------------------------------------------------------
 * [Fields]
 * -----------------------------------------------------------------------------
...
$smarty->assign("header", sprintf(lang("Disa.activities-delete-title"), $name));
$smarty->assign("message", sprintf(lang("Disa.activities-delete-message"), $name));
$smarty->assign("form", $f);
$smarty->assign("continue", null);
$smarty->assign("voice", "disa/activities-delete-errors-message.mp3");
