...
$f->fields["cancel"] = $f->get_Cancel("cancel", array("href" => "/disa/activities/list/" . lpk(), "text" => lang("App.Cancel"), "type" => "secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
$f->fields["edit"] = $f->get_Button("edit", array("href" => "/disa/activities/edit/" . $oid, "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
/*
* -----------------------------------------------------------------------------
* [Groups]
* -----------------------------------------------------------------------------
...
$f->groups["g3"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["period"] . $f->fields["score"] . $f->fields["author"])));
...
$smarty->assign("header", lang("Disa.activities-view-title"));
