...
if (isset($row["activity"])) {
    ...
    $smarty->assign("title", lang("Disa.activities-view-success-title"));
    $smarty->assign("message", sprintf(lang("Disa.activities-view-success-message"), $d['activity']));
    $smarty->assign("edit", base_url("/disa/activities/edit/{$d['activity']}/" . lpk()));
    $smarty->assign("continue", base_url("/disa/activities/view/{$d["activity"]}/" . lpk()));
    $smarty->assign("voice", "disa/activities-view-success-message.mp3");
    $c = $smarty->view('alerts/success.tpl');
} else {
    $smarty = service("smarty");
    $smarty->set_Mode("bs5x");
    $smarty->assign("title", lang("Disa.activities-view-noexist-title"));
    $smarty->assign("message", lang("Disa.activities-view-noexist-message"));
    $smarty->assign("continue", base_url("/disa/activities"));
    $smarty->assign("voice", "disa/activities-view-noexist-message.mp3");
