...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.activities-view-errors-title"));
    $smarty->assign("message", lang("Disa.activities-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/activities-view-errors-message.mp3");
