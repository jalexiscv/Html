...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.activities-edit-errors-title"));
    $smarty->assign("message", lang("Disa.activities-edit-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/activities-edit-errors-message.mp3");
