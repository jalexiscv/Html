...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Disa\Views\Activities\Editor\form.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$r["criteria"] = $f->get_Value("criteria", urldecode($row["criteria"]));
$r["description"] = $f->get_Value("description", urldecode($row["description"]));
$r["evaluation"] = $f->get_Value("evaluation", urldecode($row["evaluation"]));
...
$f->fields["cancel"] = $f->get_Cancel("cancel", array("href" => "/disa/mipg/activities/list/{$r["category"]}", "text" => lang("App.Cancel"), "type" => "secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
...
$smarty->assign("header", lang("Disa.activities-edit-title"));
