...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.diagnostics-edit-errors-title"));
    $smarty->assign("message", lang("Disa.diagnostics-edit-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/diagnostics-edit-errors-message.mp3");
