...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Disa\Views\Diagnostics\List\json.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
foreach ($list as $item) {
    ...
    $lview->attr('href', '/disa/diagnostics/view/' . $item["politic"]);
    ...
    $leditor->attr('href', '/disa/diagnostics/edit/' . $item["politic"]);
    ...
    $ldeleter->attr('href', '/disa/diagnostics/delete/' . $item["politic"]);
