...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Disa\Views\Diagnostics\List\table.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$table = array(
    'id' => 'table-' . lpk(),
    'data-url' => '/disa/api/diagnostics/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('text' => lang('App.Create'), 'href' => '/disa/diagnostics/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'politic' => array('text' => lang('App.politic'), 'class' => 'text-center'),
        'diagnostic' => array('text' => lang('App.diagnostic'), 'class' => 'text-center'),
...
$smarty->assign('header', lang('Disa.diagnostics-list-title'));
$smarty->assign('body', '');
