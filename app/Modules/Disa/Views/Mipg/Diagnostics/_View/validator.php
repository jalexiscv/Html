...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.diagnostics-view-errors-title"));
    $smarty->assign("message", lang("Disa.diagnostics-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/diagnostics-view-errors-message.mp3");
