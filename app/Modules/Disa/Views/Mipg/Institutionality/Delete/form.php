...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Storage\Views\Attachments\Delete\form.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$r = $model->find($oid);
$name = urldecode($r["attachment"]);
$message = sprintf(lang("Disa.institutionality-attachments-delete-message"), $name);
$cancel = "/disa/mipg/institutionality/home/" . lpk();
/*
 * -----------------------------------------------------------------------------
 * [Fields]
 * -----------------------------------------------------------------------------
...
$smarty->assign("header", sprintf(lang("Disa.institutionality-attachments-delete-title"), $name));
$smarty->assign("message", sprintf(lang("Disa.institutionality-attachments-delete-message"), $name));
$smarty->assign("form", $f);
$smarty->assign("continue", null);
$smarty->assign("voice", "storage/attachments-delete-errors-message.mp3");
