...
///disa/mipg/recommendations/list/2021/6256cb4517885
...
$smarty->assign("header", sprintf(lang("Disa.recommendations-delete-title"), $name));
$smarty->assign("message", sprintf(lang("Disa.recommendations-delete-message"), $name));
