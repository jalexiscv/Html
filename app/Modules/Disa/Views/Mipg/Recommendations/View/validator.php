...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.recommendations-view-errors-title"));
    $smarty->assign("message", lang("Disa.recommendations-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/recommendations-view-errors-message.mp3");
