...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.politics-view-errors-title"));
    $smarty->assign("message", lang("Disa.politics-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/politics-view-errors-message.mp3");
