...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Disa\Views\Politics\Editor\form.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
* -----------------------------------------------------------------------------
*/
$f->fields["politic"] = $f->get_FieldView("politic", array("value" => $r["politic"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "readonly" => true));
$f->fields["dimension"] = $f->get_FieldView("dimension", array("value" => $r["dimension"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "readonly" => true));
...
$f->fields["edit"] = $f->get_Button("edit", array("href" => "/disa/mipg/politics/edit/{$r["politic"]}", "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
...
$smarty->assign("header", lang("Disa.politics-view-title"));
