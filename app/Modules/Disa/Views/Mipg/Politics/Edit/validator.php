...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.politics-edit-errors-title"));
    $smarty->assign("message", lang("Disa.politics-edit-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/politics-edit-errors-message.mp3");
