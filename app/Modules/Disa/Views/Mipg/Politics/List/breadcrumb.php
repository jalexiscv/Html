...
$item = array("href" => "/disa/mipg/politics/create/{$oid}", "text" => "Crear política");
array_push($menu["dimensions"]["levels"], array("separator" => true));
array_push($menu["dimensions"]["levels"], $item);
 ...
 * $count++;
 * $item=array("href"=>"/disa/mipg/scores/list/{$activity["activity"]}","text"=>$count);
