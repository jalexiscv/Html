...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.actions-edit-errors-title"));
    $smarty->assign("message", lang("Disa.actions-edit-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/actions-edit-errors-message.mp3");
