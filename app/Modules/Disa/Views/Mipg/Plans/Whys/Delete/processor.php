...
$vsuccess = "disa/whys-delete-success-message.mp3";
$vnoexist = "disa/whys-delete-noexist-message.mp3";
...
if (isset($row["why"])) {
    ...
    $smarty->assign("title", lang("Disa.whys-delete-success-title"));
    $smarty->assign("message", sprintf(lang("Disa.whys-delete-success-message"), $row['why']));
    ...
    $smarty = service("smarty");
    $smarty->set_Mode("bs5x");
    $smarty->assign("title", lang("Disa.whys-delete-noexist-title"));
    $smarty->assign("message", lang("Disa.whys-delete-noexist-message"));
    $smarty->assign("continue", $continue);
