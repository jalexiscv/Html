...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.whys-edit-errors-title"));
    $smarty->assign("message", lang("Disa.whys-edit-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/whys-edit-errors-message.mp3");
