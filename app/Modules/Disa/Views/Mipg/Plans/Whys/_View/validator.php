...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.whys-view-errors-title"));
    $smarty->assign("message", lang("Disa.whys-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/whys-view-errors-message.mp3");
