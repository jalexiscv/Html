...
$validator = $component . '\Evaluate\validator';
$form = $component . '\Evaluate\form';
$deny = $component . '\Evaluate\deny';
$score = $component . '\Evaluate\score';
/*
* -----------------------------------------------------------------------------
* [Evaluate]
* -----------------------------------------------------------------------------
...
* -----------------------------------------------------------------------------
*/
$header = view($component . '\Evaluate\breadcrumb', $data);
