...
$f->fields["cancel"] = $f->get_Cancel("cancel", array("href" => "/disa/mipg/plans/causes/list/{$r["plan"]}", "text" => lang("App.Cancel"), "type" => "secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
...
history_logger(array(
    ...
    "reference" => "COMPONENT",
    "object" => "PLAN",
    "log" => "Accedió a actualizar la causa <b> {$r["description"]}</b> del  <b>plan de acción</b> <b>{$plan['order']}</b>",
));
...
$smarty->assign("header", lang("Disa.causes-edit-title"));
