...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.causes-edit-errors-title"));
    $smarty->assign("message", lang("Disa.causes-edit-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/causes-edit-errors-message.mp3");
