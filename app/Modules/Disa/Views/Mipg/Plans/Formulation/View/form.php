...
$f->fields["formulation"] = $f->get_FieldViewArea("formulation", array("value" => urldecode($r["formulation"]), "proportion" => "col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"));
...
$f->fields["submit"] = $f->get_Button("submit", array("href" => "/disa/mipg/plans/formulation/edit/{$oid}?time=" . time(), "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
...
history_logger(array(
    ...
    "reference" => "COMPONENT",
    "object" => "PLAN",
    "log" => "Accedió a la  <b>formulación</b> del  <b>plan de acción</b> <b>{$plan['order']}</b>",
));
