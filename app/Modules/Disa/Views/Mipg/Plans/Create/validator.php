...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Disa\Views\Plans\Creator\validator.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$f->set_ValidationRule("value", "required|greater_than[{$score}]");
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.plans-create-errors-title"));
    $smarty->assign("message", lang("Disa.plans-create-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/plans-create-errors-message.mp3");
