...
history_logger(array(
    ...
    "reference" => "COMPONENT",
    "object" => "PLAN",
    "log" => "Accedió a la selección del <b>equipo de trabajo</b> de  <b>plan de acción</b> <b>{$plan['order']}</b>",
));
...
$card->assign("header", "Selección del equipo de trabajo del plan de acción " . $string->get_ZeroFill($plan["order"], 4));
