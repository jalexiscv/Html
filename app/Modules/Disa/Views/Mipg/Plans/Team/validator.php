...
* -----------------------------------------------------------------------------
*/
$f->set_ValidationRule("option", "trim|required");
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.plans-team-view-errors-title"));
    $smarty->assign("message", lang("Disa.plans-team-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/plans-view-errors-message.mp3");
