...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.statuses-view-errors-title"));
    $smarty->assign("message", lang("Disa.statuses-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/statuses-view-errors-message.mp3");
