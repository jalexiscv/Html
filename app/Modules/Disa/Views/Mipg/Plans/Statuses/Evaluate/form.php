...
$f = service("forms", array("lang" => "Disa.statuses-evaluate-"));
/*
* -----------------------------------------------------------------------------
* [Requests]
* -----------------------------------------------------------------------------
...
$r["value"] = $f->get_Value("value", "INEVALUATION");
...
$f->fields["value"] = $f->get_FieldText("value", array("value" => $r["value"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "readonly" => true));
...
$f->fields["submit"] = $f->get_Submit("submit", array("value" => "Solicitar", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-left"));
/** groups * */
...
$sinfo->set_Mode("bs5x");
$sinfo->assign("title", lang("Disa.statuses-evaluate-info-title"));
$sinfo->assign("message", lang("Disa.statuses-evaluate-info-message"));
...
$card->assign("header", sprintf(lang("Disa.statuses-evaluate-title"), $plan_number));
