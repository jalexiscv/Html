...
$f->fields["cancel"] = $f->get_Cancel("cancel", array("href" => "/disa/statuses/list/", "text" => lang("App.Cancel"), "type" => "secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
...
$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["observations"] . $f->fields["author"] . $f->fields["created_at"])));
...
$smarty->assign("header", lang("Disa.statuses-create-title"));
