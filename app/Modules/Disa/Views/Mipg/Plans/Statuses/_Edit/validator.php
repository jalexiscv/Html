...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Disa.statuses-edit-errors-title"));
    $smarty->assign("message", lang("Disa.statuses-edit-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "disa/statuses-edit-errors-message.mp3");
