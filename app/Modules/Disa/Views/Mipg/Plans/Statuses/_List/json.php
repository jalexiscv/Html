...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Disa\Views\Statuses\List\json.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
foreach ($list as $item) {
    ...
    $lview->attr('href', '/disa/statuses/view/' . $item["status"]);
    ...
    $leditor->attr('href', '/disa/statuses/edit/' . $item["status"]);
    ...
    $ldeleter->attr('href', '/disa/statuses/delete/' . $item["status"]);
    ...
    $row["observations"] = $item["observations"];
