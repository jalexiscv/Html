...
$values = array(
    ...
    array("label" => "Aprobado", "value" => "APPROVED")
);
...
$sinfo->set_Mode("bs5x");
$sinfo->assign("title", lang("Disa.statuses-approve-info-title"));
$sinfo->assign("message", lang("Disa.statuses-approve-info-message"));
...
$card->assign("header", sprintf(lang("Disa.statuses-approve-title"), $plan_number));
