...
$r["value"] = $f->get_Value("value", "APPROVAL");
...
$f->fields["submit"] = $f->get_Submit("submit", array("value" => lang("Disa.Request-Approval"), "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-left"));
/** groups * */
...
$sinfo->set_Mode("bs5x");
$sinfo->assign("title", lang("Disa.statuses-approval-info-title"));
$sinfo->assign("message", lang("Disa.statuses-approval-info-message"));
...
$card->assign("header", sprintf(lang("Disa.statuses-approval-title"), $plan_number));
