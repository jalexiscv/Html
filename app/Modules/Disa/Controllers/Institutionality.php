...
class Institutionality extends ModuleController
{
    ...
    public function __construct()
    {
        ...
        $this->prefix = 'disa-institutionality';
        $this->module = 'App\Modules\Disa';
        $this->views = $this->module . '\Views';
        $this->viewer = $this->views . '\index';
        $this->component = $this->views . '\Mipg\Institutionality';
    }
    ...
    public function delete(string $oid)
    {
        ...
        $this->component = $this->views . '\Mipg\Institutionality\Delete';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function committees(string $option, string $oid)
    {
        $this->oid = $oid;
        $this->option = $option;
        $this->prefix = "{$this->prefix}-committee";
        $this->component = $this->views . '\Mipg\Institutionality\Upload';
        return (view($this->viewer, $this->get_Array()));
    }
}
