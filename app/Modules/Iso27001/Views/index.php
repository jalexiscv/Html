...
$version = round(($server->get_DirectorySize(APPPATH . 'Modules/Iso27001') / 102400), 6);
$data = $parent->get_Array();
$rviews = array(
    "default" => "{$views}\E404\index",
    "iso27001-denied" => "{$views}\Denied\index",
    "iso27001-home" => "{$views}\Home\index",
    //[others]------------------------------------------------------------------------------------------
);
...
$assign['left'] = get_iso27001_sidebar();
