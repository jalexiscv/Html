...
if (strpos($dirName, '_') === false) {
    ...
    $mdm = model("App\Modules\Iso27001\Models\Iso27001_Modules");
    $mdcxm = model("App\Modules\Iso27001\Models\Iso27001_Clients_Modules");
    $module = 'iso27001';
    $namespace = "App\Modules\Iso27001\Controllers";
    ...
    if ($cxm == "authorized") {
        $routes->group($module,
            ['namespace' => $namespace],
            function ($subroutes) {
                $subroutes->add('/', 'Iso27001::index');
                $subroutes->add('/home', 'Iso27001::index');
                $subroutes->add('home/(:any)', 'Iso27001::home/$1');
        ...
        $routes->group($module,
            ['namespace' => $namespace],
            function ($subroutes) {
                $subroutes->add('/', 'Iso27001::denied');
                $subroutes->add('(:any)', 'Iso27001::denied');
            }
        );
    }
}
