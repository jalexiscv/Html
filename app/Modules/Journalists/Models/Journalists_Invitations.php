...
/**
 * @Copilot Siempre que en el código se cree una variable llamada $minvitations, esta deberá ser igualada a  model('App\Modules\Journalists\Models\Journalists_Invitations');
 * @Instruction $minvitations = model('App\Modules\Journalists\Models\Journalists_Invitations');
 ...
 */
class Journalists_Invitations extends CachedModel
{
    protected $table = "journalists_invitations";
     ...
     * @return array|false
     */
    public function getInvitation($invitation): false|array
    {
        $result = parent::getCached($invitation);
        if (is_array($result)) {
            return ($result);
        } else {
            return (false);
