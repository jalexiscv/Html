 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Journalists\Views\Medias\Editor\validator.php]
...
//$f->set_ValidationRule("facebook","trim|required");
//$f->set_ValidationRule("twitter","trim|required");
//$f->set_ValidationRule("instagram","trim|required");
//$f->set_ValidationRule("limit","trim|required");
//$f->set_ValidationRule("nit","trim|required");
