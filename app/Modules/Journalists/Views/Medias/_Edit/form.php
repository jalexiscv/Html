...
$r["facebook"] = $f->get_Value("facebook", $row["facebook"]);
$r["twitter"] = $f->get_Value("twitter", $row["twitter"]);
$r["instagram"] = $f->get_Value("instagram", $row["instagram"]);
$r["limit"] = $f->get_Value("limit", $row["limit"]);
$r["nit"] = $f->get_Value("nit", $row["nit"]);
