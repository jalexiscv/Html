 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Journalists\Views\Medias\Delete\form.php]
...
$r = $model->get_Medias($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Medias.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Medias.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Medias.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
