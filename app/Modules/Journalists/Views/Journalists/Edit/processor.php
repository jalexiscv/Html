...
if (is_array($row)) {
    ...
    $c = $bootstrap->get_Card("success", array(
        ...
        "title" => lang("Journalists.edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Journalists.edit-success-message"),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Journalists.edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Journalists.edit-noexist-message"), $d['journalist']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
