 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Journalists\Views\Journalists\Delete\form.php]
...
$r = $model->get_Journalists($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Journalists.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Journalists.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Journalists.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
