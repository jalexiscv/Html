...
if (isset($row["journalist"])) {
    ...
    $c = $bootstrap->get_Card("duplicate", array(
        ...
        "title" => lang("Journalists.delete-success-title"),
        "text-class" => "text-center",
        "text" => lang("Journalists.delete-success-message"),
    ...
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Journalists.delete-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Journalists.delete-noexist-message"), $d['journalist']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $vnoexist,
    ));
