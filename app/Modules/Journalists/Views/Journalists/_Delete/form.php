...
$r= $model->getJournalist($oid);
$name = urldecode($r["name"]);
$message=sprintf(lang("Journalists_Journalists.delete-message"),$name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
		 "class" =>"card-info",
		 "icon" => ICON_WARNING,
		 "title" => sprintf(lang("Journalists_Journalists.delete-title"),$name),
		 "text-class" =>"text-center",
		 "text"=>sprintf(lang("Journalists_Journalists.delete-message"),$name),
		 "content" =>$f,
		 "header-back" =>$back
));
echo($card);
