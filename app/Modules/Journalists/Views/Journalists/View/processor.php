...
$c = $bootstrap->get_Card('warning', array(
				...
				'title' => lang("Journalists_Journalists.view-success-title"),
				'text' => lang("Journalists_Journalists.view-success-message"),
				'footer-class' => 'text-center',
				'footer-continue' => base_url("/journalists/journalists/view/{$d["journalist"]}/".lpk()),
				'voice' => "journalists/journalists-view-success-message.mp3",
		));
}else {
$c = $bootstrap->get_Card('success', array(
				...
				'icon' => 'fa-duotone fa-triangle-exclamation',
				'text-class' => 'text-center',
				'title' => lang("Journalists_Journalists.view-noexist-title"),
				'text' => lang("Journalists_Journalists.view-noexist-message"),
				'footer-class' => 'text-center',
				'footer-continue' => base_url("/journalists/journalists"),
				'voice' => "journalists/journalists-view-noexist-message.mp3",
		));
}
echo($c);
?>
