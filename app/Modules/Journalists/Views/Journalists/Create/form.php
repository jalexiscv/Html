 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Journalists\Views\Journalists\Creator\form.php]
...
//[vars]----------------------------------------------------------------------------------------------------------------
$r["journalist"] = $f->get_Value("journalist", pk());
...
$r["status"] = $f->get_Value("status", "REVISION");
...
$f->fields["submit"] = $f->get_Submit("submit", array("value" => "Solicitar Acreditación", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-left"));
//[groups]----------------------------------------------------------------------------------------------------------------
...
$card = $b->get_Card("create", array(
    "title" => "Solicitud de Acreditación",
    "content" => "El proceso de acreditaciones a finalizado… !",
));
//echo($card);
