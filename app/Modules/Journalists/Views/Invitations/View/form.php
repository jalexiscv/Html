...
$f->fields["whatsapp"] = $f->get_Button("whatsapp", array("href" => "https://web.whatsapp.com/send?phone=57{$r['tel']}?text=", "target" => "_blank", "text" => "WhatsApp", "class" => "btn btn-success", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
...
$f->groups["gz"] = $f->get_Buttons(array("fields" => $f->fields["whatsapp"] . $f->fields["edit"] . $f->fields["cancel"]));
//[build]---------------------------------------------------------------------------------------------------------------
