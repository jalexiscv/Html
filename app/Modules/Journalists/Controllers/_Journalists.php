...
/**
* █ ---------------------------------------------------------------------------------------------------------------------
* █ ░FRAMEWORK                                  2025-07-05 17:14:16
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Journalists\Controllers\_Journalists.php]
...
class Journalists extends ModuleController {
    ...
    public function __construct() {
       parent::__construct();
       $this->prefix = 'journalists-journalists';
    ...
    public function index() {
        $url = base_url('journalists/journalists/home/' . lpk());
    ...
    public function home(string $rnd) {
        ...
        $this->component = $this->views . '\Journalists\Home';
