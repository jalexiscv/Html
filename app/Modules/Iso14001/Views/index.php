...
$version = round(($server->get_DirectorySize(APPPATH . 'Modules/Iso14001') / 102400), 6);
$data = $parent->get_Array();
$rviews = array(
    "default" => "{$views}\E404\index",
    "iso14001-denied" => "{$views}\Denied\index",
    "iso14001-home" => "{$views}\Home\index",
    //[others]------------------------------------------------------------------------------------------
);
...
$assign['left'] = get_iso14001_sidebar();
