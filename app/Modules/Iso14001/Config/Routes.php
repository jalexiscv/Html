...
if (strpos($dirName, '_') === false) {
    ...
    $mdm = model("App\Modules\Iso14001\Models\Iso14001_Modules");
    $mdcxm = model("App\Modules\Iso14001\Models\Iso14001_Clients_Modules");
    $module = 'iso14001';
    $namespace = "App\Modules\Iso14001\Controllers";
    ...
    if ($cxm == "authorized") {
        $routes->group($module,
            ['namespace' => $namespace],
            function ($subroutes) {
                $subroutes->add('/', 'Iso14001::index');
                $subroutes->add('/home', 'Iso14001::index');
                $subroutes->add('home/(:any)', 'Iso14001::home/$1');
        ...
        $routes->group($module,
            ['namespace' => $namespace],
            function ($subroutes) {
                $subroutes->add('/', 'Iso14001::denied');
                $subroutes->add('(:any)', 'Iso14001::denied');
            }
        );
    }
}
