...
class Tools extends ModuleController
{
    ...
    {
        $url = base_url('security/tools/home/' . lpk());
    ...
    public function users(string $rnd)
    {
        $this->oid = $rnd;
        $this->prefix = "{$this->prefix}-users";
    ...
    public function importer(string $rnd)
    {
        ...
        $this->component = $this->views . '\Tools\Importer';
        return (view($this->viewer, $this->get_Array()));
    }
