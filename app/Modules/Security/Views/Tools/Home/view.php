...
$options = array(
    array("href" => "/security/tools/users/" . lpk(), "title" => "Usuarios", "icon" => "fas fa-tasks"),
    array("href" => "/security/tools/roles/" . lpk(), "title" => "Roles", "icon" => "fas fa-tasks"),
    //array("href" => "/security/tools/importer/" . lpk(), "title" => "Importador", "icon" => "fas fa-tasks", "class" => "disabled"),
);
