...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Transactions.view-errors-title"));
    $smarty->assign("message", lang("Transactions.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "wallet/transactions-view-errors-message.mp3");
