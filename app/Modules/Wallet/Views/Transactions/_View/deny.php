...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Transactions.view-denied-title"));
    $smarty->assign("message", lang("Transactions.view-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "wallet/transactions-view-denied-message.mp3");
