...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Wallet\Views\Transactions\Creator\validator.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
* -----------------------------------------------------------------------------
*/
$f->set_ValidationRule("transaction", "trim|required");
...
$f->set_ValidationRule("debit", "trim|required");
$f->set_ValidationRule("credit", "trim|required");
$f->set_ValidationRule("balance", "trim|required");
...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Transactions.create-errors-title"));
    $cerrors->assign("message", lang("Transactions.create-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "wallet/transactions-create-errors-message.mp3");
