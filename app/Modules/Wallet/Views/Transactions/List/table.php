...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Wallet\Views\Transactions\List\table.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$table = array(
    'id' => 'table-' . lpk(),
    'data-url' => '/wallet/api/transactions/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('text' => lang('App.Create'), 'href' => '/wallet/transactions/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'transaction' => array('text' => lang('App.Transaction'), 'class' => 'text-center'),
        ...
        'currency' => array('text' => lang('App.Currency'), 'class' => 'text-center', 'visible' => false),
        'credit' => array('text' => lang('App.Credit'), 'class' => 'text-center'),
        'debit' => array('text' => lang('App.Debit'), 'class' => 'text-center'),
        'balance' => array('text' => lang('App.Balance'), 'class' => 'text-center'),
...
$smarty->assign('header', lang('Transactions.list-title'));
$smarty->assign('body', '');
