...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Wallet\Views\Transactions\Delete\form.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$message = sprintf(lang("Transactions.delete-message"), $name);
...
$smarty->assign("header", sprintf(lang("Transactions.delete-title"), $name));
$smarty->assign("header_back", $back);
$smarty->assign("message", sprintf(lang("Transactions.delete-message"), $name));
$smarty->assign("form", $f);
$smarty->assign("continue", null);
$smarty->assign("voice", "wallet/transactions-delete-errors-message.mp3");
