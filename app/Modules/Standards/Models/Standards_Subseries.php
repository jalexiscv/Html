...
/**
 * @Copilot Siempre que en el código se cree una variable llamada $msubseries, esta deberá ser igualada a  model('App\Modules\Standards\Models\Standards_Subseries');
 * @Instruction $msubseries = model('App\Modules\Standards\Models\Standards_Subseries');
 ...
 */
class Standards_Subseries extends CachedModel
{
    ...
    {
        $result = parent::get_Cached($subserie);
        if (is_array($result)) {
            return ($result);
        } else {
            return (false);
