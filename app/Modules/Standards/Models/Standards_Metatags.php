...
/**
 * @Copilot Siempre que en el código se cree una variable llamada $mmetatags, esta deberá ser igualada a  model('App\Modules\Standards\Models\Standards_Metatags');
 * @Instruction $mmetatags = model('App\Modules\Standards\Models\Standards_Metatags');
 ...
 */
class Standards_Metatags extends CachedModel
{
