...
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Standards\Views\Objects\Creator\validator.php]
...
$f->set_ValidationRule("type_content","trim|required");
$f->set_ValidationRule("type_node","trim|required");
$f->set_ValidationRule("attachments","trim|required");
