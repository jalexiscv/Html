...
/**
* █ ---------------------------------------------------------------------------------------------------------------------
* █ ░FRAMEWORK                                  2025-10-02 09:52:54
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Standards\Views\Scores\Delete\form.php]
...
$r= $model->getScore($oid);
$name = urldecode($r["description"]);
$message=sprintf(lang("Standards_Scores.delete-message"),$name);
$back="/standards/scores/list/{$r["object"]}?parent={$parent}";
//[fields]----------------------------------------------------------------------------------------------------------------
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
		 "class" =>"card-info",
		 "icon" => ICON_WARNING,
		 "title" => sprintf(lang("Standards_Scores.delete-title"),$name),
		 "text-class" =>"text-center",
		 "text"=>sprintf(lang("Standards_Scores.delete-message"),$name),
		 "content" =>$f,
		 "header-back" =>$back
));
echo($card);
