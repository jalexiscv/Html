...
/**
* █ ---------------------------------------------------------------------------------------------------------------------
* █ ░FRAMEWORK                                  2025-02-07 21:45:09
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Standards\Views\Categories\List\table.php]
...
$rows = $mcategories->get_CachedSearch($conditions,$limit, $offset,"name ASC");
$total = $mcategories->get_CountAllResults($conditions);
...
$card = $bootstrap->get_Card("card-grid", array(
		...
		"header-back" => $back,
		"header-add"=>"/standards/categories/create/" . lpk(),
		"alert" => array("icon" => ICON_INFO, "type" => "info", "title" => lang('Categories.list-title'), "message" => lang('Categories.list-description')),
		"content" => $bgrid,
));
echo($card);
?>