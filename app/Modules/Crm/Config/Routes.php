...
$mdm = model("App\Modules\Crm\Models\Crm_Modules");
$mdcxm = model("App\Modules\Crm\Models\Crm_Clients_Modules");
$module = 'crm';
...
if ($cxm == "authorized") {
    $routes->group($module,
        ['namespace' => $namespace],
        function ($subroutes) {
            $subroutes->add('/', 'Crm::index');
            $subroutes->add('/home', 'Crm::index');
            $subroutes->add('home/(:any)', 'Crm::home/$1');
    ...
    $routes->group($module, [
        'namespace' => $namespace],
        function ($subroutes) {
            $subroutes->add('/', 'Crm::denied/none');
            $subroutes->add('(:any)', 'Crm::denied/$1');
        }
    );
}
?>