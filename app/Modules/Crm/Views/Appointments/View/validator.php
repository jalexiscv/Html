 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Crm\Views\Appointments\Editor\validator.php]
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Appointments.view-errors-title"));
    $smarty->assign("message", lang("Appointments.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "crm/appointments-view-errors-message.mp3");
