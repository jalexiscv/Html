 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Crm\Views\Appointments\Delete\form.php]
...
$message = sprintf(lang("Appointments.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Appointments.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Appointments.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
