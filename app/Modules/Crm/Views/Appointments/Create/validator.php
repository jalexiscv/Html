...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-01-18 22:03:07
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Crm\Views\Appointments\Creator\validator.php]
...
// 1. Verificar el día asegurándose de que sea laboral (regla:no_Holiday)
// 2. Selección de Agente
// 3. Verificar Horario de Agente
// 4. Verificar Capacidad de Citas del Agente
// 5. Comprobar Citas Preexistentes
// 6. Asignación de Cita
$f->set_ValidationRule("appointment", "trim|required");
//$f->set_ValidationRule("agent","trim|required");
//$f->set_ValidationRule("customer","trim|required");
$f->set_ValidationRule("date", "trim|required|no_Holiday");
$f->set_ValidationRule("time", "trim|required");
//$f->set_ValidationRule("duration","trim|required");
