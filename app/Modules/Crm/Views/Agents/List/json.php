 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Crm\Views\Agents\List\json.php]
...
//[Asignations]---------------------------------------------------------------------------------------------------------
$data = array();
$component = '/crm/agents';
foreach ($list as $item) {
    //[Buttons]---------------------------------------------------------------------------------------------------------
    $viewer = "{$component}/view/{$item["agent"]}";
    $editor = "{$component}/edit/{$item["agent"]}";
    $deleter = "{$component}/delete/{$item["agent"]}";
    ...
    $row["morning_shift_start"] = $item["morning_shift_start"];
    $row["morning_shift_end"] = $item["morning_shift_end"];
    $row["afternoon_shift_start"] = $item["afternoon_shift_start"];
    $row["afternoon_shift_end"] = $item["afternoon_shift_end"];
