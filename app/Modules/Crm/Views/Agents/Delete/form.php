...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-01-18 01:20:05
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Crm\Views\Agents\Delete\form.php]
...
$r = $model->where('agent', $oid)->first();
$name = urldecode($r["name"]);
$message = sprintf(lang("Crm.agents-delete-message"), $name);
