 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Crm\Views\Agents\Creator\form.php]
...
$r["capacity"] = $f->get_Value("capacity");
$r["morning_shift_start"] = $f->get_Value("morning_shift_start", "08:00:00");
$r["morning_shift_end"] = $f->get_Value("morning_shift_end", "12:00:00");
$r["afternoon_shift_start"] = $f->get_Value("afternoon_shift_start", "14:00:00");
$r["afternoon_shift_end"] = $f->get_Value("afternoon_shift_end", "18:00:00");
