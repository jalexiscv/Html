 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Crm\Views\Agents\Editor\validator.php]
...
* -----------------------------------------------------------------------------
*/
$f->set_ValidationRule("agent", "trim|required");
...
$f->set_ValidationRule("capacity", "trim|required");
$f->set_ValidationRule("morning_shift_start", "trim|required");
$f->set_ValidationRule("morning_shift_end", "trim|required");
$f->set_ValidationRule("afternoon_shift_start", "trim|required");
$f->set_ValidationRule("afternoon_shift_end", "trim|required");
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Crm.agents-view-errors-title"));
    $smarty->assign("message", lang("Crm.agents-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "crm/agents-view-errors-message.mp3");
