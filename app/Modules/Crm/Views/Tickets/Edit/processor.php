...
if (is_array($row)) {
    ...
    $c = $bootstrap->get_Card("success", array(
        ...
        "title" => lang("Tickets.edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Tickets.edit-success-message"),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Tickets.edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Tickets.edit-noexist-message"), $d['ticket']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
