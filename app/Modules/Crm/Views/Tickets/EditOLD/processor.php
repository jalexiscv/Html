...
$l["back"] = "/crm/tickets/list/" . lpk();
$l["edit"] = "/crm/tickets/edit/{$d["ticket"]}";
$asuccess = "crm/tickets-edit-success-message.mp3";
$anoexist = "crm/tickets-edit-noexist-message.mp3";
//[build]---------------------------------------------------------------------------------------------------------------
if (is_array($row)) {
    $edit = $model->update($d['ticket'], $d);
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Crm.tickets-edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Crm.tickets-edit-success-message"),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Crm.tickets-edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Crm.tickets-edit-noexist-message"), $d['ticket']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
