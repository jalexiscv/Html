...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-01-20 20:43:34
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Crm\Views\Tickets\Delete\form.php]
...
$message = sprintf(lang("Crm.tickets-delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Tickets.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Tickets.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
