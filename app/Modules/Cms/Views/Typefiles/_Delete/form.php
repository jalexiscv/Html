...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-24 09:44:56
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Views\Typefiles\Delete\form.php]
...
//[vars]----------------------------------------------------------------------------------------------------------------
$f = service("forms", array("lang" => "Typefiles."));
$r = $model->get_Typefiles($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Typefiles.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Typefiles.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Typefiles.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
