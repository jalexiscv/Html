 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Views\Menus\Delete\form.php]
...
$r = $model->get_Menus($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Menus.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Menus.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Menus.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
