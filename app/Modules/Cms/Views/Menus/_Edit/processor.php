...
$asuccess = "cms/menus-edit-success-message.mp3";
$anoexist = "cms/menus-edit-noexist-message.mp3";
//[build]---------------------------------------------------------------------------------------------------------------
if (is_array($row)) {
    $edit = $model->update($d['menu'], $d);
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Menus.edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Menus.edit-success-message"),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Menus.edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Menus.edit-noexist-message"), $d['menu']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
