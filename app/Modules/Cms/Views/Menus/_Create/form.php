...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-24 09:43:28
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Views\Menus\Creator\form.php]
...
//[vars]----------------------------------------------------------------------------------------------------------------
$r["menu"] = $f->get_Value("menu");
$r["post"] = $f->get_Value("post");
$r["men_menu"] = $f->get_Value("men_menu");
...
$f->groups["g3"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["target"] .)));
