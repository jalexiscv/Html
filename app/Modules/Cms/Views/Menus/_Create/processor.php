 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Views\Menus\Creator\processor.php]
...
$l["back"] = "$back";
$l["edit"] = "/cms/menus/edit/{$d["menu"]}";
$asuccess = "cms/menus-create-success-message.mp3";
$aexist = "cms/menus-create-exist-message.mp3";
if (is_array($row)) {
    $c = $bootstrap->get_Card("duplicate", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Menus.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Menus.create-duplicate-message"),
    ...
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Menus.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Menus.create-success-message"), $d['menu']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
