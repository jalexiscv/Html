 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Views\Menus\List\table.php]
...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/cms/api/menus/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('icon' => ICON_ADD, 'text' => lang('App.Create'), 'href' => '/cms/menus/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'menu' => array('text' => lang('App.menu'), 'class' => 'text-center'),
        'post' => array('text' => lang('App.post'), 'class' => 'text-center'),
        'men_menu' => array('text' => lang('App.men_menu'), 'class' => 'text-center'),
        ...
        'target' => array('text' => lang('App.target'), 'class' => 'text-center'),
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang('Menus.list-title'),
    "header-back" => $back,
    "alert" => array("icon" => ICON_INFO, "type" => "info", "title" => lang('Menus.list-title'), "message" => lang('Menus.list-description')),
    "content" => $table,
));
echo($card);
?>
