...
$l["edit"] = "/cms/asigns/edit/{$d["asign"]}";
$asuccess = "cms/asigns-edit-success-message.mp3";
$anoexist = "cms/asigns-edit-noexist-message.mp3";
//[build]---------------------------------------------------------------------------------------------------------------
if (is_array($row)) {
    $edit = $model->update($d['asign'], $d);
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Asigns.edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Asigns.edit-success-message"),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Asigns.edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Asigns.edit-noexist-message"), $d['asign']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
