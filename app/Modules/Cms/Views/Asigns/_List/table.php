 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Views\Asigns\List\table.php]
...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/cms/api/asigns/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('icon' => ICON_ADD, 'text' => lang('App.Create'), 'href' => '/cms/asigns/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'asign' => array('text' => lang('App.asign'), 'class' => 'text-center'),
        'post' => array('text' => lang('App.post'), 'class' => 'text-center'),
        'meta' => array('text' => lang('App.meta'), 'class' => 'text-center'),
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang('Asigns.list-title'),
    "header-back" => $back,
    "alert" => array("icon" => ICON_INFO, "type" => "info", "title" => lang('Asigns.list-title'), "message" => lang('Asigns.list-description')),
    "content" => $table,
));
echo($card);
?>
