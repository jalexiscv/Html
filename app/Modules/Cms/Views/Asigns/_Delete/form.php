 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Views\Asigns\Delete\form.php]
...
$r = $model->get_Asigns($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Asigns.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Asigns.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Asigns.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
