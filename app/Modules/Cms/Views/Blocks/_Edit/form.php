 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Views\Blocks\Editor\form.php]
...
$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["area"] . $f->fields["author"] . $f->fields["created_at"])));
