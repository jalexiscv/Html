...
$asuccess = "cms/blocks-edit-success-message.mp3";
$anoexist = "cms/blocks-edit-noexist-message.mp3";
//[build]---------------------------------------------------------------------------------------------------------------
if (is_array($row)) {
    $edit = $model->update($d['block'], $d);
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Blocks.edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Blocks.edit-success-message"),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Blocks.edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Blocks.edit-noexist-message"), $d['block']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
