 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Views\Blocks\Delete\form.php]
...
$r = $model->get_Blocks($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Blocks.delete-message"), $name);
$back = "/cms/blocks/list/" . lpk();
//[fields]----------------------------------------------------------------------------------------------------------------
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Blocks.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Blocks.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
