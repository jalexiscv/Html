 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Views\Links\List\table.php]
...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/cms/api/links/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('icon' => ICON_ADD, 'text' => lang('App.Create'), 'href' => '/cms/links/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'link' => array('text' => lang('App.link'), 'class' => 'text-center'),
        'post' => array('text' => lang('App.post'), 'class' => 'text-center'),
        'text' => array('text' => lang('App.text'), 'class' => 'text-center'),
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang('Links.list-title'),
    "header-back" => $back,
    "alert" => array("icon" => ICON_INFO, "type" => "info", "title" => lang('Links.list-title'), "message" => lang('Links.list-description')),
    "content" => $table,
));
echo($card);
?>
