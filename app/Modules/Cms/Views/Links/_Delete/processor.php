...
$f = service("forms", array("lang" => "Links."));
...
$l["edit"] = "/cms/links/edit/{$pkey}";
$vsuccess = "cms/links-delete-success-message.mp3";
$vnoexist = "cms/links-delete-noexist-message.mp3";
/* Build */
if (isset($row["link"])) {
    ...
    $c = $bootstrap->get_Card("duplicate", array(
        ...
        "title" => lang("Links.delete-success-title"),
        "text-class" => "text-center",
        "text" => lang("Links.delete-success-message"),
    ...
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Links.delete-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Links.delete-noexist-message"), $d['link']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $vnoexist,
    ));
