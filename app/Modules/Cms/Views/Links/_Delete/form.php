 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Views\Links\Delete\form.php]
...
$r = $model->get_Links($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Links.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Links.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Links.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
