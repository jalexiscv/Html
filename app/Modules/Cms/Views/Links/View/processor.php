...
//$edit = $model->update($d);
    $c = $bootstrap->get_Card('warning', array(
        ...
        'title' => lang("Links.view-success-title"),
        'text' => lang("Links.view-success-message"),
        'footer-class' => 'text-center',
        'footer-continue' => base_url("/cms/links/view/{$d["link"]}/" . lpk()),
        'voice' => "cms/links-view-success-message.mp3",
    ));
} else {
    $c = $bootstrap->get_Card('success', array(
        ...
        'icon' => 'fa-duotone fa-triangle-exclamation',
        'text-class' => 'text-center',
        'title' => lang("Links.view-noexist-title"),
        'text' => lang("Links.view-noexist-message"),
        'footer-class' => 'text-center',
        'footer-continue' => base_url("/cms/links"),
        'voice' => "cms/links-view-noexist-message.mp3",
    ));
}
echo($c);
?>
