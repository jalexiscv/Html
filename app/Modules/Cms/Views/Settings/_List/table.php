 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Views\Settings\List\table.php]
...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/cms/api/settings/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('icon' => ICON_ADD, 'text' => lang('App.Create'), 'href' => '/cms/settings/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'setting' => array('text' => lang('App.setting'), 'class' => 'text-center'),
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang('Settings.list-title'),
    "header-back" => $back,
