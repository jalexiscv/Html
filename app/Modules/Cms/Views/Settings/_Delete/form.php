 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Views\Settings\Delete\form.php]
...
$r = $model->get_Settings($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Settings.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Settings.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Settings.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
