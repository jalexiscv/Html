 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cms\Views\Posts\List\table.php]
...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/cms/api/posts/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('icon' => ICON_ADD, 'text' => lang('App.Create'), 'href' => '/cms/posts/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        ...
        'body' => array('text' => lang('App.body'), 'class' => 'text-center'),
...
$card = $bootstrap->get_Card("card-view-service", array(
    ...
    "header-back" => $back,
    "alert" => array("icon" => ICON_INFO, "type" => "info", "title" => lang('Posts.list-title'), "message" => lang('Posts.list-description')),
    "content" => $table,
));
echo($card);
?>
