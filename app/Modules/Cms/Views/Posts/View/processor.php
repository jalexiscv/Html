...
//$edit = $model->update($d);
    $c = $bootstrap->get_Card('warning', array(
        ...
        'footer-continue' => base_url("/cms/posts/view/{$d["post"]}/" . lpk()),
        'voice' => "cms/posts-view-success-message.mp3",
    ));
} else {
    $c = $bootstrap->get_Card('success', array(
        ...
        'footer-class' => 'text-center',
        'footer-continue' => base_url("/cms/posts"),
        'voice' => "cms/posts-view-noexist-message.mp3",
    ));
}
echo($c);
?>
