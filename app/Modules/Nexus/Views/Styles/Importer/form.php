...
$back = "/nexus/styles/list/" . $r["theme"];
$resolutions = array(
    array("label" => "STD General", "value" => "default"),
    array("label" => "XXL ≥1400px", "value" => "xxl"),
    array("label" => "XL ≥1200px", "value" => "xl"),
    array("label" => "LG ≥992px", "value" => "lg"),
    array("label" => "MD ≥768px", "value" => "md"),
    array("label" => "SM ≥576px", "value" => "sm"),
    array("label" => "XS <576px", "value" => "xs"),
);
/*
* -----------------------------------------------------------------------------
* [Fields]
* -----------------------------------------------------------------------------
*/
$f->add_HiddenField("importer", pk());
$f->fields["resolution"] = $f->get_FieldSelect("resolution", array("value" => $r["resolution"], "data" => $resolutions, "proportion" => "col-12"));
$f->fields["style"] = $f->get_FieldText("style", array("value" => $r["style"], "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12", "readonly" => true));
$f->fields["theme"] = $f->get_FieldText("theme", array("value" => $r["theme"], "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12", "readonly" => true));
...
$f->fields["code"] = $f->get_FieldCode("code", array("value" => $r["code"], "mode" => "css", "proportion" => "col-12"));
...
* -----------------------------------------------------------------------------
*/
$f->groups["g0"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["style"] . $f->fields["theme"])));
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["resolution"])));
