...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Nexus.modules-view-errors-title"));
    $smarty->assign("message", lang("Nexus.modules-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "application/modules-view-errors-message.mp3");
