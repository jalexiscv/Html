...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Nexus.modules-edit-errors-title"));
    $smarty->assign("message", lang("Nexus.modules-edit-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "application/modules-edit-errors-message.mp3");
