...
if ($f->run_Validation()) {
    $c = view($processor, $data);
} else {
    $errors = $f->validation->listErrors();
    $smarty = service("smarty");
    $smarty->set_Mode("bs5x");
    $smarty->assign("title", lang("Nexus.clients-edit-errors-title"));
    $smarty->assign("message", lang("Nexus.clients-edit-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "nexus/clients-edit-errors-message.mp3");
