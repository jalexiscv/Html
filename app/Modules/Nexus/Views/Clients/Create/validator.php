 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Application\Views\Clients\Creator\validator.php]
...
$f = service("forms", array("lang" => "Application.clients-"));
//[Request]-----------------------------------------------------------------------------
...
if ($f->run_Validation()) {
    ...
    $c = $bootstrap->get_Card('access-denied', array(
        ...
        'text' => lang("Application.clients-create-errors-message"),
        'errors' => $errors,
        'footer-class' => 'text-center',
        'voice' => "application/clients-create-errors-message.mp3",
    ));
