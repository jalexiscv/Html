...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Application\Views\Themes\List\table.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$table = array(
    'id' => 'table-' . lpk(),
    'data-url' => '/nexus/api/themes/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('text' => lang('App.Create'), 'href' => '/nexus/themes/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'theme' => array('text' => lang('App.Theme'), 'class' => 'text-center'),
...
$smarty->assign('header', lang('Nexus.themes-list-title'));
$smarty->assign('body', '');
