...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Nexus.themes-edit-errors-title"));
    $smarty->assign("message", lang("Nexus.themes-edit-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "application/themes-edit-errors-message.mp3");
