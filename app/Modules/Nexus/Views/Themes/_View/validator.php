...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Application.themes-view-errors-title"));
    $smarty->assign("message", lang("Application.themes-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "application/themes-view-errors-message.mp3");
