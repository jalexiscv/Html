...
$ctable = view($component . '\coders\table', $data);
$cjson = view($component . '\coders\json', $data);
$cbreadcrumb = view($component . '\coders\breadcrumb', $data);

$code = $cindex . $cdeny . $ctable . $cjson . $cbreadcrumb;
...
$f->add_HiddenField("ctable", urlencode($ctable));
$f->add_HiddenField("cjson", urlencode($cjson));
...
$f->fields["submit"] = $f->get_Submit("submit", array("value" => "Guardar Lister", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-left"));
/*
 * -----------------------------------------------------------------------------
 * [Groups]
 * -----------------------------------------------------------------------------
...
$smarty->assign("header", lang("Nexus.generators-lister"));
