...
$code .= "\t//[{$ucf_component}]\n";
$code .= "\t//\"{$slc_module}-{$slc_component}-home\"=>component(\"{\$views}\\{$ucf_component}\\Home\\index\",\$data),\n";
$code .= "\t//\"{$slc_module}-{$slc_component}-list\"=>component(\"{\$views}\\{$ucf_component}\\List\\index\",\$data),\n";
$code .= "\t//\"{$slc_module}-{$slc_component}-view\"=>component(\"{\$views}\\{$ucf_component}\\View\\index\",\$data),\n";
$code .= "\t//\"{$slc_module}-{$slc_component}-create\"=>component(\"{\$views}\\{$ucf_component}\\Create\\index\",\$data),\n";
$code .= "\t//\"{$slc_module}-{$slc_component}-edit\"=>component(\"{\$views}\\{$ucf_component}\\Edit\\index\",\$data),\n";
$code .= "\t//\"{$slc_module}-{$slc_component}-delete\"=>component(\"{\$views}\\{$ucf_component}\\Delete\\index\",\$data),\n";
$code .= "\n";
...
$smarty->assign("header", lang("Nexus.generators-controller"));
