...
if (isset($row["client"])) {
    ...
    $smarty = service("smarty");
    $smarty->set_Mode("bs5x");
    $smarty->assign("title", lang("Nexus.clients-delete-success-title"));
    $smarty->assign("message", sprintf(lang("Nexus.clients-delete-success-message"), ""));
    //$smarty->assign("edit", base_url("/nexus/clients/edit/{$d['client']}/" . lpk()));
    $smarty->assign("continue", base_url("/nexus/generators"));
    $smarty->assign("voice", "nexus/clients-delete-success-message.mp3");
