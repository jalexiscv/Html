...
$code .= "        \"title\" => lang(\"{$ucf_module}.{$slc_component}-create-duplicate-title\"),\n";
$code .= "        \"text-class\" => \"text-center\",\n";
$code .= "        \"text\" => lang(\"{$ucf_module}.{$slc_component}-create-duplicate-message\"),\n";
...
$code .= "        \"icon\" => \"fa-duotone fa-triangle-exclamation\",\n";
$code .= "        \"title\" => lang(\"{$ucf_module}.{$slc_component}-create-success-title\"),\n";
$code .= "        \"text-class\" => \"text-center\",\n";
$code .= "        \"text\" => sprintf(lang(\"{$ucf_module}.{$slc_component}-create-success-message\"),\$d['{$fields[0]}']),\n";
$code .= "        \"footer-continue\" => \$l[\"back\"],\n";
$code .= "        \"footer-class\" => \"text-center\",\n";
$code .= "        \"voice\" =>\$asuccess,\n";
$code .= "    ));\n";
