...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Social\Views\Companies\Creator\deny.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Social.settings-access-denied-title"));
    $smarty->assign("message", lang("Social.settings-access-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", "/social/");
    $smarty->assign("voice", "social/companies-create-denied-message.mp3");
