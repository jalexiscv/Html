...
class Nexus_Datas extends Model
{
    ...
    public function regenerate()
    {
        ...
        $fields = [
            'data' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
    ...
    /**
     * Retorna el valor almacenado para el campo de un cliente
     * - Cacheado
     * @param type $id codigo primario del registro a consultar
     * @param type $author codigo del usuario del cual se pretende establecer la autoria
     * @return boolean falso o verdadero segun sea el caso
     */
    public function get_Field($reference, $field): string
    {
        $data = $this->where("reference", $reference)->where("name", $field)->orderBy("created_at", "DESC")->first();
