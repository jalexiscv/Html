...
class Nexus_Styles extends Model
{
    protected $table = "application_styles";
    protected $primaryKey = "style";
    ...
    public function regenerate()
    {
        if (!$this->tableExists($this->table)) {
            ...
            $fields = [
                'style' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'theme' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'selectors' => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => FALSE],
                'default' => ['type' => 'TEXT', 'null' => FALSE],
                'xxl' => ['type' => 'TEXT', 'null' => FALSE],
                'xl' => ['type' => 'TEXT', 'null' => FALSE],
                'lg' => ['type' => 'TEXT', 'null' => FALSE],
                'md' => ['type' => 'TEXT', 'null' => FALSE],
                'sm' => ['type' => 'TEXT', 'null' => FALSE],
                'xs' => ['type' => 'TEXT', 'null' => FALSE],
                'date' => ['type' => 'DATE', 'null' => FALSE],
                'time' => ['type' => 'TIME', 'null' => FALSE],
                'importer' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
