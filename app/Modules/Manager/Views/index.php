...
$version = round(($server->get_DirectorySize(APPPATH . 'Modules/Manager') / 102400), 6);
$data = $parent->get_Array();
$rviews = array(
		"default" => "{$views}\E404\index",
		"manager-denied" => "{$views}\Denied\index",
		"manager-home" => "{$views}\Home\index",
		//[others]------------------------------------------------------------------------------------------
);
...
$assign['left'] = get_manager_sidebar();
