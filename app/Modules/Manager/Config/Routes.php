...
$mdm = model("App\Modules\Manager\Models\Manager_Modules");
$mdcxm = model("App\Modules\Manager\Models\Manager_Clients_Modules");
$module = 'manager';
...
if ($cxm == "authorized") {
		$routes->group($module,
				['namespace' => $namespace],
				function ($subroutes) {
						$subroutes->add('/', 'Manager::index');
						$subroutes->add('/home', 'Manager::index');
						$subroutes->add('home/(:any)', 'Manager::home/$1');
		...
		$routes->group($module,
				['namespace' => $namespace],
				function ($subroutes) {
						$subroutes->add('/', 'Manager::denied');
						$subroutes->add('(:any)', 'Manager::denied');
				}
		);
}
}
