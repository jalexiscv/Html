...
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules}\Manager\Controllers\Manager.php]
...
class Manager extends ModuleController
{
		...
		{
				parent::__construct();
				$this->module = 'App\Modules\Manager';
				helper($this->module . '\Helpers\Manager');
				$this->prefix = 'manager';
		...
		{
				$url = base_url('manager/home/index.html');
