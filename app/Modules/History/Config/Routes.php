...
if (strpos($dirName, '_') === false) {
    ...
    $mdm = model("App\Modules\History\Models\History_Modules");
    $mdcxm = model("App\Modules\History\Models\History_Clients_Modules");
    $module = 'history';
    ...
    if ($cxm == "authorized") {
        $routes->group($module,
            ...
            function ($subroutes) {
                ...
                $subroutes->add('/home', 'History::index');
        ...
        $routes->group($module,
            ['namespace' => $namespace],
            function ($subroutes) {
                $subroutes->add('/', 'History::denied');
                $subroutes->add('(:any)', 'History::denied');
            }
        );
    }
}
