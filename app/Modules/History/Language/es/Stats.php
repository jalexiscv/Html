...
return [
    ...
    "placeholder_stat" => "stat",
    "placeholder_instance" => "instance",
    ...
    "list-title" => "Historial",
    "list-description"=>"Historial general de acciónes realizadas en la plataforma, por los usuarios registrados en el sistema. Para filtrar los resultados de la búsqueda, utilice los campos de búsqueda disponibles en la parte superior de la tabla.",
];
