...
$version = round(($server->get_DirectorySize(APPPATH . 'Modules/History') / 102400), 6);
$data = $parent->get_Array();
$rviews = array(
    "default" => "{$views}\E404\index",
    "history-denied" => "{$views}\Denied\index",
    "history-home" => "{$views}\Home\index",
    //[Stats]
    "history-stats-home" => "$views\Stats\Home\index",
    "history-stats-general" => "$views\Stats\List\index",
    "history-stats-list" => "$views\Stats\List\index",
    "history-stats-view" => "$views\Stats\View\index",
    "history-stats-create" => "$views\Stats\Create\index",
    "history-stats-edit" => "$views\Stats\Edit\index",
    "history-stats-delete" => "$views\Stats\Delete\index",
    //[others]------------------------------------------------------------------------------------------
);
...
$assign['left'] = get_history_sidebar();
