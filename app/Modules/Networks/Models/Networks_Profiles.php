...
namespace App\Modules\Networks\Models;

use Higgs\Model;
use Config\Database;

class Networks_Profiles extends Model
{
    protected $table = "networks_profiles";
    ...
    public function regenerate()
    {
        if (!$this->tableExists()) {
            ...
            $fields = [
                ...
                'citizenshipcard' => ['type' => 'VARCHAR', 'constraint' => 16, 'null' => FALSE],
                'first_name' => ['type' => 'TINYTEXT', 'null' => FALSE],
                'last_name' => ['type' => 'TINYTEXT', 'null' => FALSE],
                'address' => ['type' => 'TINYTEXT', 'null' => FALSE],
