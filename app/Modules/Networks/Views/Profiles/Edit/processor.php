...
$l["back"] = "/networks/profiles/list/" . lpk();
$l["edit"] = "/networks/profiles/edit/{$d["profile"]}";
$asuccess = "networks/profiles-edit-success-message.mp3";
$anoexist = "networks/profiles-edit-noexist-message.mp3";
//[Build]-----------------------------------------------------------------------------
if (is_array($row)) {
    ...
    $c = $bootstrap->get_Card("duplicate", array(
        ...
        "title" => lang("Profiles.edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Profiles.edit-success-message"),
    ...
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Profiles.edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Profiles.edit-noexist-message"), $d['profile']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
