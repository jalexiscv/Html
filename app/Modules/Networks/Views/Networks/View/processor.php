...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Networks\Views\Networks\Editor\processor.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
if (isset($row["network"])) {
    ...
    $smarty->assign("edit", base_url("/cadastre/networks/edit/{$d['network']}/" . lpk()));
    $smarty->assign("continue", base_url("/cadastre/networks/view/{$d["network"]}/" . lpk()));
    $smarty->assign("voice", "cadastre/networks-view-success-message.mp3");
    ...
    $smarty->assign("continue", base_url("/cadastre/networks"));
    $smarty->assign("voice", "cadastre/networks-view-noexist-message.mp3");
