...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Networks\Views\Networks\List\deny.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$continue = "/cadastre/resources/home/" . pk();
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Networks.list-denied-title"));
    $smarty->assign("message", lang("Networks.list-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "cadastre/networks-list-denied-message.mp3");
