...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2023-06-21 20:03:06
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Networks\Views\Customers\Creator\index.php]
...
return [
    // - Customers fields
    "label_customer" => "Codigo del cliente",
    ...
    "edit-success-message" => "Los datos del cliente se <b>actualizaron exitosamente</b>, para retornar al listado general de clientes presioné el botón continuar en la parte inferior del presente mensaje.",
    // - Customers deleter
    ...
    "delete-success-message" => "La cliente se elimino exitosamente, para retornar al listado de general de clientes presioné el botón continuar en la parte inferior de este mensaje.",
    // - Customers list
