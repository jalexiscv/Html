 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sogt\Views\Telemetry\Creator\validator.php]
...
//[Request]-----------------------------------------------------------------------------
//$f->set_ValidationRule("telemetry","trim|required");
...
//$f->set_ValidationRule("altitude","trim|required");
//$f->set_ValidationRule("speed","trim|required");
//$f->set_ValidationRule("heading","trim|required");
//$f->set_ValidationRule("gps_valid","trim|required");
//$f->set_ValidationRule("satellites","trim|required");
//$f->set_ValidationRule("network","trim|required");
//$f->set_ValidationRule("battery","trim|required");
//$f->set_ValidationRule("ignition","trim|required");
//$f->set_ValidationRule("event","trim|required");
//$f->set_ValidationRule("motion","trim|required");
//$f->set_ValidationRule("timestamp","trim|required");
