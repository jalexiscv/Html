 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sogt\Views\Telemetry\Delete\form.php]
...
$r = $model->getTelemetry($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Sogt_Telemetry.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Sogt_Telemetry.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Sogt_Telemetry.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
