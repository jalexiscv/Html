 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sogt\Views\Devices\Creator\processor.php]
...
$asuccess = "sogt/devices-create-success-message.mp3";
$aexist = "sogt/devices-create-exist-message.mp3";
if (is_array($row)) {
    $c = $bootstrap->get_Card("duplicate", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Sogt_Devices.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Sogt_Devices.create-duplicate-message"),
    ...
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Sogt_Devices.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Sogt_Devices.create-success-message"), $d['device']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
