...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2025-08-26 00:44:17
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sogt\Views\Devices\Creator\form.php]
...
$r["tenant"] = $f->get_Value("tenant");
$r["name"] = $f->get_Value("name");
$r["alias"] = $f->get_Value("alias");
$r["device_type"] = $f->get_Value("device_type");
$r["asset_type"] = $f->get_Value("asset_type");
$r["asset_ref"] = $f->get_Value("asset_ref");
$r["imei"] = $f->get_Value("imei");
$r["serial"] = $f->get_Value("serial");
$r["iccid"] = $f->get_Value("iccid");
$r["imsi"] = $f->get_Value("imsi");
$r["mac_address"] = $f->get_Value("mac_address");
$r["vendor"] = $f->get_Value("vendor");
$r["model"] = $f->get_Value("model");
$r["firmware_version"] = $f->get_Value("firmware_version");
$r["protocol"] = $f->get_Value("protocol");
$r["transport"] = $f->get_Value("transport");
$r["server_host"] = $f->get_Value("server_host");
$r["server_port"] = $f->get_Value("server_port");
$r["apn"] = $f->get_Value("apn");
$r["carrier"] = $f->get_Value("carrier");
$r["sim_phone"] = $f->get_Value("sim_phone");
$r["auth_key"] = $f->get_Value("auth_key");
$r["ip_whitelist"] = $f->get_Value("ip_whitelist");
$r["has_ignition"] = $f->get_Value("has_ignition");
$r["has_sos"] = $f->get_Value("has_sos");
$r["has_temp"] = $f->get_Value("has_temp");
$r["has_fuel"] = $f->get_Value("has_fuel");
$r["supports_ble"] = $f->get_Value("supports_ble");
$r["report_interval_moving_s"] = $f->get_Value("report_interval_moving_s");
$r["report_interval_idle_s"] = $f->get_Value("report_interval_idle_s");
$r["overspeed_kmh"] = $f->get_Value("overspeed_kmh");
$r["timezone_offset_min"] = $f->get_Value("timezone_offset_min");
$r["status"] = $f->get_Value("status");
$r["activation_date"] = $f->get_Value("activation_date");
$r["installed_on"] = $f->get_Value("installed_on");
$r["installed_by"] = $f->get_Value("installed_by");
$r["warranty_until"] = $f->get_Value("warranty_until");
$r["tags"] = $f->get_Value("tags");
...
$f->groups["g14"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["tags"] . $f->fields["notes"] .)));
$f->groups["g15"] = $f->get_Group(array("legend" => "", "fields" => ()));
//[buttons]-------------------------------------------------------------------------------------------------------------
$f->groups["gy"] = $f->get_GroupSeparator();
$f->groups["gz"] = $f->get_Buttons(array("fields" => $f->fields["submit"] . $f->fields["cancel"]));
//[build]---------------------------------------------------------------------------------------------------------------
$card = $b->get_Card("create", array(
    "title" => lang("Sogt_Devices.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
