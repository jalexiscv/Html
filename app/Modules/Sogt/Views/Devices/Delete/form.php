...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2025-08-26 00:44:21
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sogt\Views\Devices\Delete\form.php]
...
$r = $model->getDevic($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Sogt_Devices.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Sogt_Devices.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Sogt_Devices.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
