 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules}\Sogt\Controllers\Sogt.php]
...
class Maps extends ModuleController
{
    ...
    public function __construct()
    {
        ...
        $this->prefix = 'sogt-maps';
        $this->views = $this->module . '\Views';
        $this->viewer = $this->views . '\index';
        $this->component = $this->views . '\Maps';
    }

    public function index()
    {
        $alias = safe_get_alias();
        $url = base_url("sogt/home/{$alias}.html");
