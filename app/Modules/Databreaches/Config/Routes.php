...
$mdm = model("App\Modules\Databreaches\Models\Databreaches_Modules");
$mdcxm = model("App\Modules\Databreaches\Models\Databreaches_Clients_Modules");
$module = 'databreaches';
...
if ($cxm == "authorized") {
		$routes->group($module,
				['namespace' => $namespace],
				function ($subroutes) {
						$subroutes->add('/', 'Databreaches::index');
						$subroutes->add('/home', 'Databreaches::index');
						$subroutes->add('home/(:any)', 'Databreaches::home/$1');
		...
		$routes->group($module,
				['namespace' => $namespace],
				function ($subroutes) {
						$subroutes->add('/', 'Databreaches::denied');
						$subroutes->add('(:any)', 'Databreaches::denied');
				}
		);
}
}
