 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Databreaches\Views\Breaches\Editor\form.php]
...
//[Fields]-----------------------------------------------------------------------------
$f->add_HiddenField("breach", $r["breach"]);
...
$f->fields["edit"] = $f->get_Button("edit", array("href" => "/databreaches/breaches/edit/" . $oid, "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
//[Groups]-----------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["breach"] . $f->fields["date"] . $f->fields["time"])));
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang("Breaches.view-title"),
    "header-back" => $back,
    "content" => $f,
    "content-class" => "px-2",
));
