 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Databreaches\Views\Breaches\Delete\form.php]
...
$r = $model->where('breach', $oid)->first();
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Breaches.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Breaches.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
