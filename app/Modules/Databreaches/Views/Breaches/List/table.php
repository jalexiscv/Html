...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-04-03 07:01:42
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Databreaches\Views\Breaches\List\table.php]
...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/databreaches/api/breaches/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('icon' => ICON_ADD, 'text' => lang('App.Create'), 'href' => '/databreaches/breaches/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'breach' => array('text' => lang('App.Breach'), 'class' => 'text-center'),
        'reference' => array('text' => lang('App.Reference'), 'class' => 'text-start'),
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang('Breaches.list-title'),
    "header-back" => $back,
    "content" => $table,
));
echo($card);
