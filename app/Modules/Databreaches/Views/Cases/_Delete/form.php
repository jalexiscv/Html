 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Databreaches\Views\Cases\Delete\form.php]
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Cases.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Cases.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
