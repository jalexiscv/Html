...
//$count = number_format($mdatabreaches->count(), 0, ',', '.');
//$url = 'https://mongo.c4isr.co/api/databreaches/json/count/123';
?>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        function updateBreachesCount() {
            fetch('https://mongo.c4isr.co/api/databreaches/json/count/123')
