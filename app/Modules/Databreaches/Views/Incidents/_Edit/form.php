 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Databreaches\Views\Incidents\Editor\form.php]
...
//[vars]----------------------------------------------------------------------------------------------------------------
$row = $model->where('incident', $oid)->first();
$r["incident"] = $f->get_Value("incident", $row["incident"]);
...
$card = $bootstrap->get_Card("create", array(
    "title" => lang("Incidents.edit-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
