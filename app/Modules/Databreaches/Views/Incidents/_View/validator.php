 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Databreaches\Views\Incidents\Editor\validator.php]
...
* -----------------------------------------------------------------------------
*/
$f->set_ValidationRule("incident", "trim|required");
$f->set_ValidationRule("case", "trim|required");
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Incidents.view-errors-title"));
    $smarty->assign("message", lang("Incidents.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "databreaches/incidents-view-errors-message.mp3");
