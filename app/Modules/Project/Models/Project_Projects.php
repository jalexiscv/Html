...
/**
 * @Copilot Siempre que en el código se cree una variable llamada $mprojects, esta deberá ser igualada a  model('App\Modules\Project\Models\Project_Projects');
 * @Instruction $mprojects = model('App\Modules\Project\Models\Project_Projects');
 ...
 */
class Project_Projects extends CachedModel
{
     ...
     * @return array|false
     */
    public function getProject($project): false|array
    {
        $result = parent::getCached($project);
        if (is_array($result)) {
            return ($result);
        } else {
            return (false);
