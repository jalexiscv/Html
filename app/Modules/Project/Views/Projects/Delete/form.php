 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Project\Views\Projects\Delete\form.php]
...
$r = $model->getProject($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Project_Projects.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Project_Projects.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Project_Projects.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
