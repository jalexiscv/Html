...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2025-04-28 21:56:53
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Project\Views\Statuses\Editor\form.php]
...
$f->fields["details"] = $f->get_FieldView("details", array("value" => $r["details"], "proportion" => "col-sm-12 col-12"));
...
$f->fields["edit"] = $f->get_Button("edit", array("href" => "/project/statuses/edit/" . $oid, "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
//[Groups]-----------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["status"] . $f->fields["task"] . $f->fields["value"])));
...
$card = $bootstrap->get_Card2("card-view-service", array(
    "header-title" => lang("Project_Statuses.view-title"),
    "header-back" => $back,
    "content" => $f,
));
echo($card);
