...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2025-04-28 21:56:52
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Project\Views\Statuses\Creator\form.php]
...
$f->fields["value"] = $f->get_FieldSelect("value", array("selected" => $r["value"], "data" => $statuses, "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$card = $b->get_Card2("create", array(
    "header-title" => lang("Project_Statuses.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
