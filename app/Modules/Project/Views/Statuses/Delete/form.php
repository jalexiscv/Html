 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Project\Views\Statuses\Delete\form.php]
...
$r = $model->getStatus($oid);
$name = urldecode($r["value"]);
$message = sprintf(lang("Project_Statuses.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Project_Statuses.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Project_Statuses.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
