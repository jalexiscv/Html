 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Project\Views\Tasks\Delete\form.php]
...
$message = sprintf(lang("Project_Tasks.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Project_Tasks.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Project_Tasks.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
