 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Project\Views\Tasks\Creator\form.php]
 ...
 **/
$r["task"] = $f->get_Value("task", pk());
$r["project"] = $f->get_Value("project", $oid);
...
$card = $b->get_Card2("create", array(
    "header-title" => lang("Project_Tasks.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
