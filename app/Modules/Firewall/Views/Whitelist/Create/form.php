...
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Firewall\Views\Whitelist\Creator\form.php]
...
$f->fields["id"] = $f->get_FieldText("id", array("value" => $r["id"],"proportion"=>"col-md-4 col-sm-12 col-12","readonly"=>true));
...
$card = $b->get_Card("create", array(
		 "title" => lang("Firewall_Whitelist.create-title"),
		 "content" =>$f,
		 "header-back" =>$back
));
echo($card);
