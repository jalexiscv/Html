...
$bgrid->set_Headers(array(
    ...
    array("content" => "ID", "class" => "text-center	align-middle"),
...
$card = $bootstrap->get_Card2("card-grid", array(
    ...
    "alert" => array("icon" => ICON_INFO, "type" => "info", "title" => lang('Firewall_Whitelist.list-title'), "message" => lang('Firewall_Whitelist.list-description')),
    "content" => $bgrid,
));
echo($card);
?>