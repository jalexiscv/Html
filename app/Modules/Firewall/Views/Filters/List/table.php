...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-02-14 11:01:57
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Firewall\Views\Filters\List\table.php]
...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/firewall/api/filters/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('icon' => ICON_ADD, 'text' => lang('App.Create'), 'href' => '/firewall/filters/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'filter' => array('text' => lang('App.filter'), 'class' => 'text-center'),
        'name' => array('text' => lang('App.name'), 'class' => 'text-center'),
        'expression' => array('text' => lang('App.expression'), 'class' => 'text-center', 'visible' => false),
