 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Firewall\Views\Badbots\Delete\form.php]
...
$r = $model->where('bot', $oid)->first();
$name = urldecode($r["name"]);
$message = sprintf(lang("Firewall.badbots-delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Badbots.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Badbots.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
