...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-02-13 19:14:18
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Firewall\Views\Badbots\Editor\form.php]
...
$back = "/firewall/badbots/list/" . lpk();
//[Fields]-----------------------------------------------------------------------------
...
$f->fields["edit"] = $f->get_Button("edit", array("href" => "/firewall/badbots/edit/" . $oid, "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
//[Groups]-----------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["bot"] . $f->fields["reference"] . $f->fields["name"])));
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang("Firewall.badbots-view-title"),
    "header-back" => $back,
    "content" => $f,
));
echo($card);
