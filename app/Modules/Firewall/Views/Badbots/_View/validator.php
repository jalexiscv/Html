 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Firewall\Views\Badbots\Editor\validator.php]
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Firewall.badbots-view-errors-title"));
    $smarty->assign("message", lang("Firewall.badbots-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "firewall/badbots-view-errors-message.mp3");
