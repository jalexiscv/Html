...
//[fields]----------------------------------------------------------------------------------------------------------------
$f->fields["bot"] = $f->get_FieldText("bot", array("value" => $r["bot"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "readonly" => true));
...
//[groups]----------------------------------------------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["bot"] . $f->fields["reference"])));
