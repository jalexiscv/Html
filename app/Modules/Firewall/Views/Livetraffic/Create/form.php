 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Firewall\Views\Livetraffic\Creator\form.php]
...
//[vars]----------------------------------------------------------------------------------------------------------------
$r["traffic"] = $f->get_Value("traffic");
$r["ip"] = $f->get_Value("ip");
$r["useragent"] = $f->get_Value("useragent");
$r["browser"] = $f->get_Value("browser");
$r["browser_code"] = $f->get_Value("browser_code");
$r["os"] = $f->get_Value("os");
$r["os_code"] = $f->get_Value("os_code");
$r["device_type"] = $f->get_Value("device_type");
$r["country"] = $f->get_Value("country");
$r["country_code"] = $f->get_Value("country_code");
$r["request_uri"] = $f->get_Value("request_uri");
$r["domain"] = $f->get_Value("domain");
$r["referer"] = $f->get_Value("referer");
$r["bot"] = $f->get_Value("bot");
$r["date"] = $f->get_Value("date", service("dates")::get_Date());
$r["time"] = $f->get_Value("time", service("dates")::get_Time());
$r["uniquev"] = $f->get_Value("uniquev");
...
$card = $b->get_Card("create", array(
    "title" => lang("Firewall.livetraffic-create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
