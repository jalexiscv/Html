 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Firewall\Views\Livetraffic\Creator\processor.php]
...
$l["back"] = "/firewall/livetraffic/list/" . lpk();
$l["edit"] = "/firewall/livetraffic/edit/{$d["traffic"]}";
$asuccess = "firewall/livetraffic-create-success-message.mp3";
$aexist = "firewall/livetraffic-create-exist-message.mp3";
if (is_array($row)) {
    $c = $card = $bootstrap->get_Card("duplicate", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Firewall.livetraffic-create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Firewall.livetraffic-create-duplicate-message"),
    ...
    $c = $card = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Firewall.livetraffic-create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Firewall.livetraffic-create-success-message"), $d['traffic']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
