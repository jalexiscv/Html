...
$asuccess = "firewall/livetraffic-edit-success-message.mp3";
$anoexist = "firewall/livetraffic-edit-noexist-message.mp3";
//[build]---------------------------------------------------------------------------------------------------------------
if (is_array($row)) {
    $edit = $model->update($d['traffic'], $d);
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Firewall.livetraffic-edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Firewall.livetraffic-edit-success-message"),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Firewall.livetraffic-edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Firewall.livetraffic-edit-noexist-message"), $d['traffic']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
