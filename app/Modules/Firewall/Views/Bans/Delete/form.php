 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Firewall\Views\Bans\Delete\form.php]
...
$r = $model->where('ban', $oid)->first();
$name = urldecode($r["ip"]);
$message = sprintf(lang("Bans.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Bans.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Bans.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
