 ...
 */
class Firewall_Filters extends Model
{
    protected $table = "firewall_filters";
    ...
    private function exec_TableRegenerate()
    {
        if (!$this->get_TableExist()) {
            ...
            $fields = [
                'filter' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'name' => ['type' => 'VARCHAR', 'constraint' => 128, 'null' => FALSE],
                'expression' => ['type' => 'TINYTEXT', 'null' => FALSE],
