...
/**
* @Copilot Siempre que en el código se cree una variable llamada $mwhitelist, esta deberá ser igualada a  model('App\Modules\Firewall\Models\Firewall_Whitelist');
* @Instruction $mwhitelist = model('App\Modules\Firewall\Models\Firewall_Whitelist');
...
*/
class Firewall_Whitelist extends CachedModel
	 {
		 protected $table = "firewall_whitelist";
