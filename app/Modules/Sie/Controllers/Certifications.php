...
class Certifications extends ModuleController
{
    ...
    /**
     * Certificado de estudios" en inglés se dice "academic certificate" o "certificate of studies".
     * @param string $oid
     * @return array|false|mixed|string
     */
    public function studies(string $oid)
    {
        $this->oid = $oid;
        //$this->prefix = "{$this->prefix}-studies";
        //$this->component = $this->views . '\Certifications\Studies';
        return (view("App\Modules\Sie\Views\Certifications\Studies\index", $this->get_Array()));
    }
