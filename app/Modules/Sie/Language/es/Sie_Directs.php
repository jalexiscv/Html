...
/**
* █ ---------------------------------------------------------------------------------------------------------------------
* █ ░FRAMEWORK                                  2025-11-26 08:37:51
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Directs\Creator\index.php]
...
return [
	// - Directs fields 
	"label_direct"=>"Código del enlace directo",
	"label_title"=>"Titulo de la tarjeta",
	"label_content"=>"Contenido / Descripción",
	"label_href"=>"Enlace",
	"label_target"=>"Destino",
    "label_file"=>"Imagen de la tarjeta",
	"label_author"=>"author",
	"label_created_at"=>"created_at",
	"label_updated_at"=>"updated_at",
	"label_deleted_at"=>"deleted_at",
	"placeholder_direct"=>"direct",
	...
	"help_target"=>"target",
	"help_author"=>"author",
    "help_file"=>"Formatos: jpg,png,gif,jpeg",
	...
	"create-title"=>"Crear nuevo enlace directo",
	...
	"list-title"=>"Listado de enlaces directos",
