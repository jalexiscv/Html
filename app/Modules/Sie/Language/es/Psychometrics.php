...
return [
    ...
    "create-title" => "Crear nuevo la prueba",
    ...
    "create-duplicate-title" => "¡la prueba existente!",
    "create-duplicate-message" => "Este la prueba ya se había registrado previamente, presioné continuar en la parte inferior de este mensaje para retornar al listado general de #plural.",
    "create-success-title" => "¡la prueba registrada exitosamente!",
    "create-success-message" => "La la prueba se registró exitosamente, para retornar al listado general de #plural presioné continuar en la parte inferior de este mensaje.",
    // - Psychometrics viewer
    ...
    "edit-title" => "¡Actualizar la prueba!",
    ...
    "edit-success-title" => "¡la prueba actualizada!",
    "edit-success-message" => "Los datos de la prueba se <b>actualizaron exitosamente</b>, para retornar al listado general de #plural presioné el botón continuar en la parte inferior del presente mensaje.",
    // - Psychometrics deleter
    ...
    "delete-title" => "¡Eliminar la prueba!",
    "delete-message" => "Para confirmar la eliminación del la prueba <b>%s</b>, presioné eliminar, para retornar al listado general de #plural presioné cancelar.",
    ...
    "delete-success-title" => "¡la prueba eliminad@ exitosamente!",
    "delete-success-message" => "La la prueba se elimino exitosamente, para retornar al listado de general de #plural presioné el botón continuar en la parte inferior de este mensaje.",
    // - Psychometrics list
