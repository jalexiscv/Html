...
//$edit = $model->update($d);
    $c = $bootstrap->get_Card('warning', array(
        ...
        'title' => lang("Sie_Programs.view-success-title"),
        'text' => lang("Sie_Programs.view-success-message"),
        'footer-class' => 'text-center',
        'footer-continue' => base_url("/sie/programs/view/{$d["program"]}/" . lpk()),
        'voice' => "sie/programs-view-success-message.mp3",
    ));
} else {
    $c = $bootstrap->get_Card('success', array(
        ...
        'icon' => 'fa-duotone fa-triangle-exclamation',
        'text-class' => 'text-center',
        'title' => lang("Sie_Programs.view-noexist-title"),
        'text' => lang("Sie_Programs.view-noexist-message"),
        'footer-class' => 'text-center',
        'footer-continue' => base_url("/sie/programs"),
        'voice' => "sie/programs-view-noexist-message.mp3",
    ));
}
echo($c);
?>
