 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Q10profiles\Creator\processor.php]
...
$asuccess = "sie/q10profiles-create-success-message.mp3";
$aexist = "sie/q10profiles-create-exist-message.mp3";
if (is_array($row)) {
    $c = $bootstrap->get_Card("duplicate", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Q10profiles.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Q10profiles.create-duplicate-message"),
    ...
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Q10profiles.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Q10profiles.create-success-message"), $d['profile']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
