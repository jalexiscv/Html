 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Executions\Editor\validator.php]
...
//[Request]-----------------------------------------------------------------------------
$f->set_ValidationRule("execution", "trim|required");
$f->set_ValidationRule("progress", "trim|required");
$f->set_ValidationRule("course", "trim|required");
$f->set_ValidationRule("date_start", "trim|required");
$f->set_ValidationRule("date_end", "trim|required");
$f->set_ValidationRule("c1", "trim|numeric|required");
$f->set_ValidationRule("c2", "trim|numeric|required");
$f->set_ValidationRule("c3", "trim|numeric|required");
$f->set_ValidationRule("total", "trim|numeric|required");
