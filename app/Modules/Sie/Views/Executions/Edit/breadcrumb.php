 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Executions\Creator\deny.php]
...
$menu = array(
    ...
    array("href" => "/sie/courses/view/{$execution["course"]}", "text" => "Curso", "class" => false),
    array("href" => "/sie/executions/edit/{$oid}", "text" => "Calificando", "class" => "active"),
);
