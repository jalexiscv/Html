...
$asuccess = "sie/executions-create-success-message.mp3";
$aexist = "sie/executions-create-exist-message.mp3";
if (is_array($row)) {
    $c = $bootstrap->get_Card("duplicate", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Executions.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Executions.create-duplicate-message"),
    ...
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Executions.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Executions.create-success-message"), $d['execution']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
