...
$r["progress"] = $f->get_Value("progress");
...
$f->fields["execution"] = $f->get_FieldText("execution", array("value" => $r["execution"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["progress"] = $f->get_FieldText("progress", array("value" => $r["progress"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["course"] = $f->get_FieldText("course", array("value" => $r["course"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$card = $b->get_Card("create", array(
    "title" => lang("Executions.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
