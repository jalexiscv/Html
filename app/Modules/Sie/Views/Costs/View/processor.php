...
//$edit = $model->update($d);
    $c = $bootstrap->get_Card('warning', array(
        ...
        'title' => lang("Sie_Costs.view-success-title"),
        'text' => lang("Sie_Costs.view-success-message"),
        'footer-class' => 'text-center',
        'footer-continue' => base_url("/sie/costs/view/{$d["cost"]}/" . lpk()),
        'voice' => "sie/costs-view-success-message.mp3",
    ));
} else {
    $c = $bootstrap->get_Card('success', array(
        ...
        'icon' => 'fa-duotone fa-triangle-exclamation',
        'text-class' => 'text-center',
        'title' => lang("Sie_Costs.view-noexist-title"),
        'text' => lang("Sie_Costs.view-noexist-message"),
        'footer-class' => 'text-center',
        'footer-continue' => base_url("/sie/costs"),
        'voice' => "sie/costs-view-noexist-message.mp3",
    ));
}
echo($c);
?>
