 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Costs\Delete\form.php]
...
$r = $model->getCost($oid);
$name = urldecode($r["period"]);
$message = sprintf(lang("Sie_Costs.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Sie_Costs.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Sie_Costs.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
