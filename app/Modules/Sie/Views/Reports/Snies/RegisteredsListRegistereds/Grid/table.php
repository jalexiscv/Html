...
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >AÑO</th>\n";
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >SEMESTRE</th>\n";
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >ID_TIPO_DOCUMENTO</th>\n";
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >NUM_DOCUMENTO</th>\n";
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >PRIMER NOMBRE</th>\n";
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >SEGUNDO NOMBRE</th>\n";
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >PRIMER APELLIDO</th>\n";
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >SEGUNDO APELLIDO</th>\n";
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >SEXO BIOLOGICO</th>\n";
/**
 * $code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >#</th>\n";
...
foreach ($statuses["data"] as $status) {
    ...
    // bulding columns
    $program = "";
    $name = explode(" ", $registration_name);
    $lastname = explode(" ", $registration_lastname);
    ...
    $code .= "<td class='text-center text-nowrap'>" . @$lastname[1] . "</td>\n";
