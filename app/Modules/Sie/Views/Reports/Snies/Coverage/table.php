...
$code .= "<th class='text-center ' title=\"\" >ID_MUNICIPIO_ESTUDIO</th>\n";
$code .= "<th class='text-center ' title=\"\" >EN_LA_NOCHE_ESTUDIO</th>\n";
$code .= "<th class='text-center ' title=\"\" >CICLOS_BASICOS</th>\n";
$code .= "</tr>\n";
$code .= "</thead>";
$code .= "<tbody>";
...
foreach ($statuses as $status) {
    ...
    $code .= "<td class='text-center ' title=\"\" >{$ID_MUNICIPIO_ESTUDIO}</td>\n";
    $code .= "<td class='text-center ' title=\"\" >{$EN_LA_NOCHE_ESTUDIO}</td>";
    $code .= "<td class='text-center ' title=\"\" >{$CICLOS_BASICOS}</td>";
    $code .= "</tr>\n";
}
