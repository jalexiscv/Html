...
foreach ($statuses as $status) {
    ...
    $status_textual_journey = get_sie_textual_journey(@$status['journey']);
    $status_textual_status = get_sie_textual_status(@$status['reference']);
    $author = $mfields->get_Profile($status['author']);
    $status_status_author = @$author['name'];
    //[build]-----------------------------------------------------------------------------------------------------------
    $code .= "<tr class=\"{$class}\">";
    ...
    $code .= "    <td class='text-center text-nowrap'>{$status_textual_journey}</td>";
    ...
    $code .= "    <td class='text-center text-nowrap'>{$status_status_author}</td>";
    $code .= "</tr>";
}
$code .= "</table>";
//echo($code);
