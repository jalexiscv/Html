        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="myModalLabel">Prematricula Financiera</h1>
                ...
                <div class="modal-body">
                    <form method="get">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="statusX" value="MATRICULADOS / MATRICULADOS ANTIGUOS"
                                   class="form-control" id="statusX" readonly>
                        </div>
                        <div class="mb-3">
                            <div class="alert alert-primary" role="alert">
                                Este reporte solo incluye estudiantes matriculados en el periodo académico anterior, con
                                el objetivo de facturar el ciclo siguiente.
                            </div>
                        </div>
