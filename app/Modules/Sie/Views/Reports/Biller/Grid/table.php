...
$statuses = $mstatuses->get_DetailsMultiStatus($program, $period, $status, $limit, $offset);
...
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >PERIODO</th>\n";
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >ESTADO</th>\n";
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >CICLO</th>\n";
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >PERIODO</th>\n";
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >FACTURAR</th>\n";
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >FACTURA</th>\n";
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >ID</th>\n";
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >DOCUMENTO</th>\n";
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >NOMBRE</th>\n";
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >APELLIDOS</th>\n";
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >PROGRAMA</th>\n";
$code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >ID_MUNICIPIO</th>\n";
/**
 * $code .= "<th class='text-center ' title=\"{$n["CONSECUTIVO"]}\" >#</th>\n";
...
foreach ($statuses["data"] as $status) {
    ...
    ////ENROLLED, ENROLLED-OLD, ENROLLED-EXT
    $status_name = "";
    if ($status_reference == "ENROLLED") {
        $status_name = "MATRICULADO";
    } elseif ($status_reference == "ENROLLED-OLD") {
        $status_name = "MATRICULADO-ANTIGUO";
    } elseif ($status_reference == "ENROLLED-EXT") {
        $status_name = "MATRICULADO-EXTENSIÓN";
    } else {
        $status_name = "ERROR";
    }

    $nextPeriod = $dates->getNextPeriod($period);
    $order = $morders->getFirstByRegistrationByPeriodByTypeOfProduct($registration_registration, $nextPeriod, "ENROLLMENT");

    $code .= "<td class='text-center'>{$count}</td>\n";
    $code .= "<td class='text-center'>{$period}</td>\n";
    $code .= "<td class='text-left'>{$status_name}</td>\n";
    $code .= "<td class='text-center'>{$cycle}</td>\n";
    $code .= "<td class='text-center'>{$moment}</td>\n";
    $code .= "<td class='text-center'><a href=\"/sie/students/view/{$registration_registration}#finance\" target=\"_blank\">FACTURAR</></td>\n";
    $code .= "<td class='text-center'>" . @$order["order"] . "</td>\n";
    $code .= "<td class='text-end'>{$identification_type}</td>\n";
    $code .= "<td class='text-end'>{$identification_number}</td>\n";
    $code .= "<td class='text-left'>{$registration_name}</td>\n";
    $code .= "<td class='text-left'>{$registration_lastname}</td>\n";
    $code .= "<td class='text-left'>{$program_name}</td>\n";
     ...
     * $code .= "<td class='text-left text-nowrap'><a href=\"/sie/students/view/{$registration_registration}\" target='\_blank\"'>{$identification_number}</td>";
