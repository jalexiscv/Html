...
$r["psychometric"] = $f->get_Value("psychometric", $row["psychometric"]);
$r["teacher"] = $f->get_Value("teacher", $row["teacher"]);
$r["file"] = $f->get_Value("file", $row["file"]);
$r["fulfilled"] = $f->get_Value("fulfilled", $row["fulfilled"]);
...
//[fields]----------------------------------------------------------------------------------------------------------------
$f->fields["psychometric"] = $f->get_FieldText("psychometric", array("value" => $r["psychometric"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->fields["fulfilled"] = $f->get_FieldText("fulfilled", array("value" => $r["fulfilled"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$card = $bootstrap->get_Card("create", array(
    "title" => lang("Psychometrics.edit-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
