 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Psychometrics\Delete\form.php]
...
$r = $model->get_Psychometrics($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Psychometrics.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Psychometrics.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Psychometrics.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
