...
if (is_array($row)) {
    $c = $bootstrap->get_Card("duplicate", array(
        ...
        "title" => lang("Sie_Spaces.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Sie_Spaces.create-duplicate-message"),
    ...
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Sie_Spaces.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Sie_Spaces.create-success-message"), $d['space']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
