...
//[vars]----------------------------------------------------------------------------------------------------------------
$r["identification_number"] = $f->get_Value("identification_number", $request->getVar("identification_number"));
...
$card = $bootstrap->get_Card("create", array(
    "title" => "Actualizar Prematricula",
    "alert" => array(
        'type' => 'info',
        'title' => "Nota",
        'message' => "Ingrese su número de cedula para poder actualizar la prematricula"
    ),
    "content" => $f,
    "header-back" => $back,
));
