...
//$edit = $model->update($d);
    $c = $bootstrap->get_Card('warning', array(
        ...
        'title' => lang("Sie_Progress.view-success-title"),
        'text' => lang("Sie_Progress.view-success-message"),
        'footer-class' => 'text-center',
        'footer-continue' => base_url("/sie/progress/view/{$d["progress"]}/" . lpk()),
        'voice' => "sie/progress-view-success-message.mp3",
    ));
} else {
    $c = $bootstrap->get_Card('success', array(
        ...
        'icon' => 'fa-duotone fa-triangle-exclamation',
        'text-class' => 'text-center',
        'title' => lang("Sie_Progress.view-noexist-title"),
        'text' => lang("Sie_Progress.view-noexist-message"),
        'footer-class' => 'text-center',
        'footer-continue' => base_url("/sie/progress"),
        'voice' => "sie/progress-view-noexist-message.mp3",
    ));
}
echo($c);
?>
