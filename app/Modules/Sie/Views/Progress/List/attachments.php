...
if (is_array($files)) {
    foreach ($files as $file) {
        ...
        } elseif ($file["reference"] == "SIE-DT-10") {
            $type = "Documentos de homologación";
        } elseif ($file["reference"] == "SIE-DT-11") {
            $type = "Resultados Academicos Q10";
...
$code .= "\t\t\t\t\t\t\t\t<option value=\"SIE-DT-19\">Acta de Homologación</option>\n";
...
$code .= "\t\t\t\t\t\t\t\t<option value=\"SIE-DT-11\">Resultados Academicos Q10</option>\n";
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                for (let i = 0; i < files.length; i++) {
                    ...
                    } else if (files[i].reference == "SIE-DT-11") {
                        reference = "Resultados Academicos Q10";
