...
if (is_array($row)) {
    ...
    $c = $bootstrap->get_Card("success", array(
        ...
        "title" => lang("Sie_Agreements.edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Sie_Agreements.edit-success-message"),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Sie_Agreements.edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Sie_Agreements.edit-noexist-message"), $d['agreement']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
