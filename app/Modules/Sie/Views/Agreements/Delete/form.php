...
$message = sprintf(lang("Sie_Agreements.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Sie_Agreements.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Sie_Agreements.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
