...
if (is_array($row)) {
    $c = $card = $bootstrap->get_Card("duplicate", array(
        ...
        "title" => lang("Sie_Pensums.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Sie_Pensums.create-duplicate-message"),
    ...
    $c = $card = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Sie_Pensums.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Sie_Pensums.create-success-message"), $d['pensum']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
