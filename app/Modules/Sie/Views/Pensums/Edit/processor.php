...
if (is_array($row)) {
    ...
    $c = $bootstrap->get_Card("success", array(
        ...
        "title" => lang("Sie_Pensums.edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Sie_Pensums.edit-success-message"),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Sie_Pensums.edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Sie_Pensums.edit-noexist-message"), $d['pensum']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
