...
if (is_array($files)) {
    foreach ($files as $file) {
        ...
        } elseif ($file["reference"] == "SIE-DT-16") {
            $type = "Certificado EPS";
        } elseif ($file["reference"] == "SIE-DT-17") {
            $type = "Certificado de Población Especial";
...
$code .= "\t\t\t\t\t\t\t\t<option value=\"SIE-DT-16\">Certificado EPS</option>\n";
