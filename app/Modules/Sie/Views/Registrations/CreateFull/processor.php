...
if (is_array($row)) {
    ...
    $code .= "\t\t\t\t\t\t\t\t\t\t\t\t registraste. ¡Revisa tu bandeja de entrada y prepárate para comenzar esta nueva etapa en Utedé!</p>\n";
    ...
    $c = $bootstrap->get_Card("success", array(
        ...
        "text-class" => "text-center",
        "text" => $code,
        "footer-continue" => array("text" => "Descargar recibo de pago", "href" => $back, "target" => "_blank"),
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
}
