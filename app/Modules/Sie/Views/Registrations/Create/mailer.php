...
$code .= "<p>¡Hola {$name}!</p>\n";
$code .= "<p>Espero que este mensaje te encuentre bien.\tEstamos emocionados de que hayas decidido dar el primer paso hacia la educación superior en Utedé, enviando tu solicitud de preinscripción para el semestre 2025-B.</p>\n";
$code .= "<p><b>Primero lo primero</b>: el pago de la inscripción.\tEncontrarás adjunto el recibo necesario para realizar este pago.\tPor favor, efectúa el pago según las indicaciones y no olvides subir los documentos requeridos a nuestra plataforma usando este enlace:\t <a href=\"https://intranet.utede.edu.co/sie/registrations/documents/{$oid}\">Cargar Documentos!</a>. Recuerda que al escribir de nuevo tu número de documento podrás completar el registro hasta el último paso donde debes cargar estos documentos escaneados en formato PDF.</p>\n";
$code .= "<ol>\n";
$code .= "<li>Documento de identidad ampliado al 150% (No aceptamos scans desde el móvil).</li>\n";
$code .= "<li>Resultados de las pruebas Saber ICFES 11 o firma un acta de compromiso si aún no los tienes (se firma en oficina).</li>\n";
...
$code .= "<li>Foto digital tamaño 3x4 cm con fondo blanco para tu carnet en formato PNG.</li>\n";
...
$code .= "<li>Certificado de población vulnerable si lo tiene (víctima del conflicto armado, desplazado, indígena, comunidad negra, población LGTBIQ+ etc).</li>\n";
$code .= "<li><a href=\"https://intranet.utede.edu.co/sie/orders/print/{$facture}\" style=\"font-family:'Google Sans','Noto Sans JP',Arial,sans-serif;color:#ffffff;text-decoration:none;font-size:14px;letter-spacing:1px;font-weight:bold;border-radius:4px;margin:0;border:1px solid #1a73e8;padding:14px 16px 14px 16px;background-color: #1a73e8;margin: 0.5rem;display:inline-block\">Descargar Factura</a></li>\n";
$code .= "</ol>\n";
...
$code .= "</br>\n";
$code .= "<p>Equipo de Psicología\n";
//$code .= "<br><b>Leidy Johana Ortiz</b>\n";
$code .= "<br><b>Bienestar Institucional </b>\n";
...
$mailer->set_SMTPDebug(0);
$mailer->set_From($client["smtp_from_email"]);
$mailer->set_Subject($subject);
$mailer->set_Body($code);
$mailer->add_Address($email, "");
//$mailer->add_AttachmentFromUrl("https://intranet.utede.edu.co/sie/orders/print/{$facture}", "recibo.pdf");
$mailer->send();
//[/email]----------------------------------------------------------------------------------------------------------
?>