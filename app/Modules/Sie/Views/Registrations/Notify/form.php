...
$f->fields["subject"] = $f->get_FieldText("subject", array("value" => lang("Sie_Registrations.notify-subject"), "proportion" => "col-12", "readonly" => true));
...
$card = $bootstrap->get_Card("create", array(
    "title" => lang("Sie_Registrations.notify-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
