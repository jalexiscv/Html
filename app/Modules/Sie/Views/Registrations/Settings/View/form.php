...
//[Fields]-----------------------------------------------------------------------------
$f->fields["status_registrations_setting"] = $f->get_FieldView("setting", array("value" => $status_registrations_setting, "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "disabled" => true));
$f->fields["status_registrations_name"] = $f->get_FieldView("name", array("value" => $status_registrations_label, "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->fields["registrations_message_enabled_code"] = $f->get_FieldView("setting", array("value" => $registrations_message_enabled_code, "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["registrations_message_enabled_name"] = $f->get_FieldView("name", array("value" => $registrations_message_enabled_label, "proportion" => "col-md-8 col-sm-12 col-12"));
...
$f->fields["registrations_message_disabled_code"] = $f->get_FieldView("setting", array("value" => $registrations_message_disabled_code, "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->groups["g5"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["registrations_message_disabled_code"] . $f->fields["registrations_message_disabled_name"] . $f->fields["registrations_message_disabled_value"])));
//[Buttons]-----------------------------------------------------------------------------
