...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2025-09-16 16:34:40
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Subsectors\Creator\form.php]
...
//[models]--------------------------------------------------------------------------------------------------------------
//$model = model("App\Modules\Sie\Models\Sie_Subsectors");
//[vars]----------------------------------------------------------------------------------------------------------------
/**
 ...
 **/
$r["subsector"] = $f->get_Value("subsector", pk());
$r["network"] = $f->get_Value("network", $oid);
$r["reference"] = $f->get_Value("reference");
$r["name"] = $f->get_Value("name");
$r["moodle_course_base"] = $f->get_Value("moodle_course_base");
...
$f->fields["subsector"] = $f->get_FieldText("subsector", array("value" => $r["subsector"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "readonly" => true));
$f->fields["network"] = $f->get_FieldText("network", array("value" => $r["network"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "readonly" => true));
...
$f->fields["moodle_course_base"] = $f->get_FieldText("moodle_course_base", array("value" => $r["moodle_course_base"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["name"] . $f->fields["moodle_course_base"])));
...
$card = $b->get_Card("create", array(
    "title" => lang("Sie_Subsectors.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
