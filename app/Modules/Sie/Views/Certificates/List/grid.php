...
$card = $bootstrap->get_Card2("card-grid", array(
    "header-title" => lang('Sie_Certificates.list-title'),
    "header-back" => $back,
    "header-add" => "/sie/certificates/create/" . lpk(),
    "alert" => array("icon" => ICON_INFO, "type" => "info", "title" => lang('Sie_Certificates.list-title'), "message" => lang('Sie_Certificates.list-description')),
    "content" => $bgrid,
));
echo($card);
?>