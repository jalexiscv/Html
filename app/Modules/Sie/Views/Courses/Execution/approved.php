...
$card = $b->get_Card2("create", array(
    ...
    "alert" => array(
        "icon" => ICON_WARNING,
        "type" => "warning",
        "title" => lang('Sie_Executions.course-approved-alert-title'),
        "message" => lang('Sie_Executions.course-approved-alert-message')
    ),
    "content" => $f,
    "header-back" => $back,
    'voice' => "sie/course-approved-alert-message.mp3",
));
echo($card);
?>