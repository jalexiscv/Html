...
$card = $b->get_Card2("create", array(
    ...
    "alert" => array(
        "icon" => ICON_DANGER,
        "type" => "danger",
        "title" => lang('Sie_Executions.course-inexecution-alert-title'),
        "message" => lang('Sie_Executions.course-inexecution-alert-message')
    ),
    "content" => $f,
    "header-back" => $back,
    'voice' => "sie/course-inexecution-alert-message.mp3",
));
echo($card);
?>