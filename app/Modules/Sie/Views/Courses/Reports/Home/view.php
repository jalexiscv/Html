...
if ($authentication->get_LoggedIn()) {
    ...
    $shortcuts->add($bootstrap->get_Shortcut(array("href" => "/sie/reports/courses/general?t=" . lpk(), "icon" => "fa-light fa-folder-tree", "value" => "General", "description" => "Cursos", "class" => "text-success", "target" => "_blank")));
    echo($shortcuts);
} else {
}
