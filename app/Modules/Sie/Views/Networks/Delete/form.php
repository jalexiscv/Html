 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Networks\Delete\form.php]
...
$r = $model->getNetwork($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Sie_Networks.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Sie_Networks.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Sie_Networks.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
