...
$r["registration"] = $f->get_Value("registration", $oid);
...
$r["headquarter"] = $f->get_Value("version");
...
$r["renewal"] = $f->get_Value("renewal", service("dates")::get_Date());
...
$back = $request->getVar("back") ?? "/sie/students/view/{$oid}";

//[fields]----------------------------------------------------------------------------------------------------------------
$f->add_HiddenField("back", $back);
$f->fields["enrollment"] = $f->get_FieldText("enrollment", array("value" => $r["enrollment"], "proportion" => "col-md-3 col-sm-12 col-12", "readonly" => true));
$f->fields["registration"] = $f->get_FieldText("registration", array("value" => $r["registration"], "proportion" => "col-md-3 col-sm-12 col-12", "readonly" => true));
$f->fields["student_name"] = $f->get_FieldText("student_name", array("value" => $r["student_name"], "proportion" => "col-md-6 col-12", "readonly" => true));
...
$f->fields["renewal"] = $f->get_FieldDate("renewal", array("value" => $r["renewal"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
//[groups]----------------------------------------------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["enrollment"] . $f->fields["registration"] . $f->fields["student_name"])));
...
$f->groups["g8"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["date"] . $f->fields["renewal"] . $f->fields["period"])));
...
$card = $b->get_Card("create", array(
        "title" => lang("Sie_Enrollments.create-title"),
        "content" => $f,
        "header-back" => $back
));
echo($card);
            ...
            fetch(url)
                ...
                .then(responseData => {
                    ...
                    if (Array.isArray(data)) {
                        ...
                        var option = document.createElement("option");
                        option.value = "";
                        option.text = " - Seleccione una versión";
