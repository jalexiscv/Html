...
$f->fields["grid"] = $f->get_FieldSelect("grid", array("selected" => $r["grid"], "data" => $grids, "proportion" => "col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 disabled", "readonly" => true));
...
$f->fields["cycle"] = $f->get_FieldSelect("cycle", array("selected" => $r["cycle"], "data" => LIST_CYCLES, "proportion" => "col-md-4 col-sm-12 col-12", "readonly" => true));
$f->fields["moment"] = $f->get_FieldSelect("moment", array("selected" => $r["moment"], "data" => LIST_MOMENTS, "proportion" => "col-md-4 col-sm-12 col-12", "readonly" => true));
$f->fields["observation"] = $f->get_FieldTextArea("observation", array("value" => $r["observation"], "proportion" => "col-12", "readonly" => true));
...
$f->fields["status"] = $f->get_FieldSelect("status", array("selected" => $r["status"], "data" => LIST_ENRROLMENTS_STATUS, "proportion" => "col-md-3 col-sm-12 col-12", "readonly" => true));
