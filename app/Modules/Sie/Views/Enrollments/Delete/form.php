 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Enrollments\Delete\form.php]
...
$r = $model->get_Enrollment($oid);
$name = urldecode($r["enrollment"]);
$message = sprintf(lang("Sie_Enrollments.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Sie_Enrollments.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Sie_Enrollments.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
