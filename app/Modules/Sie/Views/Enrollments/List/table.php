...
$table = $bootstrap->get_DynamicTable(array(
    ...
    'cols' => array(
        ...
        'details' => array('text' => "Detalles", 'class' => 'text-start'),
        'full_name' => array('text' => lang('App.Name'), 'class' => 'text-start', 'visible' => false),
...
$card = $bootstrap->get_Card("card-view-service", array(
    ...
    "header-back" => $back,
    "alert" => array("icon" => ICON_INFO, "type" => "info", "title" => lang('Registrations.message-list-title'), "message" => lang('Sie_Enrollments.message-list-description')),
    "content" => $table,
));
echo($card);
?>
