 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Grids\List\table.php]
...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/sie/api/grids/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('icon' => ICON_ADD, 'text' => lang('App.Create'), 'href' => '/sie/grids/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang('Grids.list-title'),
    "header-back" => $back,
    "alert" => array("icon" => ICON_INFO, "type" => "info", "title" => lang('Grids.list-title'), "message" => lang('Grids.list-description')),
    "content" => $table,
));
echo($card);
?>
