...
$student = $request->getGet("registration");
$back = "/sie/students/view/{$r["user"]}#finance";

if (!empty($student)) {
    $back = "/sie/students/view/{$student}#finance";
}

$statuses = array(
    array("value" => "PENDDING", "label" => "Pendiente"),
    array("value" => "DEFERRED", "label" => "Diferida"),
);
...
$f->fields["order"] = $f->get_FieldText("order", array("value" => $r["order"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "readonly" => "readonly"));
$f->fields["user"] = $f->get_FieldText("user", array("value" => $r["user"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "readonly" => "readonly"));
$f->fields["ticket"] = $f->get_FieldText("ticket", array("value" => $r["ticket"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "readonly" => "readonly"));
$f->fields["parent"] = $f->get_FieldText("parent", array("value" => $r["parent"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["period"] = $f->get_FieldText("period", array("value" => $r["period"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "readonly" => "readonly"));
...
$f->fields["cycle"] = $f->get_FieldSelect("cycle", array("selected" => $r["cycle"], "data" => $cycles, "proportion" => "col-md-6 col-sm-12 col-12"));
$f->fields["moment"] = $f->get_FieldSelect("moment", array("selected" => $r["moment"], "data" => $moments, "proportion" => "col-md-6 col-sm-12 col-12"));
...
$f->fields["date"] = $f->get_FieldDate("date", array("value" => $r["date"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["time"] = $f->get_FieldTime("time", array("value" => $r["time"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "readonly" => "readonly"));
$f->fields["expiration"] = $f->get_FieldDate("expiration", array("value" => $r["expiration"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->groups["g3"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["paid"] . $f->fields["status"] . $f->fields["expiration"])));
$f->groups["g4"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["type"] . $f->fields["date"] . $f->fields["time"])));
$f->groups["g5"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["cycle"] . $f->fields["moment"])));
...
$card = $bootstrap->get_Card("create", array(
    "title" => lang("Sie_Orders.edit-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
$items = $bootstrap->get_Card("create", array(
    "title" => lang("Sie_Orders_Items.list-title"),
    "content" => view("App\Modules\Sie\Views\Orders\Edit\items", array("oid" => $oid)),
    "header-back" => $back
));
//echo($items);
?>