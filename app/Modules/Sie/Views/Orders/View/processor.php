...
//$edit = $model->update($d);
    $c = $bootstrap->get_Card('warning', array(
        ...
        'title' => lang("Sie_Orders.view-success-title"),
        'text' => lang("Sie_Orders.view-success-message"),
    ...
    $c = $bootstrap->get_Card('success', array(
        ...
        'icon' => 'fa-duotone fa-triangle-exclamation',
        'text-class' => 'text-center',
        'title' => lang("Sie_Orders.view-noexist-title"),
        'text' => lang("Sie_Orders.view-noexist-message"),
        'footer-class' => 'text-center',
