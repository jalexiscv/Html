 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Groups\Delete\form.php]
...
$message = sprintf(lang("Sie_Groups.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Sie_Groups.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Sie_Groups.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
