 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Groups\Editor\form.php]
...
//[groups]----------------------------------------------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["group"] . $f->fields["institution"] . $f->fields["reference"])));
...
$card = $bootstrap->get_Card("create", array(
    "title" => lang("Sie_Groups.edit-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
