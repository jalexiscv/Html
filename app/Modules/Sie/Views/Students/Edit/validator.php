...
//$f->set_ValidationRule("saber11_value","trim|required");
//$f->set_ValidationRule("saber11_date","trim|required");
...
//$f->set_ValidationRule("college","trim|required");
//$f->set_ValidationRule("college_year","trim|required");
...
$f->set_ValidationRule("economic_dependency", "trim|required");
$f->set_ValidationRule("type_of_funding", "trim|required");
$f->set_ValidationRule("current_occupation", "trim|required");
$f->set_ValidationRule("type_of_work", "trim|required");
