<?php
$code = "<!-- Modal -->\n";
$code .= "<div class=\"modal fade\" id=\"observation-modal-edit\" tabindex=\"-1\" aria-labelledby=\"observation-modal-edit\" aria-hidden=\"true\">\n";
$code .= "\t\t<div class=\"modal-dialog\">\n";
$code .= "\t\t\t\t<div class=\"modal-content\">\n";
$code .= "\t\t\t\t\t\t<div class=\"modal-header\">\n";
$code .= "\t\t\t\t\t\t\t\t<h5 class=\"modal-title\" id=\"observacionModalLabel\">Editar Observación</h5>\n";
...
$code .= "\t\t\t\t\t\t\t\t\t\t<div class=\"mb-3\">\n";
$code .= "\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"content\" class=\"form-label\">Código de la observación</label>\n";
$code .= "\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"update-observation-id\" disabled>\n";
$code .= "\t\t\t\t\t\t\t\t\t\t</div>\n";

$code .= "\t\t\t\t\t\t\t\t\t\t<div class=\"mb-3\">\n";
$code .= "\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"type\" class=\"form-label\">Tipo de Observación</label>\n";
$code .= "\t\t\t\t\t\t\t\t\t\t\t\t<select class=\"form-select\" id=\"update-observation-type\" required>\n";
...
$code .= "\t\t\t\t\t\t\t\t\t\t\t\t<textarea class=\"form-control\" id=\"update-observation-content\" rows=\"3\" required></textarea>\n";
$code .= "\t\t\t\t\t\t\t\t\t\t</div>\n";
$code .= "\t\t\t\t\t\t\t\t</form>\n";
$code .= "\t\t\t\t\t\t</div>\n";
$code .= "\t\t\t\t\t\t<div class=\"modal-footer\">\n";
$code .= "\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-secondary\" data-bs-dismiss=\"modal\">Cerrar</button>\n";
$code .= "\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary\" onclick=\"xhrUpdateObservation()\">Actualizar</button>\n";
$code .= "\t\t\t\t\t\t</div>\n";
$code .= "\t\t\t\t</div>\n";
$code .= "\t\t</div>\n";
$code .= "</div>\n";
