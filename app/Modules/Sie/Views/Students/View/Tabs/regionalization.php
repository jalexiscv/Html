...
$agreement = $magreements->get_Agreement($r["agreement"]);
$institutions = $minstitutions->getInstitution($r["agreement_institution"]);
$country = $mcountries->get_Country($r["agreement_country"]);
$region = $mregions->get_Region($r["agreement_region"]);
$city = $mcities->get_City($r["agreement_city"]);
...
$f->fields["agreement"] = $f->get_FieldView("agreement", array("value" => $r["agreement"] . ": " . $agreement_name, "proportion" => "col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12"));
$f->fields["agreement_country"] = $f->get_FieldView("agreement_country", array("value" => $r["agreement_country"] . ": " . $country_name, "data" => $countries, "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["agreement_region"] = $f->get_FieldView("agreement_region", array("value" => $r["agreement_region"] . ": " . $region_name, "data" => $regions, "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12"));
$f->fields["agreement_city"] = $f->get_FieldView("agreement_city", array("value" => $r["agreement_city"] . ": " . $city_name, "data" => $cities, "proportion" => "col-xl-6 col-lg-6 col-md-64 col-sm-12 col-12"));
$f->fields["agreement_institution"] = $f->get_FieldView("agreement_institution", array("value" => $r["agreement_institution"] . ": " . $institution_name, "data" => $institutions, "proportion" => "col-12"));
$f->fields["agreement_group"] = $f->get_FieldView("agreement_group", array("value" => $group_reference, "proportion" => "col-md-4 col-sm-12 col-12"));
//[buttons]-------------------------------------------------------------------------------------------------------------
...
$f->groups["g04"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["agreement_group"])));
//[buttons]-------------------------------------------------------------------------------------------------------------
