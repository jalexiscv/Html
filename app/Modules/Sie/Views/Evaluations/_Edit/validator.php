 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Evaluations\Editor\validator.php]
...
//$f->set_ValidationRule("q1","trim|required");
//$f->set_ValidationRule("q2","trim|required");
//$f->set_ValidationRule("q3","trim|required");
//$f->set_ValidationRule("q4","trim|required");
//$f->set_ValidationRule("q5","trim|required");
//$f->set_ValidationRule("q6","trim|required");
//$f->set_ValidationRule("q7","trim|required");
//$f->set_ValidationRule("q8","trim|required");
//$f->set_ValidationRule("q9","trim|required");
//$f->set_ValidationRule("q10","trim|required");
