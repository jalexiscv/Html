...
$r["q1"] = $f->get_Value("q1", $row["q1"]);
$r["q2"] = $f->get_Value("q2", $row["q2"]);
$r["q3"] = $f->get_Value("q3", $row["q3"]);
$r["q4"] = $f->get_Value("q4", $row["q4"]);
$r["q5"] = $f->get_Value("q5", $row["q5"]);
$r["q6"] = $f->get_Value("q6", $row["q6"]);
$r["q7"] = $f->get_Value("q7", $row["q7"]);
$r["q8"] = $f->get_Value("q8", $row["q8"]);
$r["q9"] = $f->get_Value("q9", $row["q9"]);
$r["q10"] = $f->get_Value("q10", $row["q10"]);
...
$f->fields["q1"] = $f->get_FieldText("q1", array("value" => $r["q1"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["q2"] = $f->get_FieldText("q2", array("value" => $r["q2"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["q3"] = $f->get_FieldText("q3", array("value" => $r["q3"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["q4"] = $f->get_FieldText("q4", array("value" => $r["q4"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["q5"] = $f->get_FieldText("q5", array("value" => $r["q5"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["q6"] = $f->get_FieldText("q6", array("value" => $r["q6"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["q7"] = $f->get_FieldText("q7", array("value" => $r["q7"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["q8"] = $f->get_FieldText("q8", array("value" => $r["q8"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["q9"] = $f->get_FieldText("q9", array("value" => $r["q9"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["q10"] = $f->get_FieldText("q10", array("value" => $r["q10"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$card = $bootstrap->get_Card("create", array(
    "title" => lang("Evaluations.edit-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
