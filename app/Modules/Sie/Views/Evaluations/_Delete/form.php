...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-05 12:35:22
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Evaluations\Delete\form.php]
...
$r = $model->get_Evaluations($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Evaluations.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Evaluations.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Evaluations.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
