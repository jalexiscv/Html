...
if ($mfields->get_UserByCitizenshipcard($f->get_Value("citizenshipcard"))) {
    $f->validation->setError('citizenshipcard', 'El número de cédula ya se encuentra registrado');
}

if ($mfields->get_UserByAlias($f->get_Value("alias"))) {
    $f->validation->setError('alias', 'El alias ya se encuentra registrado');
}
...
$f->set_ValidationRule("email_personal", "trim|required|valid_email");
...
$f->set_ValidationRule("whatsapp", "trim|required|numeric|min_length[10]|max_length[15]");
