...
$r["email_personal"] = $f->get_Value("email_personal");
...
$r["whatsapp"] = $f->get_Value("whatsapp");
...
$f->groups["g4"] = $f->get_Group(array("fields" => $f->fields["email"] . $f->fields["email_personal"]));
$f->groups["g5"] = $f->get_Group(array("fields" => $f->fields["phone"] . $f->fields["whatsapp"]));
$f->groups["g6"] = $f->get_Group(array("fields" => $f->fields["birthday"] . $f->fields["citizenshipcard"]));
$f->groups["g7"] = $f->get_Group(array("fields" => $f->fields["expedition_date"] . $f->fields["expedition_place"]));
$f->groups["g8"] = $f->get_Group(array("fields" => $f->fields["reference"]));
$f->groups["g9"] = $f->get_Group(array("fields" => $f->fields["notes"]));
//[buttons]-------------------------------------------------------------------------------------------------------------
$f->groups["gy"] = $f->get_GroupSeparator();
$f->groups["gz"] = $f->get_Buttons(array("fields" => $f->fields["submit"] . $f->fields["cancel"]));
//[build]---------------------------------------------------------------------------------------------------------------
$card = $b->get_Card("create", array(
    "title" => lang("Sie_Teachers.create-title"),
    "content" => $f,
