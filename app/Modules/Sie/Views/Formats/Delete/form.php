...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2025-10-30 07:50:56
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Formats\Delete\form.php]
...
$r = $model->getFormat($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Sie_Formats.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Sie_Formats.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Sie_Formats.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
