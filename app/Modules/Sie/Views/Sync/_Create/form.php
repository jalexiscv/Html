...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2025-08-04 10:00:56
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Sync\Creator\form.php]
 ...
 **/
$r["sync"] = $f->get_Value("sync");
$r["type"] = $f->get_Value("type");
$r["payload"] = $f->get_Value("payload");
...
$card = $b->get_Card("create", array(
    "title" => lang("Sie_Sync.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
