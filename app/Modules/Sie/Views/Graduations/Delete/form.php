...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-11-06 13:55:40
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Graduations\Delete\form.php]
...
$r = $model->get_Graduation($oid);
$name = urldecode($r["full_name"]);
$message = sprintf(lang("Sie_Graduations.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Sie_Graduations.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Sie_Graduations.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
