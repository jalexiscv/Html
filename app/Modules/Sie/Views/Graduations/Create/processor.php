 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Graduations\Creator\processor.php]
...
//[Vars]-----------------------------------------------------------------------------
$back = "/sie/graduations/create/fullscreen";
$d = array(
...
$asuccess = "sie/graduations-create-success-message.mp3";
$aexist = "sie/graduations-create-exist-message.mp3";
if (is_array($row)) {
    $c = $bootstrap->get_Card("duplicate", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Sie_Graduations.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Sie_Graduations.create-duplicate-message"),
    ...
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Sie_Graduations.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Sie_Graduations.create-success-message"), $d['graduation']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
