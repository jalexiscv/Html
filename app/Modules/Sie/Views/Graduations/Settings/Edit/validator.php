 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Settings\Editor\validator.php]
...
//[Request]-----------------------------------------------------------------------------
$f->set_ValidationRule("status_graduations", "trim|required");
$f->set_ValidationRule("graduations_message_enabled", "trim|required");
$f->set_ValidationRule("graduations_message_disabled", "trim|required");
