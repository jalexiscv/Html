...
$console[] = "> Comprendo la solicitud deseas crear un usuario funcional para este perfil acádemico.";
$console[] = "> Iniciando...";
$console[] = "> 001: Identificando el perfil academico ... {$oid}";
$console[] = "> 002: Estableciendo correo electrónico para el perfil a generar ... {$email}";
$console[] = "> 003: Estableciendo contraseña para el perfil a generar ... {$password}";
$console[] = "> 004: Estableciendo si existe un usuario con este correo ...";
...
$card = $b->get_Card2("create", array(
        "header-title" => "Creación automatica de usuarios",
        "content" => $code,
        "header-back" => $back,
        "footer-class" => "text-end",
        "footer-continue" => "/sie/students/view/{$oid}",
));
echo($card);
?>
<style>
