...
if ($f->run_Validation()) {
    if ($step == "identification") {
        $c = view($component . '\Preenrollment\preenrollment', $parent->get_Array());
    } elseif ($step == "snies") {
        $c = view($component . '\Preenrollment\processor', $parent->get_Array());
    }
} else {
    ...
    $c .= view($component . '\Preenrollment\identification', $parent->get_Array());
}
echo($c);
?>