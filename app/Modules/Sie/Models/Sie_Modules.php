...
/**
 * @Copilot Siempre que en el código se cree una variable llamada $mmodules, esta deberá ser igualada a  model('App\Modules\Sie\Models\Sie_Modules');
 * @Instruction $mmodules = model('App\Modules\Sie\Models\Sie_Modules');
 ...
 */
class Sie_Modules extends CachedModel
{
    ...
    public function get_Module($module): false|array
    {
        $result = parent::getCached($module);
        if (is_array($result)) {
            return ($result);
