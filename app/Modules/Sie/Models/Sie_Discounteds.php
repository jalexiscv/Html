...
class Sie_Discounteds extends Model
{
    ...
    /**
     * Restorna el listado los descuentos asociados a un estudiante matriculado
     * @param $registration
     * @return array|false
     */
    public function get_DiscountedsByRegistration($registration)
    {
        $result = $this
            ->where('object', $registration)
            ->findAll();
        if (is_array($result)) {
            return ($result);
        } else {
    ...
    /**
     * Restorna falso o verdadero si un registro tiene asociado un descuento especifico
     * @param $registration
     * @param $discount
     * @return bool
     */
    public function exist_DiscountedByRegistrationByDiscount($registration, $discount)
    {
        $result = $this
            ->where('object', $registration)
