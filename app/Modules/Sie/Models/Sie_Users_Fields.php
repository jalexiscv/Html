...
class Sie_Users_Fields extends CachedModel
{
    ...
    public function get_Profile($user): mixed
    {
        ...
        $data = array(
            ...
            "email_personal" => $this->get_Field($user, "email_personal"),
