...
/**
 * Ej: $model = model('App\Modules\Sie\Models\Sie_Evaluations');
 * @method where(mixed $primaryKey, string $id) : \Higgs\Database\BaseBuilder
 * @method groupStart() : \Higgs\Database\BaseBuilder
 */
class Sie_Evaluations extends Model
{
    protected $table = "sie_evaluations";
    protected $primaryKey = "evaluation";
    ...
    private function exec_TableRegenerate()
    {
        if (!$this->get_TableExist()) {
            ...
            $fields = [
                'evaluation' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'type' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => TRUE],
                'teacher' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => TRUE],
                'q1' => ['type' => 'VARCHAR', 'constraint' => 1, 'null' => TRUE],
                'q2' => ['type' => 'VARCHAR', 'constraint' => 1, 'null' => TRUE],
                'q3' => ['type' => 'VARCHAR', 'constraint' => 1, 'null' => TRUE],
                'q4' => ['type' => 'VARCHAR', 'constraint' => 1, 'null' => TRUE],
                'q5' => ['type' => 'VARCHAR', 'constraint' => 1, 'null' => TRUE],
                'q6' => ['type' => 'VARCHAR', 'constraint' => 1, 'null' => TRUE],
                'q7' => ['type' => 'VARCHAR', 'constraint' => 1, 'null' => TRUE],
                'q8' => ['type' => 'VARCHAR', 'constraint' => 1, 'null' => TRUE],
                'q9' => ['type' => 'VARCHAR', 'constraint' => 1, 'null' => TRUE],
                'q10' => ['type' => 'VARCHAR', 'constraint' => 1, 'null' => TRUE],
     ...
     * @return array|false
     */
    public function get_Evaluation($evaluation): false|array
    {
        $row = $this->where($this->primaryKey, $evaluation)->first();
        if (is_array($row)) {
            $value = $row;
        } else {
            $value = false;
    ...
    public function get_LastEvaluationByTeacher($teacher): false|array
    {
        $row = $this
