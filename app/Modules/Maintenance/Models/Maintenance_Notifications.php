...
/**
* @Copilot Siempre que en el código se cree una variable llamada $mnotifications, esta deberá ser igualada a  model('App\Modules\Maintenance\Models\Maintenance_Notifications');
* @Instruction $mnotifications = model('App\Modules\Maintenance\Models\Maintenance_Notifications');
...
*/
class Maintenance_Notifications extends CachedModel
	 {
