...
$rows = $mmaintenances->get_CachedSearch($conditions, $limit, $offset, "maintenance DESC");
$total = $mmaintenances->get_CountAllResults($conditions);
...
foreach ($rows["data"] as $row) {
    if (!empty($row["maintenance"])) {
        ...
        //[type]--------------------------------------------------------------------------------------------------------
        $type = safe_strtoupper($mmaintenances->getLabelType($row['type']));
        ...
        $details .= "<b>Descripción:</b> {$row['description']}<br>";
