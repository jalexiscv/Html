...
$f->fields["type"] = $f->get_FieldView("type", array("value" => $r["type"], "data" => $types, "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["status"] = $f->get_FieldView("status", array("value" => $r["status"], "data" => $statuses, "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
//[custom]--------------------------------------------------------------------------------------------------------------
$f->fields["entry_date"] = $f->get_FieldView("entry_date", array("value" => @$r["entry_date"], "proportion" => "col-6"));
$f->fields["location"] = $f->get_FieldView("location", array("value" => @$r["location"], "proportion" => "col-6"));
$f->fields["code"] = $f->get_FieldView("code", array("value" => @$r["code"], "proportion" => "col-6"));
$f->fields["brand"] = $f->get_FieldView("brand", array("value" => @$r["brand"], "proportion" => "col-6"));
$f->fields["serial_number"] = $f->get_FieldView("serial_number", array("value" => @$r["serial_number"], "proportion" => "col-6"));
$f->fields["voltage"] = $f->get_FieldView("voltage", array("value" => @$r["voltage"], "proportion" => "col-6"));
$f->fields["amperage"] = $f->get_FieldView("amperage", array("value" => @$r["amperage"], "proportion" => "col-6"));
$f->fields["frequency"] = $f->get_FieldView("frequency", array("value" => @$r["frequency"], "proportion" => "col-6"));
$f->fields["power"] = $f->get_FieldView("power", array("value" => @$r["power"], "proportion" => "col-6"));
$f->fields["model"] = $f->get_FieldView("model", array("value" => @$r["model"], "proportion" => "col-6"));
$f->fields["rpm"] = $f->get_FieldView("rpm", array("value" => @$r["rpm"], "proportion" => "col-6"));
$f->fields["operation_hours"] = $f->get_FieldView("operation_hours", array("value" => @$r["operation_hours"], "proportion" => "col-6"));
$f->fields["other_specifications"] = $f->get_FieldView("other_specifications", array("value" => @$r["other_specifications"], "proportion" => "col-12"));
$f->fields["document_type"] = $f->get_FieldView("document_type", array("value" => @$r["document_type"], "proportion" => "col-6"));
$f->fields["document_location"] = $f->get_FieldView("document_location", array("value" => @$r["document_location"], "proportion" => "col-6"));
$f->fields["equipment_function"] = $f->get_FieldView("equipment_function", array("value" => @$r["equipment_function"], "proportion" => "col-12"));
$f->fields["authorized_personnel"] = $f->get_FieldView("authorized_personnel", array("value" => @$r["authorized_personnel"], "proportion" => "col-12"));
...
$f->groups["g14"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["observations"])));
//[buttons]-------------------------------------------------------------------------------------------------------------
