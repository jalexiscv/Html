...
//[custom]--------------------------------------------------------------------------------------------------------------
$f->fields["license_plate"] = $f->get_FieldText("license_plate", array("value" => @$r["license_plate"],"proportion"=>"col-6"));
$f->fields["vehicle_brand"] = $f->get_FieldText("vehicle_brand", array("value" => @$r["vehicle_brand"],"proportion"=>"col-6"));
$f->fields["vehicle_line"] = $f->get_FieldText("vehicle_line", array("value" => @$r["vehicle_line"],"proportion"=>"col-6"));
$f->fields["engine_displacement"] = $f->get_FieldText("engine_displacement", array("value" => @$r["engine_displacement"],"proportion"=>"col-6"));
$f->fields["vehicle_model"] = $f->get_FieldText("vehicle_model", array("value" => @$r["vehicle_model"],"proportion"=>"col-6"));
$f->fields["vehicle_class"] = $f->get_FieldText("vehicle_class", array("value" => @$r["vehicle_class"],"proportion"=>"col-6"));
$f->fields["body_type"] = $f->get_FieldText("body_type", array("value" => @$r["body_type"],"proportion"=>"col-6"));
$f->fields["doors_number"] = $f->get_FieldText("doors_number", array("value" => @$r["doors_number"],"proportion"=>"col-6"));
$f->fields["engine_number"] = $f->get_FieldText("engine_number", array("value" => @$r["engine_number"],"proportion"=>"col-6"));
$f->fields["serial_document"] = $f->get_FieldText("serial_document", array("value" => @$r["serial_document"],"proportion"=>"col-6"));
$f->fields["chassis_number"] = $f->get_FieldText("chassis_number", array("value" => @$r["chassis_number"],"proportion"=>"col-6"));
$f->fields["document_number"] = $f->get_FieldText("document_number", array("value" => @$r["document_number"],"proportion"=>"col-6"));
$f->fields["tonnage_capacity"] = $f->get_FieldText("tonnage_capacity", array("value" => @$r["tonnage_capacity"],"proportion"=>"col-6"));
$f->fields["city"] = $f->get_FieldText("city", array("value" => @$r["city"],"proportion"=>"col-6"));
$f->fields["passengers"] = $f->get_FieldText("passengers", array("value" => @$r["passengers"],"proportion"=>"col-6"));
$f->fields["document_date"] = $f->get_FieldText("document_date", array("value" => @$r["document_date"],"proportion"=>"col-6"));
$f->fields["vehicle_function"] = $f->get_FieldTextArea("vehicle_function", array("value" => @$r["vehicle_function"],"proportion"=>"col-12"));
$f->fields["authorized_drivers"] = $f->get_FieldTextArea("authorized_drivers", array("value" => @$r["authorized_drivers"],"proportion"=>"col-12"));
$f->fields["maintenance_manager"] = $f->get_FieldText("maintenance_manager", array("value" => @$r["maintenance_manager"],"proportion"=>"col-6"));
$f->fields["photo_url"] = $f->get_FieldText("photo_url", array("value" => @$r["photo_url"],"proportion"=>"col-6"));
//[/custom]--------------------------------------------------------------------------------------------------------------
