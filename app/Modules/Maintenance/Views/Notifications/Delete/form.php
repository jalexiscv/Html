...
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Maintenance\Views\Notifications\Delete\form.php]
...
$message=sprintf(lang("Maintenance_Notifications.delete-message"),$name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
		 "class" =>"card-info",
		 "icon" => ICON_WARNING,
		 "title" => sprintf(lang("Maintenance_Notifications.delete-title"),$name),
		 "text-class" =>"text-center",
		 "text"=>sprintf(lang("Maintenance_Notifications.delete-message"),$name),
		 "content" =>$f,
		 "header-back" =>$back
));
echo($card);
