...
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Maintenance\Views\Maintenances\Delete\form.php]
...
$r= $model->getMaintenance($oid);
$name = urldecode($r["maintenance"]);
$message=sprintf(lang("Maintenance_Maintenances.delete-message"),$name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
		 "class" =>"card-info",
		 "icon" => ICON_WARNING,
		 "title" => sprintf(lang("Maintenance_Maintenances.delete-title"),$name),
		 "text-class" =>"text-center",
		 "text"=>sprintf(lang("Maintenance_Maintenances.delete-message"),$name),
		 "content" =>$f,
		 "header-back" =>$back
));
echo($card);
