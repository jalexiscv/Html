...
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Maintenance\Views\Maintenances\Creator\processor.php]
...
$asuccess = "maintenance/maintenances-create-success-message.mp3";
$aexist = "maintenance/maintenances-create-exist-message.mp3";
if (is_array($row)) {
    $c= $bootstrap->get_Card("duplicate", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Maintenance_Maintenances.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Maintenance_Maintenances.create-duplicate-message"),
    ...
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Maintenance_Maintenances.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Maintenance_Maintenances.create-success-message"),$d['maintenance']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" =>$asuccess,
    ));
