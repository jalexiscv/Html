...
$r["maintenance"] = $f->get_Value("maintenance",$row["maintenance"]);
$r["asset"] = $f->get_Value("asset",$row["asset"]);
$r["type"] = $f->get_Value("type",$row["type"]);
$r["scheduled"] = $f->get_Value("scheduled",$row["scheduled"]);
...
$f->fields["type"] = $f->get_FieldSelect("type", array("selected" => $r["type"],"data"=>$typos,"proportion"=>"col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$card = $bootstrap->get_Card2("create", array(
		 "header-title" => lang("Maintenance_Maintenances.edit-title"),
		 "content" =>$f,
		 "header-back" =>$back
));
echo($card);
