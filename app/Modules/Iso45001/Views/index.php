...
$version = round(($server->get_DirectorySize(APPPATH . 'Modules/Iso45001') / 102400), 6);
$data = $parent->get_Array();
$rviews = array(
    "default" => "{$views}\E404\index",
    "iso45001-denied" => "{$views}\Denied\index",
    "iso45001-home" => "{$views}\Home\index",
    //[others]------------------------------------------------------------------------------------------
);
...
$assign['left'] = get_iso45001_sidebar();
