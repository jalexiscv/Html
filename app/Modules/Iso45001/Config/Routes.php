...
if (strpos($dirName, '_') === false) {
    ...
    $mdm = model("App\Modules\Iso45001\Models\Iso45001_Modules");
    $mdcxm = model("App\Modules\Iso45001\Models\Iso45001_Clients_Modules");
    $module = 'iso45001';
    $namespace = "App\Modules\Iso45001\Controllers";
    ...
    if ($cxm == "authorized") {
        $routes->group($module,
            ['namespace' => $namespace],
            function ($subroutes) {
                $subroutes->add('/', 'Iso45001::index');
                $subroutes->add('/home', 'Iso45001::index');
                $subroutes->add('home/(:any)', 'Iso45001::home/$1');
        ...
        $routes->group($module,
            ['namespace' => $namespace],
            function ($subroutes) {
                $subroutes->add('/', 'Iso45001::denied');
                $subroutes->add('(:any)', 'Iso45001::denied');
            }
        );
    }
}
