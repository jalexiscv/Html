 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Application\Views\Towns\Delete\form.php]
...
$message = sprintf(lang("Application_Towns.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Application_Towns.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Application_Towns.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
