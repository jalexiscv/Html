...
return [
    ...
    "label_notification" => "Código de notificación",
    "label_user" => "Código de usuario",
    "label_recipient_email" => "Correo electrónico",
    "label_recipient_phone" => "Movil / Whatsapp",
    "label_type" => "Tipe",
    ...
    "create-title" => "Crear notificación manual",
    ...
    "create-success-message" => "La notificación se registró exitosamente, para retornar al listado general de #plural presioné continuar en la parte inferior de este mensaje.",
    ...
    "list-title" => "Recuerde",
    "list-description" => "Este listado contiene las notificaciones que el sistema a generado.",
];
