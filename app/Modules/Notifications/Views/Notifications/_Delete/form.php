 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Notifications\Views\Notifications\Delete\form.php]
...
$r = $model->getNotification($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Notifications_Notifications.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Notifications_Notifications.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Notifications_Notifications.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
