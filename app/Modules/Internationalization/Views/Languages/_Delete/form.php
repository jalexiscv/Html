 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Application\Views\Languages\Delete\form.php]
...
$r = $model->get_Languages($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Languages.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Languages.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Languages.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
