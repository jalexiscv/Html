 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Application\Views\Languages\Creator\form.php]
...
$r["locale"] = $f->get_Value("locale");
$r["name"] = $f->get_Value("name");
$r["is_default"] = $f->get_Value("is_default");
$r["icon"] = $f->get_Value("icon");
...
$card = $b->get_Card("create", array(
    "title" => lang("Languages.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
