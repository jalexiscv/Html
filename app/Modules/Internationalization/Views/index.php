...
$rviews = array(
    ...
    "internationalization-denied" => "{$views}\Denied\index",
    "internationalization-home" => "{$views}\Home\index",
    //[Languages]----------------------------------------------------------------------------------------
    "internationalization-languages-home" => "$views\Languages\Home\index",
    "internationalization-languages-list" => "$views\Languages\List\index",
    "internationalization-languages-view" => "$views\Languages\View\index",
    "internationalization-languages-create" => "$views\Languages\Create\index",
    "internationalization-languages-edit" => "$views\Languages\Edit\index",
    "internationalization-languages-delete" => "$views\Languages\Delete\index",
    //[others]------------------------------------------------------------------------------------------
);
...
$assign['left'] = get_internationalization_sidebar();
