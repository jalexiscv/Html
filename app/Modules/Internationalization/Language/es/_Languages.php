...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-12-20 15:55:30
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Application\Views\Languages\Creator\index.php]
...
return [
    ...
    "label_locale" => "locale",
    "label_name" => "name",
    "label_is_default" => "is_default",
    "label_icon" => "icon",
    "label_is_active" => "is_active",
    ...
    "placeholder_is_default" => "is_default",
    "placeholder_icon" => "icon",
    "placeholder_is_active" => "is_active",
    ...
    "help_locale" => "locale",
    "help_name" => "name",
    "help_is_default" => "is_default",
    "help_icon" => "icon",
    "help_is_active" => "is_active",
