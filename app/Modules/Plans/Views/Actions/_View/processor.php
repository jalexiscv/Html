...
//$edit = $model->update($d);
    $c = $bootstrap->get_Card('warning', array(
        ...
        'title' => lang("Actions.view-success-title"),
        'text' => lang("Actions.view-success-message"),
        'footer-class' => 'text-center',
        'footer-continue' => base_url("/plans/actions/view/{$d["action"]}/" . lpk()),
        'voice' => "plans/actions-view-success-message.mp3",
    ));
} else {
    $c = $bootstrap->get_Card('success', array(
        ...
        'icon' => 'fa-duotone fa-triangle-exclamation',
        'text-class' => 'text-center',
        'title' => lang("Actions.view-noexist-title"),
        'text' => lang("Actions.view-noexist-message"),
        'footer-class' => 'text-center',
        'footer-continue' => base_url("/plans/actions"),
        'voice' => "plans/actions-view-noexist-message.mp3",
    ));
}
echo($c);
?>
