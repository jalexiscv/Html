...
$menu = array(
    ...
    array("href" => "/plans/categories/home/{$component['component']}", "text" => "Componente", "class" => false),
    array("href" => "/plans/activities/home/{$category['category']}", "text" => "Categoría", "class" => false),
    array("href" => "/plans/plans/view/{$action['plan']}", "text" => "Plan", "class" => false),
    array("href" => "/plans/actions/home/{$action['plan']}", "text" => "Acciones", "class" => true),
);
