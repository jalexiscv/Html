...
$message = sprintf(lang("Plans_Actions.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Plans_Actions.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Plans_Actions.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
