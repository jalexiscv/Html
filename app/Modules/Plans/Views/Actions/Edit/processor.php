...
$l["back"] = "/plans/actions/home/{$d["plan"]}";
...
if (is_array($row)) {
    ...
    $c = $bootstrap->get_Card("success", array(
        ...
        "title" => lang("Plans_Actions.edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Plans_Actions.edit-success-message"),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Plans_Actions.edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Plans_Actions.edit-noexist-message"), $d['action']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
