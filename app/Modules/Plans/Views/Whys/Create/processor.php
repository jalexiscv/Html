...
//[Models]-----------------------------------------------------------------------------
$f = service("forms", array("lang" => "Plans_Whys."));
...
$l["back"] = "/plans/whys/list/{$d["cause"]}";
...
if (is_array($row)) {
    $c = $card = $bootstrap->get_Card("duplicate", array(
        ...
        "title" => lang("Plans_Whys.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Plans_Whys.create-duplicate-message"),
    ...
    $c = $card = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Plans_Whys.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Plans_Whys.create-success-message"), $d['why']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
