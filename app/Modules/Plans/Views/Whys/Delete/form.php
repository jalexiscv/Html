...
$message = sprintf(lang("Plans_Whys.delete-message"), $name);
$back = "/plans/whys/list/{$r['cause']}";
//[fields]----------------------------------------------------------------------------------------------------------------
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Plans_Whys.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Plans_Whys.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
