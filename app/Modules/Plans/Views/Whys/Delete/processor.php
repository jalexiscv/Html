...
/* Vars */
$l["back"] = "/plans/whys/list/{$row['cause']}";
...
if (isset($row["why"])) {
    ...
    $c = $bootstrap->get_Card("duplicate", array(
        ...
        "title" => lang("Plans_Whys.delete-success-title"),
        "text-class" => "text-center",
        "text" => lang("Plans_Whys.delete-success-message"),
    ...
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Plans_Whys.delete-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Plans_Whys.delete-noexist-message"), $d['why']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $vnoexist,
    ));
