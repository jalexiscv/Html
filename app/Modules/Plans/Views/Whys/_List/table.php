...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/plans/api/whys/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('icon' => ICON_ADD, 'text' => lang('App.Create'), 'href' => '/plans/whys/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'why' => array('text' => lang('App.why'), 'class' => 'text-center'),
...
$card = $bootstrap->get_Card("card-view-service", array(
    ...
    "header-back" => $back,
    "alert" => array("icon" => ICON_INFO, "type" => "info", "title" => lang('Whys.list-title'), "message" => lang('Whys.list-description')),
    "content" => $table,
));
echo($card);
?>
