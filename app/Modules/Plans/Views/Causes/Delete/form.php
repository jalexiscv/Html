...
$message = sprintf(lang("Plans_Causes.delete-message"), $name);
$back = "/plans/plans/causes/{$r["plan"]}";
//[fields]----------------------------------------------------------------------------------------------------------------
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Plans_Causes.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Plans_Causes.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
