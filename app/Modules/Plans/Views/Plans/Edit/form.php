...
if($r["module"]=="iso9001"){
    ...
    $activity = $mactivities->getActivity($row["activity"]);
...
$f->fields["plan_institutional"] = $f->get_FieldSelect("plan_institutional", array("selected" => $r["plan_institutional"], "data" => $plans, "proportion" => "col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12"));
...
$f->fields["value"] = $f->get_FieldNumber("value", array("value" => $r["value"], "min" => "0", "max" => "100", "proportion" => "col-md-3 col-sm-12 col-12"));
