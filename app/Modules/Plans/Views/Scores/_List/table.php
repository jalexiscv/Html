...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-04-15 15:12:56
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Plans\Views\Causes\Scores\List\table.php]
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang('Causes.list-title'),
    "header-back" => $back,
    "alert" => array("icon" => ICON_INFO, "type" => "info", "title" => lang('Causes.list-title'), "message" => lang('Causes.list-description')),
    "content" => $table,
));
echo($card);
?>
