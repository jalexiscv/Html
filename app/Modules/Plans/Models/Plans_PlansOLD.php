 ...
 */
class Plans_PlansOLD extends Model
{
    ...
    private function exec_TableRegenerate()
    {
        if (!$this->get_TableExist()) {
            ...
            $fields = [
                ...
                'manager_subprocess' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'manager_position' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'order' => ['type' => 'INT', 'constraint' => 10, 'null' => FALSE],
                'description' => ['type' => 'TEXT', 'null' => FALSE],
                'formulation' => ['type' => 'TEXT', 'null' => FALSE],
                ...
                'status_approval' => ['type' => 'TEXT', 'null' => true,],
                'status_approval_date' => ['type' => 'DATE', 'null' => true,],
                'status_approval_time' => ['type' => 'TIME', 'null' => true,],
    ...
    {
        $result = $this->where("plan", $plan)->first();
        if (is_array($result)) {
            return ($result);
        } else {
            return (false);
