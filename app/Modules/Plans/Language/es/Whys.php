...
return [
    ...
    "create-success-title" => "¡porqué registrada exitosamente!",
    ...
    "edit-success-message" => "Los datos de porqué se <b>actualizaron exitosamente</b>, para retornar al listado general de porqués presioné el botón continuar en la parte inferior del presente mensaje.",
    // - Whys deleter
