 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Plans\Config\Routes.php]
...
$mdm = model("App\Modules\Plans\Models\Plans_Modules");
$mdcxm = model("App\Modules\Plans\Models\Plans_Clients_Modules");
$module = 'plans';
...
if ($cxm == "authorized") {
    $routes->group($module,
        ['namespace' => $namespace],
        function ($subroutes) {
            $subroutes->add('/', 'Plans::index');
            $subroutes->add('/home', 'Plans::index');
            $subroutes->add('home/(:any)', 'Plans::home/$1');
    ...
    $routes->group($module, [
        'namespace' => $namespace],
        function ($subroutes) {
            $subroutes->add('/', 'Plans::denied/none');
            $subroutes->add('(:any)', 'Plans::denied/$1');
        }
    );
}
?>