...
$data['model'] = model("App\Modules\Mipg\Models\Mipg_Categories");
$data['permissions'] = array('singular' => 'mipg-categories-delete', "plural" => 'mipg-categories-delete-all');
...
$form = $component . '\form';
$deny = $component . '\deny';
$tree = 'App\Modules\Mipg\Views\Categories\Home\tree';
//[build]---------------------------------------------------------------------------------------------------------------
if ($plural || $authority) {
    if (!empty($submited)) {
