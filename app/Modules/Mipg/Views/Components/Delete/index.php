...
$data['model'] = model("App\Modules\Mipg\Models\Mipg_Components");
$data['permissions'] = array('singular' => 'mipg-components-delete', "plural" => 'mipg-components-delete-all');
...
$form = $component . '\form';
$deny = $component . '\deny';
$tree = 'App\Modules\Mipg\Views\Components\Home\tree';
//[build]---------------------------------------------------------------------------------------------------------------
if ($plural || $authority) {
    if (!empty($submited)) {
