...
if (is_array($row)) {
    ...
    $c = $bootstrap->get_Card("success", array(
        ...
        "title" => lang("Mipg_Plans.edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Mipg_Plans.approval-success-message"),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Mipg_Plans.edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Mipg_Plans.edit-noexist-message"), $d['plan']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
