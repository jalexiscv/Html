...
//[vars]----------------------------------------------------------------------------------------------------------------
$f = service("forms", array("lang" => "Mipg_Plans.plans-"));
...
//$edit = $model->update($d);
    $c = $bootstrap->get_Card('warning', array(
        ...
        'title' => lang("Mipg_Plans.plans-view-success-title"),
        'text' => lang("Mipg_Plans.plans-view-success-message"),
    ...
    $c = $bootstrap->get_Card('success', array(
        ...
        'icon' => 'fa-duotone fa-triangle-exclamation',
        'text-class' => 'text-center',
        'title' => lang("Mipg_Plans.plans-view-noexist-title"),
        'text' => lang("Mipg_Plans.plans-view-noexist-message"),
        'footer-class' => 'text-center',
