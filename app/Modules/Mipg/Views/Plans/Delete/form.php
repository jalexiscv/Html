...
$message = sprintf(lang("Mipg_Plans.plans-delete-message"), $name);
$back = "/mipg/plans/home/{$r['activity']}";
//[fields]----------------------------------------------------------------------------------------------------------------
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Mipg_Plans.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Mipg_Plans.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
