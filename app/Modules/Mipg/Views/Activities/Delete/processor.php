...
if (isset($row["activity"])) {
    ...
    $c = $bootstrap->get_Card("duplicate", array(
        ...
        "title" => lang("Mipg_Activities.delete-success-title"),
        "text-class" => "text-center",
        "text" => lang("Mipg_Activities.delete-success-message"),
    ...
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Mipg_Activities.delete-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Mipg_Activities.delete-noexist-message"), $d['activity']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $vnoexist,
    ));
