...
if (is_array($row)) {
    $c = $card = $bootstrap->get_Card("duplicate", array(
        ...
        "title" => lang("Mipg_Activities.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Mipg_Activities.create-duplicate-message"),
    ...
    $c = $card = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Mipg_Activities.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Mipg_Activities.create-success-message"), $d['activity']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
