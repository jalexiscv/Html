...
//[services]------------------------------------------------------------------------------------------------------------
$b = service("bootstrap");
$f = service("forms", array("lang" => "Mipg_Actions."));
//[models]--------------------------------------------------------------------------------------------------------------
...
$card = $b->get_Card("create", array(
    "title" => lang("Mipg_Actions.create-title"),
    "alert" => array(
        'type' => 'info',
        'title' => lang("Mipg_Actions.create-info-title"),
        'message' => sprintf(lang("Mipg_Actions.create-info-message"), $plan['start'], $plan['end']),
    ),
    "content" => $f,
    "header-back" => $back
));
...
$info = $b->get_Card("card-view-service", array(
    "alert" => array('type' => 'secondary', 'title' => lang("Mipg_Actions.create-definition-info-title"), 'message' => lang("Mipg_Actions.create-definition-info-message"), 'class' => 'mb-0'),
));
echo($info);
?>
