...
if (is_array($row)) {
    $c = $card = $bootstrap->get_Card("duplicate", array(
        ...
        "title" => lang("Mipg_Actions.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Mipg_Actions.create-duplicate-message"),
    ...
    $c = $card = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Mipg_Actions.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Mipg_Actions.create-success-message"), $d['action']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
