...
if (is_array($row)) {
    ...
    $c = $bootstrap->get_Card("success", array(
        ...
        "title" => lang("Mipg_Actions.edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Mipg_Actions.edit-success-message"),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Mipg_Actions.edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Mipg_Actions.edit-noexist-message"), $d['action']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
