 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Plans\Views\Actions\List\json.php]
...
//[Asignations]---------------------------------------------------------------------------------------------------------
$data = array();
$component = '/plans/actions';
foreach ($list as $item) {
    //[Buttons]---------------------------------------------------------------------------------------------------------
    $viewer = "{$component}/view/{$item["action"]}";
    $editor = "{$component}/edit/{$item["action"]}";
    $deleter = "{$component}/delete/{$item["action"]}";
    ...
    $row["plan"] = $item["plan"];
    $row["variables"] = $item["variables"];
    $row["alternatives"] = $item["alternatives"];
    $row["implementation"] = $item["implementation"];
