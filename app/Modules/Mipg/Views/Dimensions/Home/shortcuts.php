...
foreach ($dimensions as $dimension) {
    ...
    $code .= "\t\t\t\t\t\t<canvas id=\"heatGraph-{$dimension['dimension']}\" class=\"heatgraph-canvas v2\"  data-type=\"Dimensión\" data-title=\"$title\" data-subtitle=\"$subtitle\" data-percentage=\"$percentage\"></canvas>\n";
    $code .= "</a>\n";
    $code .= "</div>\n";
    $code .= "</div>\n";
    $code .= "</div>\n";
...
$title = "Recuerde";
$message = lang('Mipg_Dimensions.dimensions-info');
//[build]---------------------------------------------------------------------------------------------------------------
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang('Mipg_Dimensions.list-title'),
    "header-back" => $back,
...
$info = $bootstrap->get_Card("card-view-service", array(
    "xalert" => array(
        'type' => 'secondary',
        'title' => lang("Mipg_Dimensions.info-title"),
        'message' => lang("Mipg_Dimensions.info-message"),
        'class' => 'mb-0'),
));
//echo($info);
?>
