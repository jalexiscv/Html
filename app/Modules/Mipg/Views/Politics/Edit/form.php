...
$r["normative"] = $f->get_Value("normative", $row["normative"]);
$r["tools"] = $f->get_Value("tools", $row["tools"]);
...
$f->fields["normative"] = $f->get_FieldCKEditor("normative", array("value" => $r["normative"], "proportion" => "col-12"));
$f->fields["tools"] = $f->get_FieldCKEditor("tools", array("value" => $r["tools"], "proportion" => "col-12"));
...
$f->groups["g4"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["normative"])));
$f->groups["g5"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["tools"])));
//[buttons]-------------------------------------------------------------------------------------------------------------
$f->groups["gy"] = $f->get_GroupSeparator();
$f->groups["gz"] = $f->get_Buttons(array("fields" => $f->fields["submit"] . $f->fields["cancel"]));
//[build]---------------------------------------------------------------------------------------------------------------
$card = $bootstrap->get_Card("create", array(
    "title" => lang("Mipg_Politics.edit-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
