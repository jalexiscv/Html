...
$message = sprintf(lang("Mipg_Politics.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Mipg_Politics.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Mipg_Politics.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
