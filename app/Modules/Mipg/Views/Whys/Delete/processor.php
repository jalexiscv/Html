...
if (isset($row["why"])) {
    ...
    $c = $bootstrap->get_Card("duplicate", array(
        ...
        "title" => lang("Mipg_Whys.delete-success-title"),
        "text-class" => "text-center",
        "text" => lang("Mipg_Whys.delete-success-message"),
    ...
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Mipg_Whys.delete-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Mipg_Whys.delete-noexist-message"), $d['why']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $vnoexist,
    ));
