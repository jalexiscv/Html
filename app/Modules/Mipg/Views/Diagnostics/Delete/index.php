...
$data['model'] = model("App\Modules\Mipg\Models\Mipg_Diagnostics");
$data['permissions'] = array('singular' => 'mipg-diagnostics-delete', "plural" => 'mipg-diagnostics-delete-all');
...
$form = $component . '\form';
$deny = $component . '\deny';
$tree = 'App\Modules\Mipg\Views\Diagnostics\Home\tree';
//[build]---------------------------------------------------------------------------------------------------------------
if ($plural || $authority) {
    if (!empty($submited)) {
