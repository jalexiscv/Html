...
if (is_array($row)) {
    ...
    $c = $bootstrap->get_Card("success", array(
        ...
        "title" => lang("Mipg_Scores.edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Mipg_Scores.edit-success-message"),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Mipg_Scores.edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Mipg_Scores.edit-noexist-message"), $d['score']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
