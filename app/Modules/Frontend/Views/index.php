...
$version = round(($server->get_DirectorySize(APPPATH . 'Modules/Frontend') / 102400), 6);
$data = $parent->get_Array();
$rviews = array(
    "default" => "{$views}\E404\index",
    "frontend-denied" => "{$views}\Denied\index",
    "frontend-home" => "{$views}\Home\index",
    //[settings]--------------------------------------------------------------------------------------------------------
    "frontend-settings-home" => "{$views}\Settings\Home\index",
    //[Shortcuts]-------------------------------------------------------------------------------------------------------
    "frontend-shortcuts-home" => "$views\Shortcuts\Home\index",
    "frontend-shortcuts-list" => "$views\Shortcuts\List\index",
    "frontend-shortcuts-view" => "$views\Shortcuts\View\index",
    "frontend-shortcuts-create" => "$views\Shortcuts\Create\index",
    "frontend-shortcuts-edit" => "$views\Shortcuts\Edit\index",
    "frontend-shortcuts-delete" => "$views\Shortcuts\Delete\index",
    //[migrations]------------------------------------------------------------------------------------------------------
    "frontend-migrations-home" => "$views\Migrations\Home\index",
    //[others]----------------------------------------------------------------------------------------------------------
);
...
$assign['left'] = get_frontend_sidebar2();
