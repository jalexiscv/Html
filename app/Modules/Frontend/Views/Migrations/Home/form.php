...
try {
    ...
    foreach ($all as $migration) {
        $code .= "<br>Migraciones ejecutadas exitosamente {$migration->path} para el módulo {$migration->namespace}.";
    }
    $file_name = __FILE__;
    $code = "<br>Migraciones ejecutadas exitosamente {$file_name} para todos los módulos.";
} catch (\Throwable $e) {
