 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Frontend\Views\Shortcuts\Delete\form.php]
...
$r = $model->where('shortcut', $oid)->first();
$name = urldecode($r["title"]);
$message = sprintf(lang("Shortcuts.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Shortcuts.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Shortcuts.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
