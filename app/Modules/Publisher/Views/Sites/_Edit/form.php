...
//[vars]----------------------------------------------------------------------------------------------------------------
$r = $model->where('site', $oid)->first();
$r["site"] = $f->get_Value("site", $row["site"]);
$r["image"] = $f->get_Value("image", $row["image"]);
$r["name"] = $f->get_Value("name", $row["name"]);
$r["description"] = $f->get_Value("description", $row["description"]);
$r["max_links"] = $f->get_Value("max_links", $row["max_links"]);
$r["links_type"] = $f->get_Value("links_type", $row["links_type"]);
$r["sponsored"] = $f->get_Value("sponsored", $row["sponsored"]);
$r["post_cover"] = $f->get_Value("post_cover", $row["post_cover"]);
$r["categories"] = $f->get_Value("categories", $row["categories"]);
$r["min_traffic"] = $f->get_Value("min_traffic", $row["min_traffic"]);
$r["max_traffic"] = $f->get_Value("max_traffic", $row["max_traffic"]);
$r["type"] = $f->get_Value("type", $row["type"]);
$r["themes"] = $f->get_Value("themes", $row["themes"]);
$r["moz_da"] = $f->get_Value("moz_da", $row["moz_da"]);
$r["moz_pa"] = $f->get_Value("moz_pa", $row["moz_pa"]);
$r["moz_links"] = $f->get_Value("moz_links", $row["moz_links"]);
$r["moz_rank"] = $f->get_Value("moz_rank", $row["moz_rank"]);
$r["majestic_cf"] = $f->get_Value("majestic_cf", $row["majestic_cf"]);
$r["majestic_tf"] = $f->get_Value("majestic_tf", $row["majestic_tf"]);
$r["majestic_links"] = $f->get_Value("majestic_links", $row["majestic_links"]);
$r["majestic_rd"] = $f->get_Value("majestic_rd", $row["majestic_rd"]);
$r["ahrefs_dr"] = $f->get_Value("ahrefs_dr", $row["ahrefs_dr"]);
$r["ahrefs_bl"] = $f->get_Value("ahrefs_bl", $row["ahrefs_bl"]);
$r["ahrefs_rd"] = $f->get_Value("ahrefs_rd", $row["ahrefs_rd"]);
$r["ahrefs_obl"] = $f->get_Value("ahrefs_obl", $row["ahrefs_obl"]);
$r["ahrefs_otm"] = $f->get_Value("ahrefs_otm", $row["ahrefs_otm"]);
$r["sistrix"] = $f->get_Value("sistrix", $row["sistrix"]);
...
$card = $bootstrap->get_Card("create", array(
    "title" => lang("Publisher.sites-edit-title"),
    "content" => $f,
));
echo($card);
?>
