...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Publisher.sites-view-errors-title"));
    $smarty->assign("message", lang("Publisher.sites-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "publisher/sites-view-errors-message.mp3");
