 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Publisher\Views\Sites\Creator\processor.php]
...
$asuccess = "publisher/sites-create-success-message.mp3";
$aexist = "publisher/sites-create-exist-message.mp3";
if (is_array($row)) {
    $c = $card = $bootstrap->get_Card("duplicate", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Publisher.sites-create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Publisher.sites-create-duplicate-message"),
    ...
    $c = $card = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Publisher.sites-create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Publisher.sites-create-success-message"), $d['site']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
