...
$rviews = array(
    ...
    "publisher-denied" => "$views\Denied\index",
    "publisher-home" => "$views\Home\index",
    //[Sites]
    "publisher-sites-home" => "$views\Sites\Home\index",
    "publisher-sites-list" => "$views\Sites\List\index",
    "publisher-sites-view" => "$views\Sites\View\index",
    "publisher-sites-create" => "$views\Sites\Create\index",
    "publisher-sites-edit" => "$views\Sites\Edit\index",
    "publisher-sites-delete" => "$views\Sites\Delete\index",
);
...
$assign['left'] = get_publisher_sidebar();
