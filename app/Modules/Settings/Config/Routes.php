 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Settings\Config\Routes.php]
...
$mdm = model("App\Modules\Settings\Models\Settings_Modules");
$mdcxm = model("App\Modules\Settings\Models\Settings_Clients_Modules");
$module = 'settings';
...
if ($cxm == "authorized") {
    $routes->group($module,
        ...
        function ($subroutes) {
            ...
            $subroutes->add('/home', 'Settings::index');
            $subroutes->add('home/(:any)', 'Settings::home/$1');
    ...
    $routes->group($module,
        ['namespace' => $namespace],
        function ($subroutes) {
            $subroutes->add('(:any)', 'Settings::denied');
        }
    );
}
?>