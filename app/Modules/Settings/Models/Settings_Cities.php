...
/**
 * @Copilot Siempre que en el código se cree una variable llamada $mCities, esta deberá ser igualada a  model('App\Modules\Settings\Models\Settings_Cities');
 * @Instruction $mCities = model('App\Modules\Settings\Models\Settings_Cities');
 ...
 */
class Settings_Cities extends CachedModel
{
    ...
    public function getCountByRegion($region): int
    {
        $result = $this->where("region", $region)->countAllResults();
        return ($result);
    }
