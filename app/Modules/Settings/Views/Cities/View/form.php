...
$f->fields["edit"] = $f->get_Button("edit", array("href" => "/application/Cities/edit/" . $oid, "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
//[Groups]-----------------------------------------------------------------------------
...
$card = $bootstrap->get_Card2("card-view-service", array(
    "header-title" => lang("Settings_Cities.view-title"),
    "header-back" => $back,
    "content" => $f,
));
echo($card);
