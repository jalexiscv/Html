 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Application\Views\Cities\Delete\form.php]
...
$message = sprintf(lang("Settings_Cities.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Settings_Cities.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Settings_Cities.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
