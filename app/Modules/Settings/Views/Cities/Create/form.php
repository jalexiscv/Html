...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2025-05-05 18:53:01
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Application\Views\Cities\Creator\form.php]
...
//[models]--------------------------------------------------------------------------------------------------------------
//$model = model("App\Modules\Settings\Models\Settings_Cities");
...
$country = $mregions->getCountryByRegion($oid);


$r["city"] = $f->get_Value("city");
$r["region"] = $f->get_Value("region", $oid);
$r["country"] = $f->get_Value("country", $country);
...
$f->fields["region"] = $f->get_FieldText("region", array("value" => $r["region"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "readonly" => true));
$f->fields["country"] = $f->get_FieldText("country", array("value" => $r["country"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "readonly" => true));
...
$card = $b->get_Card2("create", array(
    "header-title" => lang("Settings_Cities.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
