 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Application\Views\Countries\Delete\form.php]
...
$r = $model->getCountri($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Settings_Countries.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Settings_Countries.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Settings_Countries.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
