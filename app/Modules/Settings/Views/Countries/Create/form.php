 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Application\Views\Countries\Creator\form.php]
...
$r["_iso3"] = $f->get_Value("_iso3");
$r["codigo"] = $f->get_Value("codigo");
...
$card = $b->get_Card2("create", array(
    "header-title" => lang("Settings_Countries.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
