...
$data['model'] = model("App\Modules\Settings\Models\Settings_Countries");
$data['permissions'] = array('singular' => 'settings-countries-view', "plural" => 'settings-countries-view-all');
