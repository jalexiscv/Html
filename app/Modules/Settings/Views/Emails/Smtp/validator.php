...
$f->set_ValidationRule("smtp_host","trim|required");
$f->set_ValidationRule("smtp_port","trim|required");
$f->set_ValidationRule("smtp_smtpsecure","trim|required");
$f->set_ValidationRule("smtp_smtpauth","trim|required");
$f->set_ValidationRule("smtp_username","trim|required");
$f->set_ValidationRule("smtp_password","trim|required");
$f->set_ValidationRule("smtp_from_email","trim|required");
$f->set_ValidationRule("smtp_from_name","trim|required");
$f->set_ValidationRule("smtp_charset","trim|required");
