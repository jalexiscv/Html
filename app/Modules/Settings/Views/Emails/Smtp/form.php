...
$f->fields["smtp_host"] = $f->get_FieldText("smtp_host", array("value" => $r["smtp_host"],"proportion"=>"col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["smtp_port"] = $f->get_FieldText("smtp_port", array("value" => $r["smtp_port"],"proportion"=>"col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["smtp_smtpsecure"] = $f->get_FieldSelect("smtp_smtpsecure", array("selected" => $r["smtp_smtpsecure"],"data"=>$encryps,"proportion"=>"col-md-6 col-sm-12 col-12"));
$f->fields["smtp_smtpauth"] = $f->get_FieldSelect("smtp_smtpauth", array("selected" => $r["smtp_smtpauth"],"data"=>$smtpsecures,"proportion"=>"col-md-6 col-sm-12 col-12"));
$f->fields["smtp_username"] = $f->get_FieldText("smtp_username", array("value" => $r["smtp_username"],"proportion"=>"col-md-6 col-sm-12 col-12"));
$f->fields["smtp_password"] = $f->get_FieldText("smtp_password", array("value" => $r["smtp_password"],"proportion"=>"col-md-6 col-sm-12 col-12"));
$f->fields["smtp_from_email"] = $f->get_FieldText("smtp_from_email", array("value" => $r["smtp_from_email"],"proportion"=>"col-md-6 col-sm-12 col-12"));
$f->fields["smtp_from_name"] = $f->get_FieldText("smtp_from_name", array("value" => $r["smtp_from_name"],"proportion"=>"col-md-6 col-sm-12 col-12"));
$f->fields["smtp_charset"] = $f->get_FieldSelect("smtp_charset", array("selected" => $r["smtp_charset"],"data"=>$charsets,"proportion"=>"col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
//[groups]----------------------------------------------------------------------------------------------------------------
$f->groups["g2"]=$f->get_Group(array("legend"=>"","fields"=>($f->fields["smtp_host"].$f->fields["smtp_port"].$f->fields["smtp_charset"])));
$f->groups["g5"]=$f->get_Group(array("legend"=>"","fields"=>($f->fields["smtp_username"].$f->fields["smtp_password"])));
...
$card = $bootstrap->get_Card("create", array(
		 "title" => lang("Settings_Clients.smtp-title"),
		 "content" =>$f,
		 "header-back" =>$back
));
echo($card);
