...
$message = sprintf(lang("Settings_Regions.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Settings_Regions.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Settings_Regions.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
