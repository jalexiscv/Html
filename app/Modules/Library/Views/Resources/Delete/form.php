 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Library\Views\Resources\Delete\form.php]
...
$r = $model->where('resource', $oid)->first();
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Resources.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Resources.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
