 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Plex\Home\breadcrumb.php]
...
if ($authentication->get_LoggedIn() && $authentication->has_Permission("plex-access")) {
    ...
    $shortcuts->add($bootstrap->get_Shortcut(array("href" => "/#" . lpk(), "icon" => ICON_TOOLS, "value" => lang("App.Licenses"), "description" => "Herramienta")));
