...
//[fields]----------------------------------------------------------------------------------------------------------------
$f->fields["client"] = $f->get_FieldText("client", array("value" => $r["client"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
//[groups]----------------------------------------------------------------------------------------------------------------
$f->groups["g7"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["fb_app_id"])));
$f->groups["g8"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["fb_app_secret"])));
$f->groups["g8"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["fb_page"])));
//[buttons]-------------------------------------------------------------------------------------------------------------
