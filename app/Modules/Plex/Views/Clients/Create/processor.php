...
$model = model("App\Modules\Plex\Models\Plex_Clients");
$d = array(
...
if (is_array($row)) {
    $c = $bootstrap->get_Card("duplicate", array(
        ...
        "title" => lang("Clients.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Clients.create-duplicate-message"),
    ...
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Clients.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Clients.create-success-message"), $d['client']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
