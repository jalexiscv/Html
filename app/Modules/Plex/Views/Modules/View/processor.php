...
$c = $bootstrap->get_Card('warning', array(
				...
				'title' => lang("Plex_Modules.view-success-title"),
				'text' => lang("Plex_Modules.view-success-message"),
				'footer-class' => 'text-center',
				'footer-continue' => base_url("/plex/modules/view/{$d["module"]}/".lpk()),
				'voice' => "application/modules-view-success-message.mp3",
		));
}else {
$c = $bootstrap->get_Card('success', array(
				...
				'icon' => 'fa-duotone fa-triangle-exclamation',
				'text-class' => 'text-center',
				'title' => lang("Plex_Modules.view-noexist-title"),
				'text' => lang("Plex_Modules.view-noexist-message"),
				'footer-class' => 'text-center',
				'footer-continue' => base_url("/plex/modules"),
				'voice' => "application/modules-view-noexist-message.mp3",
		));
}
echo($c);
?>
