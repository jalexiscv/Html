...
$row["icon_light"]=!empty($row["icon_light"])?$row["icon_light"]:"/themes/assets/icons/application.svg";
$row["icon_dark"]=!empty($row["icon_dark"])?$row["icon_dark"]:"/themes/assets/icons/application.svg";
...
$r["icon_light"] = $f->get_Value("icon_light",$row["icon_light"]);
$r["icon_dark"] = $f->get_Value("icon_dark",$row["icon_dark"]);
...
$card = $bootstrap->get_Card2("create", array(
		 "header-title" => lang("Plex_Modules.edit-title"),
		 "content" =>$f,
		 "header-back" =>$back
));
echo($card);
