...
$version = round(($server->get_DirectorySize(APPPATH . 'Modules/Storage') / 102400), 6);
$data = $parent->get_Array();
$rviews = array(
    "default" => "{$views}\E404\index",
    "storage-denied" => "{$views}\Denied\index",
    "storage-home" => "{$views}\Home\index",
    //[Attachments]
    "storage-attachments-home" => "$views\Attachments\Home\index",
    "storage-attachments-list" => "$views\Attachments\List\index",
    "storage-attachments-view" => "$views\Attachments\View\index",
    "storage-attachments-create" => "$views\Attachments\Create\index",
    "storage-attachments-edit" => "$views\Attachments\Edit\index",
    "storage-attachments-delete" => "$views\Attachments\Delete\index",
    //[others]------------------------------------------------------------------------------------------
);
...
$assign['left'] = get_storage_sidebar();
