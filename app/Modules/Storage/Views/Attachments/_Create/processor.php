 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Storage\Views\Attachments\Creator\processor.php]
...
$asuccess = "storage/attachments-create-success-message.mp3";
$aexist = "storage/attachments-create-exist-message.mp3";
if (is_array($row)) {
    $c = $card = $bootstrap->get_Card("duplicate", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Storage.attachments-create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Storage.attachments-create-duplicate-message"),
    ...
    $c = $card = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Storage.attachments-create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Storage.attachments-create-success-message"), $d['attachment']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
