...
/** @var TYPE_NAME $serie */
$rows = $msubseries->getSearch($serie, $conditions, $limit, $offset, "subserie DESC");
...
$card = $bootstrap->get_Card2("card-grid", array(
    "header-title" => "Subseries documentales",
    "header-add" => "/sgd/subseries/create/" . $serie,
    "alert" => array("icon" => ICON_INFO, "type" => "info", "title" => lang('Sgd_Subseries.list-title'), "message" => lang('Sgd_Subseries.list-message')),
    "content" => $bgrid,
));
echo($card);
?>