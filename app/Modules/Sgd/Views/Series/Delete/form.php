...
$r = $model->get_Serie($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Sgd_Series.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Sgd_Series.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Sgd_Series.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
