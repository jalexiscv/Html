...
if (is_array($row)) {
    $c= $bootstrap->get_Card("duplicate", array(
        ...
        "title" => lang("Sgd_Series.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Sgd_Series.create-duplicate-message"),
    ...
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Sgd_Series.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Sgd_Series.create-success-message"),$d['serie']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" =>$asuccess,
    ));
