...
/**
* █ ---------------------------------------------------------------------------------------------------------------------
* █ ░FRAMEWORK                                  2025-02-21 17:36:08
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sgd\Views\Units\Editor\form.php]
...
$back= "/sgd/versions/view/{$r["version"]}";
//[Fields]-----------------------------------------------------------------------------
$f->fields["unit"] = $f->get_FieldView("unit", array("value" => $r["unit"],"proportion"=>"col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->fields["edit"] =$f->get_Button("edit", array("href" =>"/sgd/units/edit/".$oid,"text" =>lang("App.Edit"),"class"=>"btn btn-secondary","proportion" =>"col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
//[Groups]-----------------------------------------------------------------------------
$f->groups["g1"]=$f->get_Group(array("legend"=>"","fields"=>($f->fields["unit"].$f->fields["reference"].$f->fields["name"])));
...
$card = $bootstrap->get_Card2("card-view-service", array(
		"header-title" => lang("Sgd_Units.view-title"),
		"header-back" => $back,
		"content" => $f,
));
echo($card);
