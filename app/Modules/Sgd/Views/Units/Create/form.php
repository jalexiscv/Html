...
/**
* █ ---------------------------------------------------------------------------------------------------------------------
* █ ░FRAMEWORK                                  2025-02-21 17:36:06
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sgd\Views\Units\Creator\form.php]
...
//[models]--------------------------------------------------------------------------------------------------------------
//$model = model("App\Modules\Sgd\Models\Sgd_Units");
//[vars]----------------------------------------------------------------------------------------------------------------
/**
...
$back="/sgd/versions/view/{$oid}";
//[fields]----------------------------------------------------------------------------------------------------------------
$f->add_HiddenField("back",$back);
$f->fields["unit"] = $f->get_FieldText("unit", array("value" => $r["unit"],"proportion"=>"col-md-4 col-sm-12 col-12","readonly"=>true));
...
$f->fields["owner"] = $f->get_FieldText("owner", array("value" => $r["owner"],"proportion"=>"col-12"));
...
//[groups]----------------------------------------------------------------------------------------------------------------
$f->groups["g1"]=$f->get_Group(array("legend"=>"","fields"=>($f->fields["unit"].$f->fields["version"].$f->fields["reference"])));
...
$card = $b->get_Card("create", array(
		 "title" => lang("Sgd_Units.create-title"),
		 "content" =>$f,
		 "header-back" =>$back
));
echo($card);
