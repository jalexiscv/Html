...
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sgd\Views\Registrations\Creator\validator.php]
...
$f->set_ValidationRule("folios","trim|required|numeric|greater_than[0]");
//$f->set_ValidationRule("observations","trim|required");
$f->set_ValidationRule("date","trim|required");
//$f->set_ValidationRule("qrcode","trim|required");
