...
$c = $bootstrap->get_Card('warning', array(
				...
				'footer-continue' => base_url("/sgd/registrations/view/{$d["registration"]}/".lpk()),
				'voice' => "sgd/registrations-view-success-message.mp3",
		));
}else {
$c = $bootstrap->get_Card('success', array(
				...
				'footer-class' => 'text-center',
				'footer-continue' => base_url("/sgd/registrations"),
				'voice' => "sgd/registrations-view-noexist-message.mp3",
		));
}
echo($c);
?>
