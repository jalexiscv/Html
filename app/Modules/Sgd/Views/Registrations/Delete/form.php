...
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sgd\Views\Registrations\Delete\form.php]
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
		 "class" =>"card-info",
		 "icon" => ICON_WARNING,
		 "title" => sprintf(lang("Sgd_Registrations.delete-title"),$name),
		 "text-class" =>"text-center",
		 "text"=>sprintf(lang("Sgd_Registrations.delete-message"),$name),
		 "content" =>$f,
		 "header-back" =>$back
));
echo($card);
