...
if (!empty($execution['execution'])) {
    ...
    $last_calification .= "</tr>";
    $last_calification .= "<tr>";
    $cuc1 = ($execution['c1'] < 80) ? 'text-bg-primary' : '';
    $cuc2 = ($execution['c2'] < 80) ? 'text-bg-primary' : '';
    $cuc3 = ($execution['c3'] < 80) ? 'text-bg-primary' : '';
    $cct = ($ct < 80) ? 'text-bg-primary' : '';
    ...
    if ($pt == 0 && $ct < 80) {
        ...
        $last_calification .= "<td colspan=\"4\" class='text-bg-primary'>Cursando</td>";
