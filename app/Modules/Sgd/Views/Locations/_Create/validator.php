...
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sgd\Views\Locations\Creator\validator.php]
...
//[Request]-----------------------------------------------------------------------------
//$f->set_ValidationRule("location","trim|required");
//$f->set_ValidationRule("center","trim|required");
//$f->set_ValidationRule("shelve","trim|required");
//$f->set_ValidationRule("box","trim|required");
//$f->set_ValidationRule("folder","trim|required");
