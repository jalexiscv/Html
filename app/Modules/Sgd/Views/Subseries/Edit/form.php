...
$back = "/sgd/series/view/{$r["serie"]}";
//[fields]----------------------------------------------------------------------------------------------------------------
$f->fields["subserie"] = $f->get_FieldText("subserie", array("value" => $r["subserie"], "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12", "readonly" => true));
$f->fields["serie"] = $f->get_FieldText("serie", array("value" => $r["serie"], "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12", "readonly" => true));
...
$card = $bootstrap->get_Card("create", array(
    "title" => lang("Sgd_Subseries.edit-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
