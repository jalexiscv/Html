...
//[vars]----------------------------------------------------------------------------------------------------------------
$r["subserie"] = $f->get_Value("subserie", pk());
$r["serie"] = $f->get_Value("serie", $oid);
$r["reference"] = $f->get_Value("name");
...
$back = "/sgd/series/view/{$oid}";
//[fields]----------------------------------------------------------------------------------------------------------------
$f->add_HiddenField("back", $back);
$f->fields["subserie"] = $f->get_FieldText("subserie", array("value" => $r["subserie"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "readonly" => true));
...
//[groups]----------------------------------------------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["subserie"] . $f->fields["serie"])));
...
$card = $b->get_Card("create", array(
    "title" => lang("Sgd_Subseries.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
