...
/**
* █ ---------------------------------------------------------------------------------------------------------------------
* █ ░FRAMEWORK                                  2025-03-27 04:42:03
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sgd\Views\Boxes\Creator\form.php]
...
**/
$r["box"] = $f->get_Value("box",pk());
$r["shelve"] = $f->get_Value("shelve",$oid);
...
$card = $b->get_Card2("create", array(
		 "header-title" => lang("Sgd_Boxes.create-title"),
		 "content" =>$f,
		 "header-back" =>$back
));
echo($card);
