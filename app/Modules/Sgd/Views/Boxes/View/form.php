...
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sgd\Views\Boxes\Editor\form.php]
...
$back= "/sgd/shelves/view/".$r["shelve"];
//[Fields]-----------------------------------------------------------------------------
...
$f->fields["edit"] =$f->get_Button("edit", array("href" =>"/sgd/boxes/edit/".$oid,"text" =>lang("App.Edit"),"class"=>"btn btn-secondary","proportion" =>"col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
//[Groups]-----------------------------------------------------------------------------
$f->groups["g1"]=$f->get_Group(array("legend"=>"","fields"=>($f->fields["box"].$f->fields["shelve"].$f->fields["reference"])));
...
$card = $bootstrap->get_Card2("card-view-service", array(
		"header-title" => lang("Sgd_Boxes.view-title"),
		"header-back" => $back,
		"content" => $f,
));
echo($card);
