...
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sgd\Views\Boxes\Delete\form.php]
...
$message=sprintf(lang("Sgd_Boxes.delete-message"),$name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
		 "class" =>"card-info",
		 "icon" => ICON_WARNING,
		 "title" => sprintf(lang("Sgd_Boxes.delete-title"),$name),
		 "text-class" =>"text-center",
		 "text"=>sprintf(lang("Sgd_Boxes.delete-message"),$name),
		 "content" =>$f,
		 "header-back" =>$back
));
echo($card);
