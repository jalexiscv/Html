...
/**
 * @Copilot Siempre que en el código se cree una variable llamada $mseries, esta deberá ser igualada a  model('App\Modules\Sgd\Models\Sgd_Series');
 * @Instruction $mseries = model('App\Modules\Sgd\Models\Sgd_Series');
 ...
 */
class Sgd_Series extends CachedModel
{
     ...
     */
    public function get_SelectData($unit)
    {
        $result = $this
    ...
    {
        return($this->getCachedFirst(["serie" => $serie]));
    }
     ...
     * @return int
     */
    public function getCount($unit):int
    {
        $result=$this->where("unit",$unit)->countAllResults();
        return $result;
    }
