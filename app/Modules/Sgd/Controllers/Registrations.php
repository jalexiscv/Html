...
class Registrations extends ModuleController {
    ...
    public function index() {
        $url = base_url('sgd/registrations/home/' . lpk());
    ...
    public function print(string $oid) {
        ...
        $this->component = $this->views . '\Registrations\Print';
        return (view($this->viewer, $this->get_Array()));
    }


    public function print2(string $oid) {
        $this->oid = $oid;
        $this->prefix = "{$this->prefix}-print2";
        $this->component = $this->views . '\Registrations\Print2';
        return (view($this->viewer, $this->get_Array()));
    }
