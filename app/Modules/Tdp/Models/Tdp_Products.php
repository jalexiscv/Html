 ...
 */
class Tdp_Products extends Model
{
    protected $table = "tdp_products";
...
//$forge->addKey('profile');
     ...
     */
    public function get_List($program, int $limit, int $offset, string $search = ""): array|false
    {
        $result = $this
     ...
     */
    function get_Total($program, string $search = ""): int
    {
        $result = $this
            ->where("program", $program)
            ->groupStart()
