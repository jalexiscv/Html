...
//[vars]----------------------------------------------------------------------------------------------------------------
$row = $model->where('line', $oid)->first();
$r["line"] = $f->get_Value("line", $row["line"]);
...
//[fields]----------------------------------------------------------------------------------------------------------------
$f->fields["line"] = $f->get_FieldText("line", array("value" => $r["line"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "readonly" => true));
