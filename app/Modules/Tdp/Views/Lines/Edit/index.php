...
$data['model'] = model("App\Modules\Tdp\Models\Tdp_Lines");
$data['permissions'] = array('singular' => 'tdp-lines-edit', "plural" => 'tdp-lines-edit-all');
...
$form = $component . '\form';
$deny = $component . '\deny';
$tree = 'App\Modules\Tdp\Views\Lines\Home\tree';
//[build]---------------------------------------------------------------------------------------------------------------
if ($plural || $authority) {
    if (!empty($submited)) {
