...
$f = service("forms", array("lang" => "Lines."));
//[Request]-----------------------------------------------------------------------------
$row = $model->find($oid);
$r["line"] = $row["line"];
...
$back = "/tdp/lines/list/{$r["dimension"]}";
//[Fields]-----------------------------------------------------------------------------
$f->fields["line"] = $f->get_FieldView("line", array("value" => $r["line"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->fields["edit"] = $f->get_Button("edit", array("href" => "/tdp/lines/edit/" . $oid, "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
//[Groups]-----------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["line"] . $f->fields["dimension"] . $f->fields["order"])));
