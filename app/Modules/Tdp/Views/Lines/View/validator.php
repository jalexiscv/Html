...
* -----------------------------------------------------------------------------
*/
$f->set_ValidationRule("line", "trim|required");
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Lines.view-errors-title"));
    $smarty->assign("message", lang("Lines.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "tdp/lines-view-errors-message.mp3");
