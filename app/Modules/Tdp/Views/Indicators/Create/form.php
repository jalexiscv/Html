...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-03-26 14:31:20
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Tdp\Views\Indicators\Creator\form.php]
...
//[vars]----------------------------------------------------------------------------------------------------------------
$r["indicator"] = $f->get_Value("indicator", pk());
$r["product"] = $f->get_Value("product", $oid);
...
$r["multiplan"] = $f->get_Value("multiplan");
...
$card = $b->get_Card("create", array(
    "title" => lang("Indicators.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
