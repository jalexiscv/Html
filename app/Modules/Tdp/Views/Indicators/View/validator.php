 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Tdp\Views\Indicators\Editor\validator.php]
...
* -----------------------------------------------------------------------------
*/
$f->set_ValidationRule("indicator", "trim|required");
...
$f->set_ValidationRule("budget", "trim|required");
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Indicators.view-errors-title"));
    $smarty->assign("message", lang("Indicators.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "tdp/indicators-view-errors-message.mp3");
