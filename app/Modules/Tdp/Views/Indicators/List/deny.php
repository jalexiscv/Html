...
$mdiagnostics = model('App\Modules\tdp\Models\tdp_Diagnostics');
$mcomponents = model('App\Modules\tdp\Models\tdp_Components');
$mcategories = model('App\Modules\tdp\Models\tdp_Categories');
$mactivities = model('App\Modules\tdp\Models\tdp_Activities');

$category = $mcategories->where("category", $oid)->first();

$bootstrap = service("bootstrap");
$continue = "/mipg/categories/home/{$category['component']}";
