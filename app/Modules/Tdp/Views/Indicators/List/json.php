 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Tdp\Views\Indicators\List\json.php]
 ...
 * █ @var object $mindicators Modelo de datos utilizado en la vista y trasferido desde el index
 * █ ---------------------------------------------------------------------------------------------------------------------
 **/
...
//[Query]---------------------------------------------------------------------------------------------------------------
$list = $mindicators->get_List($limit, $offset, $search, $oid);
$recordsTotal = $mindicators->get_Total($search, $oid);
//$sql=$mindicators->getLastQuery()->getQuery();
//[Asignations]---------------------------------------------------------------------------------------------------------
$data = array();
$component = '/tdp/indicators';
foreach ($list as $item) {
    //[Buttons]---------------------------------------------------------------------------------------------------------
    $viewer = "{$component}/view/{$item["indicator"]}";
    $editor = "{$component}/edit/{$item["indicator"]}";
    $deleter = "{$component}/delete/{$item["indicator"]}";
