 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Tdp\Views\Indicators\Delete\form.php]
...
$r = $model->where('indicator', $oid)->first();
$name = $strings->get_Striptags(urldecode($r["description"]));
$message = sprintf(lang("Indicators.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Indicators.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Indicators.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
