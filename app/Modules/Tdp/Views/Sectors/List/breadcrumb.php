...
$dimension = $mdimensions->where("dimension", $line['dimension'])->first();

$menu = array(
    array("href" => "/tdp/", "text" => "TDP", "class" => false),
    array("href" => "/tdp/dimensions/home/" . lpk(), "text" => lang("App.Dimensions"), "class" => false),
    array("href" => "/tdp/lines/home/{$line['dimension']}", "text" => lang("App.Lines"), "class" => false),
    array("href" => "/tdp/diagnostics/home/{$diagnostic['line']}", "text" => lang("App.Diagnostics"), "class" => false),
    array("href" => "/tdp/sectors/home/{$oid}", "text" => $diagnostic['name'], "class" => "active"),
);
