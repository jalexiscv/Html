...
//[vars]----------------------------------------------------------------------------------------------------------------
$back = "/tdp/sectors/home/{$oid}";
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => "/tdp/api/sectors/json/list/{$oid}",
    'buttons' => array(
        'create' => array('icon' => ICON_ADD, 'text' => lang('App.Create'), 'href' => "/tdp/sectors/create/{$oid}", 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'sector' => array('text' => lang('App.Sector'), 'class' => 'text-center', 'visible' => false),
