...
$list = $msectors->get_List($limit, $offset, $search, $oid);
$recordsTotal = $msectors->get_Total($search, $oid);
//$sql=$msectors->getLastQuery()->getQuery();
//[Asignations]---------------------------------------------------------------------------------------------------------
$data = array();
$component = '/tdp/sectors';
foreach ($list as $item) {
    //[Buttons]---------------------------------------------------------------------------------------------------------
    $viewer = "/tdp/programs/home/{$item["sector"]}";
    $editor = "{$component}/edit/{$item["sector"]}";
    $deleter = "{$component}/delete/{$item["sector"]}";
