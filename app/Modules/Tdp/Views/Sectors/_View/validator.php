...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Sectors.view-errors-title"));
    $smarty->assign("message", lang("Sectors.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "tdp/sectors-view-errors-message.mp3");
