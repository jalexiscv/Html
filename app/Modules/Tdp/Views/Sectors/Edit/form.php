...
//[vars]----------------------------------------------------------------------------------------------------------------
$row = $model->where('sector', $oid)->first();
$r["sector"] = $f->get_Value("sector", $row["sector"]);
...
$back = "/tdp/sectors/list/{$r["diagnostic"]}";
//[fields]----------------------------------------------------------------------------------------------------------------
$f->fields["sector"] = $f->get_FieldText("sector", array("value" => $r["sector"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "readonly" => true));
