...
$data['model'] = model("App\Modules\Tdp\Models\Tdp_Sectors");
$data['permissions'] = array('singular' => 'tdp-sectors-delete', "plural" => 'tdp-sectors-delete-all');
...
$form = $component . '\form';
$deny = $component . '\deny';
$tree = 'App\Modules\Tdp\Views\Sectors\Home\tree';
//[build]---------------------------------------------------------------------------------------------------------------
if ($plural || $authority) {
    if (!empty($submited)) {
