...
$menu = array(
    ...
    array("href" => "/tdp/programs/home/{$program['sector']}", "text" => $name_sector, "class" => false),
    //array("href" => "/tdp/programs/home/{$program['sector']}", "text" => lang("App.Programs"), "class" => false),
    array("href" => "/tdp/products/home/$oid", "text" => lang("App.Products"), "class" => false)
);
