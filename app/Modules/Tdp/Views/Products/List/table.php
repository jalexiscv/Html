...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-03-25 23:42:49
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Tdp\Views\Products\List\table.php]
...
//[vars]----------------------------------------------------------------------------------------------------------------
$back = "/tdp/products/home/{$oid}";
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => "/tdp/api/products/json/list/{$oid}",
    'buttons' => array(
        'create' => array('icon' => ICON_ADD, 'text' => lang('App.Create'), 'href' => '/tdp/products/create/' . $oid, 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'product' => array('text' => lang('App.Product'), 'class' => 'text-center'),
        'program' => array('text' => lang('App.Program'), 'class' => 'text-center'),
        'order' => array('text' => lang('App.Order'), 'class' => 'text-center', 'visible' => false),
