...
$data['model'] = model("App\Modules\Tdp\Models\Tdp_Programs");
$data['permissions'] = array('singular' => 'tdp-programs-delete', "plural" => 'tdp-programs-delete-all');
...
$form = $component . '\form';
$deny = $component . '\deny';
$tree = 'App\Modules\Tdp\Views\Programs\Home\tree';
//[build]---------------------------------------------------------------------------------------------------------------
if ($plural || $authority) {
    if (!empty($submited)) {
