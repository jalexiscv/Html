...
$component = $msectors->get_Sector($oid);
if (!$component) {
    $program = $mprograms->get_Program($oid);
    $component = $msectors->get_Sector($program['component']);
}
...
$menu = array(
    ...
    array("href" => "/tdp/components/home/{$diagnostic['diagnostic']}", "text" => $name_diagnostic, "class" => false),
    array("href" => "/tdp/programs/home/$oid", "text" => $name_component, "class" => false),
