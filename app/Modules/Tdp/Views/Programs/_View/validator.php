...
$f->set_ValidationRule("sector", "trim|required");
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Programs.view-errors-title"));
    $smarty->assign("message", lang("Programs.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "tdp/programs-view-errors-message.mp3");
