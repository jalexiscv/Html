...
$f = service("forms", array("lang" => "Programs."));
//[Request]-----------------------------------------------------------------------------
$row = $model->find($oid);
...
$back = "/tdp/programs/list/" . lpk();
//[Fields]-----------------------------------------------------------------------------
$f->fields["program"] = $f->get_FieldView("program", array("value" => $r["program"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["sector"] = $f->get_FieldView("sector", array("value" => $r["sector"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->fields["edit"] = $f->get_Button("edit", array("href" => "/tdp/programs/edit/" . $oid, "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
//[Groups]-----------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["program"] . $f->fields["sector"] . $f->fields["order"])));
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang("Programs.view-title"),
    "header-back" => $back,
    "content" => $f,
));
echo($card);
