...
$data['model'] = model("App\Modules\Tdp\Models\Tdp_Diagnostics");
$data['permissions'] = array('singular' => 'tdp-diagnostics-delete', "plural" => 'tdp-diagnostics-delete-all');
...
$form = $component . '\form';
$deny = $component . '\deny';
$tree = 'App\Modules\Tdp\Views\Diagnostics\Home\tree';
//[build]---------------------------------------------------------------------------------------------------------------
if ($plural || $authority) {
    if (!empty($submited)) {
