...
return [
    ...
    "label_description" => "Descripción del programa",
    "label_author" => "author",
    ...
    "help_program" => "Código automático(Requerido)",
    ...
    "create-duplicate-message" => "Este programa ya se había registrado previamente, presioné continuar en la parte inferior de este mensaje para retornar al listado general de programas.",
    "create-success-title" => "¡Categoría registrada exitosamente!",
    "create-success-message" => "La programa se registró exitosamente, para retornar al listado general de programas presioné continuar en la parte inferior de este mensaje.",
    // - Programs viewer
    ...
    "edit-noexist-message" => "El elemento que actualizar no existe o se elimino previamente, para retornar al listado general de programas presioné continuar en la parte inferior de este mensaje. ",
    "edit-success-title" => "¡programa actualizada!",
    "edit-success-message" => "Los datos de programa se <b>actualizaron exitosamente</b>, para retornar al listado general de programas presioné el botón continuar en la parte inferior del presente mensaje.",
    // - Programs deleter
    ...
    "delete-message" => "Para confirmar la eliminación del programa <b>%s</b>, presioné eliminar, para retornar al listado general de programas presioné cancelar.",
    ...
    "delete-noexist-message" => "\El elemento que intenta eliminar no existe o se elimino previamente, para retornar al listado general de programas presioné continuar en la parte inferior de este mensaje.",
    "delete-success-title" => "¡programa eliminad@ exitosamente!",
    "delete-success-message" => "La programa se elimino exitosamente, para retornar al listado de general de programas presioné el botón continuar en la parte inferior de este mensaje.",
    // - Programs list
    ...
    "tdp-list-title" => "Sector / Programas",
];
