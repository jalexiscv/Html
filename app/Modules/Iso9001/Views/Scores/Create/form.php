...
$title = lang("Iso9001_Scores.info-create-title");
$message = lang("Iso9001_Scores.info-create-message");
//[build]---------------------------------------------------------------------------------------------------------------
$card = $b->get_Card("create", array(
    "title" => lang("Iso9001_Scores.create-title"),
    "content" => $f,
    "header-back" => $back,
    "alert" => array(
        'type' => 'warning',
...
$info = $b->get_Card("card-view-service", array(
    "alert" => array(
        'type' => 'secondary',
        'title' => lang("Iso9001_Scores.how-is-it-rated-title"),
