 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iso9001\Views\Activities\Delete\index.php]
...
$data['model'] = model("App\Modules\Iso9001\Models\Iso9001_Activities");
$data['permissions'] = array('singular' => 'iso9001-activities-delete', "plural" => 'iso9001-activities-delete-all');
...
$form = $component . '\form';
$deny = $component . '\deny';
$tree = 'App\Modules\Iso9001\Views\Activities\Home\tree';
//[build]---------------------------------------------------------------------------------------------------------------
if ($plural || $authority) {
    if (!empty($submited)) {
