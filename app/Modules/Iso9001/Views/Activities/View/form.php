...
$back = "/iso9001/activities/list/{$r["category"]}";
//[Fields]-----------------------------------------------------------------------------
...
$f->fields["edit"] = $f->get_Button("edit", array("href" => "/iso9001/activities/edit/" . $oid, "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
//[Groups]-----------------------------------------------------------------------------
...
$card = $bootstrap->get_Card2("card-view-service", array(
    "header-title" => sprintf(lang("Iso9001_Activities.view-title"),$oid),
    "header-back" => $back,
    "content" => $f,
));
echo($card);
