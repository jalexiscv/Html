 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iso9001\Views\Components\Delete\index.php]
...
$data['model'] = model("App\Modules\Iso9001\Models\Iso9001_Components");
$data['permissions'] = array('singular' => 'iso9001-components-delete', "plural" => 'iso9001-components-delete-all');
...
$form = $component . '\form';
$deny = $component . '\deny';
$tree = 'App\Modules\Iso9001\Views\Components\Home\tree';
//[build]---------------------------------------------------------------------------------------------------------------
if ($plural || $authority) {
    if (!empty($submited)) {
