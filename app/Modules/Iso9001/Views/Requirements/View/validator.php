 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iso9001\Views\Requirements\Editor\validator.php]
...
* -----------------------------------------------------------------------------
*/
$f->set_ValidationRule("requirement", "trim|required");
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Requirements.view-errors-title"));
    $smarty->assign("message", lang("Requirements.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "iso9001/requirements-view-errors-message.mp3");
