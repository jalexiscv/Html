...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/iso9001/api/requirements/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('icon' => ICON_ADD, 'text' => lang('App.Create'), 'href' => '/iso9001/requirements/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'requirement' => array('text' => lang('App.Requirement'), 'class' => 'text-center', 'visible' => false),
        'parent' => array('text' => lang('App.Parent'), 'class' => 'text-center', 'visible' => false),
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang('Requirements.list-title'),
    "header-back" => $back,
    "content" => $table,
));
echo($card);
