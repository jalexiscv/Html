 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iso9001\Views\Requirements\List\index.php]
...
$data['permissions'] = array('singular' => false, "plural" => 'iso9001-requirements-view-all');
...
if ($plural) {
    if (!empty($submited)) {
        ...
        $json = array('breadcrumb' => view($breadcrumb, $data), 'main' => view($shortcuts, $data), 'right' => "");
    }
} else {
