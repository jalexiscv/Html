...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                                                    2024-02-12 00:36:57
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iso9001\Home\breadcrumb.php]
...
/** @var object $request */
generate_iso9001_permissions($module);
$bootstrap = service("bootstrap");
$card = $bootstrap->get_Card("card-view-Iso9001", array(
    "class" => "mb-3",
    "title" => lang("Iso9001.module") . "",
    "header-back" => "/",
    "image" => "/themes/assets/images/header/module-iso9001.svg",
    "image-class" => "img-fluid p-3",
    "content" => lang("Iso9001.intro-1")
));
echo($card);
