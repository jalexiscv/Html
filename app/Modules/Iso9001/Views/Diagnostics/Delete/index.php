...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-02-15 02:50:34
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iso9001\Views\Diagnostics\Delete\index.php]
...
$data['model'] = model("App\Modules\Iso9001\Models\Iso9001_Diagnostics");
$data['permissions'] = array('singular' => 'iso9001-diagnostics-delete', "plural" => 'iso9001-diagnostics-delete-all');
...
$form = $component . '\form';
$deny = $component . '\deny';
$tree = 'App\Modules\Iso9001\Views\Diagnostics\Home\tree';
//[build]---------------------------------------------------------------------------------------------------------------
if ($plural || $authority) {
    if (!empty($submited)) {
