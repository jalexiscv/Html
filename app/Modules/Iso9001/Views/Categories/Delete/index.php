 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iso9001\Views\Categories\Delete\index.php]
...
$data['model'] = model("App\Modules\Iso9001\Models\Iso9001_Categories");
$data['permissions'] = array('singular' => 'iso9001-categories-delete', "plural" => 'iso9001-categories-delete-all');
...
$form = $component . '\form';
$deny = $component . '\deny';
$tree = 'App\Modules\Iso9001\Views\Categories\Home\tree';
//[build]---------------------------------------------------------------------------------------------------------------
if ($plural || $authority) {
    if (!empty($submited)) {
