 ...
 **/
return [
    "iso9001-info-requirement" => "Este diagnóstico se generara para el requerimiento <u>%s</u>.",
    "iso9001-diagnostic-info-message" => "En el contexto de la gestión de la calidad y la norma ISO 9001:2015, el término diagnóstico se refiere a un proceso sistemático de evaluación y análisis destinado a comprender el estado actual de un aspecto específico del sistema de gestión de la calidad de una organización.",
    "iso9001-diagnostic-info-title" => "Definición de diagnóstico",
    // - Diagnostics fields
