 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Social\Views\Posts\List\json.php]
...
foreach ($list as $item) {
    ...
    $row["cover_visible"] = $item["cover_visible"];
    ...
    $row["views_initials"] = $item["views_initials"];
    $row["viewers"] = $item["viewers"];
    $row["likes"] = $item["likes"];
    $row["shares"] = $item["shares"];
    $row["comments"] = $item["comments"];
    $row["video"] = $item["video"];
    $row["source"] = $item["source"];
    $row["source_alias"] = $item["source_alias"];
