...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-03-30 18:04:59
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Social\Views\Posts\Creator\form.php]
...
$r["cover_visible"] = $f->get_Value("cover_visible");
...
$r["views"] = $f->get_Value("views");
$r["views_initials"] = $f->get_Value("views_initials");
$r["viewers"] = $f->get_Value("viewers");
$r["likes"] = $f->get_Value("likes");
$r["shares"] = $f->get_Value("shares");
$r["comments"] = $f->get_Value("comments");
$r["video"] = $f->get_Value("video");
$r["source"] = $f->get_Value("source");
$r["source_alias"] = $f->get_Value("source_alias");
$r["verified"] = $f->get_Value("verified");
...
$f->groups["g7"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["views"] . $f->fields["views_initials"])));
