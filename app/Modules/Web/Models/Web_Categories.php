...
class Web_Categories extends Model
{
    ...
    public function regenerate()
    {
        if (!$this->tableExists()) {
            ...
            $fields = [
                ...
                'hierarchy' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'associability' => ['type' => 'ENUM', 'constraint' => ['yes', 'not'], 'default' => 'not',],
     ...
     * @return array|false Los registros de la tabla o false si no hay resultados.
     */
