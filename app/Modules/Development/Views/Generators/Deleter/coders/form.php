...
$code .= "\$card = \$bootstrap->get_Card(\"delete-{\$oid}\", array(\n";
$code .= "\t\t \"class\" =>\"card-info\",\n";
$code .= "\t\t \"icon\" => ICON_WARNING,\n";
$code .= "\t\t \"title\" => sprintf(lang(\"{$ucf_module}_{$ucf_component}.delete-title\"),\$name),\n";
$code .= "\t\t \"text-class\" =>\"text-center\",\n";
$code .= "\t\t \"text\"=>sprintf(lang(\"{$ucf_module}_{$ucf_component}.delete-message\"),\$name),\n";
$code .= "\t\t \"content\" =>\$f,\n";
