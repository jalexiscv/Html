...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2023-10-12 13:41:38
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Helpdesk\Controllers\_Types.php]
 * █ ░█─── █──█ █──█ █▀▀ ░█▀▀█ ▀█▀ █─▀█ █─▀█ ▀▀█ Copyright 2023 - CloudEngine S.A.S., Inc. <admin@cgine.com>
 * █ ░█▄▄█ ▀▀▀▀ ▀▀▀─ ▀▀▀ ░█─░█ ▀▀▀ ▀▀▀▀ ▀▀▀▀ ▀▀▀ Para obtener información completa sobre derechos de autor y licencia,
 * █                                             consulte la LICENCIA archivo que se distribuyó con este código fuente.
 * █ ---------------------------------------------------------------------------------------------------------------------
...
class Types extends ModuleController
{
    ...
    //[Types]
    //$subroutes->add('types', 'Types::index');
    //$subroutes->add('types/home/(:any)', 'Types::home/$1');
    //$subroutes->add('types/list/(:any)', 'Types::list/$1');
    //$subroutes->add('types/create/(:any)', 'Types::create/$1');
    //$subroutes->add('types/view/(:any)/', 'Types::view/$1');
    //$subroutes->add('types/edit/(:any)/', 'Types::edit/$1');
    //$subroutes->add('types/delete/(:any)/', 'Types::delete/$1');
    //$subroutes->add('api/types/(:any)/(:any)/(:any)', 'Api::Types/$1/$2/$3');
    ...
    {
        $url = base_url('helpdesk/types/home/' . lpk());
