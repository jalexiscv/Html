...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2023-10-07 06:29:44
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Helpdesk\Views\Participants\Creator\index.php]
...
return [
    ...
    "placeholder_participants" => "participants",
    ...
    "help_participants" => "participants",
    "help_conversation" => "conversation",
    "help_user" => "user",
    "help_rol" => "rol",
