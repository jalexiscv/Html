...
$types = array(
    array("label" => "Contacto Directo", "value" => "Y"),
    array("label" => "Unidad", "value" => "N"),
);
//[Fields]-----------------------------------------------------------------------------
...
$f->fields["direct"] = $f->get_FieldSelect("direct", array("selected" => $r["direct"], "data" => $types, "proportion" => "col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12"));
...
//[Groups]-----------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["service"] . $f->fields["direct"])));
...
$card = $bootstrap->get_Card("create", array(
    "title" => lang("Services.edit-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
