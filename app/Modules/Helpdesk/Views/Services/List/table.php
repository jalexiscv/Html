...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2023-10-09 03:49:36
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Helpdesk\Views\Services\List\table.php]
...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/helpdesk/api/services/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('icon' => ICON_ADD, 'text' => lang('App.Create'), 'href' => '/helpdesk/services/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'service' => array('text' => lang('App.Service-Center'), 'class' => 'text-center'),
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang('Services.list-title'),
    "header-back" => $back,
    "content" => $table,
));
echo($card);
