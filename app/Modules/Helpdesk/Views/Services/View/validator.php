 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Helpdesk\Views\Services\Editor\validator.php]
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Services.view-errors-title"));
    $smarty->assign("message", lang("Services.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "helpdesk/services-view-errors-message.mp3");
