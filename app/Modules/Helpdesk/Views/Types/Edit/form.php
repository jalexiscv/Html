...
//[vars]----------------------------------------------------------------------------------------------------------------
$row = $model->where('type', $oid)->first();
...
$back = "/helpdesk/types/view/{$r["type"]}";
//[fields]----------------------------------------------------------------------------------------------------------------
...
$f->fields["service"] = $f->get_FieldText("service", array("value" => $r["service"], "proportion" => "col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12", "readonly" => true));
...
//[groups]----------------------------------------------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["type"] . $f->fields["service"])));
