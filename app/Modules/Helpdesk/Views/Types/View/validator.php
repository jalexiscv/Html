...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-03-20 15:50:53
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Helpdesk\Views\Types\Editor\validator.php]
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Types.view-errors-title"));
    $smarty->assign("message", lang("Types.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "helpdesk/types-view-errors-message.mp3");
