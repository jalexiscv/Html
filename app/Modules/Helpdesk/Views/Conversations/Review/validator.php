 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Helpdesk\Views\Conversations\Editor\validator.php]
...
* -----------------------------------------------------------------------------
*/
$f->set_ValidationRule("conversation", "trim|required");
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Conversations.view-errors-title"));
    $smarty->assign("message", lang("Conversations.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "helpdesk/conversations-view-errors-message.mp3");
