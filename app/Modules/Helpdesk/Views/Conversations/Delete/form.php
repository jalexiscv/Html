 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Helpdesk\Views\Conversations\Delete\form.php]
...
$r = $model->where('conversation', $oid)->first();
$name = urldecode($r["title"]);
$message = sprintf(lang("Conversations.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Conversations.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Conversations.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
