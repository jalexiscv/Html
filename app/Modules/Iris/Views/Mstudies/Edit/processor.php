...
$asuccess = "iris/mstudies-edit-success-message.mp3";
$anoexist = "iris/mstudies-edit-noexist-message.mp3";
//[build]---------------------------------------------------------------------------------------------------------------
if (is_array($row)) {
   $edit = $model->update($d['mstudy'],$d);
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Iris_Mstudies.edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Iris_Mstudies.edit-success-message"),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Iris_Mstudies.edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Iris_Mstudies.edit-noexist-message"),$d['mstudy']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
