...
$r["assessment"] = $f->get_Value("assessment",$row["assessment"]);
$r["image"] = $f->get_Value("image",$row["image"]);
$r["analysis_date"] = $f->get_Value("analysis_date",$row["analysis_date"]);
$r["ai_results"] = $f->get_Value("ai_results",$row["ai_results"]);
$r["confidence_score"] = $f->get_Value("confidence_score",$row["confidence_score"]);
$r["ai_recommendations"] = $f->get_Value("ai_recommendations",$row["ai_recommendations"]);
...
$card = $bootstrap->get_Card("create", array(
		 "title" => lang("Iris_Assessments.edit-title"),
		 "content" =>$f,
		 "header-back" =>$back
));
echo($card);
