...
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iris\Views\Assessments\Editor\validator.php]
...
//[Request]-----------------------------------------------------------------------------
//$f->set_ValidationRule("assessment","trim|required");
//$f->set_ValidationRule("image","trim|required");
//$f->set_ValidationRule("analysis_date","trim|required");
//$f->set_ValidationRule("ai_results","trim|required");
//$f->set_ValidationRule("confidence_score","trim|required");
//$f->set_ValidationRule("ai_recommendations","trim|required");
