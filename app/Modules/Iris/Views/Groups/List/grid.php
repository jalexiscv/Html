...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2025-11-21 10:45:47
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iris\Views\Groups\List\table.php]
 ...
 **/
//[models]--------------------------------------------------------------------------------------------------------------
$mgroups = model('App\Modules\Iris\Models\Iris_Groups');
//[vars]----------------------------------------------------------------------------------------------------------------
$back = "/iris";
...
$card = $bootstrap->get_Card2("card-grid", array(
    "header-title" => lang('Iris_Groups.list-title'),
    "header-back" => $back,
    "header-add" => "/iris/groups/create/" . lpk(),
    "alert" => array(
        "icon" => ICON_INFO,
        "type" => "info",
        "title" => lang('Iris_Groups.list-title'),
        "message" => lang('Iris_Groups.list-description')
    ),
    "content" => $bgrid,
));
echo($card);
