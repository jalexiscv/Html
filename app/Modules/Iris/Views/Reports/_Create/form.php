...
/**
* █ ---------------------------------------------------------------------------------------------------------------------
* █ ░FRAMEWORK                                  2025-04-10 06:52:03
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iris\Views\Reports\Creator\form.php]
...
**/
$r["report"] = $f->get_Value("report");
$r["study"] = $f->get_Value("study");
$r["professional"] = $f->get_Value("professional");
$r["validation_date"] = $f->get_Value("validation_date");
$r["final_diagnosis"] = $f->get_Value("final_diagnosis");
$r["observations"] = $f->get_Value("observations");
$r["is_validated"] = $f->get_Value("is_validated");
...
$f->groups["g3"]=$f->get_Group(array("legend"=>"","fields"=>($f->fields["is_validated"].)));
...
$card = $b->get_Card("create", array(
		 "title" => lang("Iris_Reports.create-title"),
		 "content" =>$f,
		 "header-back" =>$back
));
echo($card);
