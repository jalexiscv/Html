...
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iris\Views\Reports\Creator\validator.php]
...
//[Request]-----------------------------------------------------------------------------
//$f->set_ValidationRule("report","trim|required");
//$f->set_ValidationRule("study","trim|required");
//$f->set_ValidationRule("professional","trim|required");
//$f->set_ValidationRule("validation_date","trim|required");
//$f->set_ValidationRule("final_diagnosis","trim|required");
//$f->set_ValidationRule("observations","trim|required");
//$f->set_ValidationRule("is_validated","trim|required");
