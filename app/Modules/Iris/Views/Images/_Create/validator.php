...
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iris\Views\Images\Creator\validator.php]
...
//$f->set_ValidationRule("capture_date","trim|required");
//$f->set_ValidationRule("eye","trim|required");
//$f->set_ValidationRule("image_file","trim|required");
//$f->set_ValidationRule("image_quality","trim|required");
//$f->set_ValidationRule("operator_comments","trim|required");
