...
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iris\Views\Episodes\Creator\validator.php]
...
//$f->set_ValidationRule("start_date","trim|required");
//$f->set_ValidationRule("end_date","trim|required");
//$f->set_ValidationRule("reason_for_visit","trim|required");
//$f->set_ValidationRule("general_notes","trim|required");
