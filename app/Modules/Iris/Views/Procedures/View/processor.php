...
//$edit = $model->update($d);
    $c = $bootstrap->get_Card('warning', array(
        ...
        'title' => lang("Iris_Procedures.view-success-title"),
        'text' => lang("Iris_Procedures.view-success-message"),
        'footer-class' => 'text-center',
        'footer-continue' => base_url("/iris/procedures/view/{$d["procedure"]}/" . lpk()),
        'voice' => "iris/procedures-view-success-message.mp3",
    ));
} else {
    $c = $bootstrap->get_Card('success', array(
        ...
        'icon' => 'fa-duotone fa-triangle-exclamation',
        'text-class' => 'text-center',
        'title' => lang("Iris_Procedures.view-noexist-title"),
        'text' => lang("Iris_Procedures.view-noexist-message"),
        'footer-class' => 'text-center',
        'footer-continue' => base_url("/iris/procedures"),
        'voice' => "iris/procedures-view-noexist-message.mp3",
    ));
}
echo($c);
?>
