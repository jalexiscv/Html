 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iris\Views\Procedures\Editor\form.php]
...
//[models]--------------------------------------------------------------------------------------------------------------
//[vars]----------------------------------------------------------------------------------------------------------------
$row = $model->getProcedure($oid);
$r["procedure"] = $row["procedure"];
$r["code"] = $row["code"];
$r["name"] = $row["name"];
...
$back = "/iris/procedures/list/" . lpk();
//[Fields]-----------------------------------------------------------------------------
$f->fields["procedure"] = $f->get_FieldView("procedure", array("value" => $r["procedure"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->fields["edit"] = $f->get_Button("edit", array("href" => "/iris/procedures/edit/" . $oid, "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
//[Groups]-----------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["procedure"] . $f->fields["code"] . $f->fields["name"])));
...
$card = $bootstrap->get_Card2("card-view-service", array(
    "header-title" => lang("Iris_Procedures.view-title"),
    "header-back" => $back,
    "content" => $f,
));
echo($card);
