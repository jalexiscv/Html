...
$r["procedure"] = $f->get_Value("procedure", $row["procedure"]);
...
$f->fields["procedure"] = $f->get_FieldText("procedure", array("value" => $r["procedure"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "readonly" => true));
...
$card = $bootstrap->get_Card("create", array(
    "title" => lang("Iris_Procedures.edit-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
