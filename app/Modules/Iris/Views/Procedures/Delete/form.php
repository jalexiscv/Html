 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iris\Views\Procedures\Delete\form.php]
...
$r = $model->getProcedure($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Iris_Procedures.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Iris_Procedures.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Iris_Procedures.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
