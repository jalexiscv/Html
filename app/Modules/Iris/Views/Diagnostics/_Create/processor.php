...
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iris\Views\Diagnostics\Creator\processor.php]
...
$asuccess = "iris/diagnostics-create-success-message.mp3";
$aexist = "iris/diagnostics-create-exist-message.mp3";
if (is_array($row)) {
    $c= $bootstrap->get_Card("duplicate", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Iris_Diagnostics.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Iris_Diagnostics.create-duplicate-message"),
    ...
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Iris_Diagnostics.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Iris_Diagnostics.create-success-message"),$d['diagnostic']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" =>$asuccess,
    ));
