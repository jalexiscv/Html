...
$d = array(
    ...
    "result_ia" => $f->get_Value("result_ia"),
...
$c = $bootstrap->get_Card('warning', array(
				...
				'title' => lang("Iris_Diagnostics.view-success-title"),
				'text' => lang("Iris_Diagnostics.view-success-message"),
				'footer-class' => 'text-center',
				'footer-continue' => base_url("/iris/diagnostics/view/{$d["diagnostic"]}/".lpk()),
				'voice' => "iris/diagnostics-view-success-message.mp3",
		));
}else {
$c = $bootstrap->get_Card('success', array(
				...
				'icon' => 'fa-duotone fa-triangle-exclamation',
				'text-class' => 'text-center',
				'title' => lang("Iris_Diagnostics.view-noexist-title"),
				'text' => lang("Iris_Diagnostics.view-noexist-message"),
				'footer-class' => 'text-center',
				'footer-continue' => base_url("/iris/diagnostics"),
				'voice' => "iris/diagnostics-view-noexist-message.mp3",
		));
}
echo($c);
?>
