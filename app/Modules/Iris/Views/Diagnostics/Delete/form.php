 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iris\Views\Diagnostics\Delete\form.php]
...
$r = $model->getDiagnostic($oid);
$name = urldecode($r["diagnostic"]);
$message = sprintf(lang("Iris_Diagnostics.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Iris_Diagnostics.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Iris_Diagnostics.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
