...
/**
* █ ---------------------------------------------------------------------------------------------------------------------
* █ ░FRAMEWORK                                  2025-09-15 06:10:23
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iris\Views\Diagnostics\List\table.php]
...
$bgrid->set_Headers(array(
		array("content" => "#", "class" => "text-center	align-middle"),
		 //array("content" => lang("App.diagnostic"), "class" => "text-center	align-middle"),
...
$card = $bootstrap->get_Card2("card-grid", array(
		...
		"alert" => array("icon" => ICON_INFO, "type" => "info", "title" => lang('Diagnostics.list-title'), "message" => lang('Diagnostics.list-description')),
		"content" => $bgrid,
));
echo($card);
?>
