...
//[build]--------------------------------------------------------------------------------------------------------------
$rows = $mepisodes->get_List($limit, $offset, $oid);
...
$bgrid->set_Headers(array(
    ...
    array("content" => lang("Iris.Details"), "class" => "text-center	align-middle"),
...
$bgrid->set_Buttons(
    array(
        $bootstrap->get_Link("btn-bill", array("size" => "sm", "icon" => ICON_PLUS, "text" => "Nuevo Episodio", "title" => lang("App.New"), "href" => "/iris/episodes/create/{$oid}", "target" => "_self")),
    )
);
...
$code = "<div class=\"row title m-0 p-0\"><div class=\"col-12 m-0 p-0 \"><h2 class=\"mx-0 my-3 form-header\">Historia Clinica</h2></div></div>\n";
//[build]---------------------------------------------------------------------------------------------------------------
echo($code);
echo($content);
?>