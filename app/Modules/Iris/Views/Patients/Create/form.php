...
//[vars]----------------------------------------------------------------------------------------------------------------
$r["patient"] = $f->get_Value("patient", pk());
$r["fhir_id"] = $f->get_Value("fhir_id", "FHIR-" . pk());
$r["active"] = $f->get_Value("active");
$r["document_type"] = $f->get_Value("document_type");
$r["document_number"] = $f->get_Value("document_number");
$r["document_issued_place"] = $f->get_Value("document_issued_place");
$r["first_name"] = $f->get_Value("first_name");
$r["middle_name"] = $f->get_Value("middle_name");
...
$r["primary_phone"] = $f->get_Value("primary_phone");
$r["secondary_phone"] = $f->get_Value("secondary_phone");
$r["email"] = $f->get_Value("email");
$r["full_address"] = $f->get_Value("full_address");
$r["neighborhood"] = $f->get_Value("neighborhood");
$r["city"] = $f->get_Value("city");
$r["state"] = $f->get_Value("state");
$r["postal_code"] = $f->get_Value("postal_code");
$r["country"] = $f->get_Value("country");
$r["residence_area"] = $f->get_Value("residence_area");
$r["socioeconomic_stratum"] = $f->get_Value("socioeconomic_stratum");
$r["emergency_contact_name"] = $f->get_Value("emergency_contact_name");
$r["emergency_contact_relationship"] = $f->get_Value("emergency_contact_relationship");
$r["emergency_contact_phone"] = $f->get_Value("emergency_contact_phone");
$r["health_insurance"] = $f->get_Value("health_insurance");
$r["health_regime"] = $f->get_Value("health_regime");
$r["affiliation_type"] = $f->get_Value("affiliation_type");
$r["ethnicity"] = $f->get_Value("ethnicity");
$r["special_population"] = $f->get_Value("special_population");
$r["has_diabetes"] = $f->get_Value("has_diabetes");
$r["has_hypertension"] = $f->get_Value("has_hypertension");
$r["family_history_glaucoma"] = $f->get_Value("family_history_glaucoma");
$r["family_history_diabetes"] = $f->get_Value("family_history_diabetes");
$r["family_history_retinopathy"] = $f->get_Value("family_history_retinopathy");
$r["previous_eye_surgeries"] = $f->get_Value("previous_eye_surgeries");
$r["blood_type"] = $f->get_Value("blood_type");
$r["allergies"] = $f->get_Value("allergies");
$r["current_medications"] = $f->get_Value("current_medications");
$r["primary_language"] = $f->get_Value("primary_language");
$r["data_consent"] = $f->get_Value("data_consent");
$r["accepts_communications"] = $f->get_Value("accepts_communications");
$r["profile_photo"] = $f->get_Value("profile_photo");
...
$card = $b->get_Card2("create", array(
    "header-title" => lang("Iris_Patients.create-title"),
		 "content" =>$f,
		 "header-back" =>$back
));
echo($card);
