 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iris\Views\Modalities\Delete\form.php]
...
$r = $model->getModality($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Iris_Modalities.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Iris_Modalities.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Iris_Modalities.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
