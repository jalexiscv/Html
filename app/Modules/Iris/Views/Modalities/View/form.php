 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iris\Views\Modalities\Editor\form.php]
...
$f->fields["edit"] = $f->get_Button("edit", array("href" => "/iris/modalities/edit/" . $oid, "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
//[Groups]-----------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["modality"] . $f->fields["code"] . $f->fields["name"])));
$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["description"] . $f->fields["is_active"] . $f->fields["created_by"])));
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang("Iris_Modalities.view-title"),
    "header-back" => $back,
    "content" => $f,
));
echo($card);
