...
/**
* █ ---------------------------------------------------------------------------------------------------------------------
* █ ░FRAMEWORK                                  2025-04-10 06:51:08
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iris\Views\Assessments\Creator\index.php]
...
return [
	...
	"label_image"=>"image",
	"label_analysis_date"=>"analysis_date",
	"label_ai_results"=>"ai_results",
	"label_confidence_score"=>"confidence_score",
	"label_ai_recommendations"=>"ai_recommendations",
	"label_author"=>"author",
	...
	"placeholder_analysis_date"=>"analysis_date",
	"placeholder_ai_results"=>"ai_results",
	"placeholder_confidence_score"=>"confidence_score",
	"placeholder_ai_recommendations"=>"ai_recommendations",
	"placeholder_author"=>"author",
	"placeholder_created_at"=>"created_at",
	"placeholder_updated_at"=>"updated_at",
	"placeholder_deleted_at"=>"deleted_at",
	"help_assessment"=>"assessment",
	"help_image"=>"image",
	"help_analysis_date"=>"analysis_date",
	"help_ai_results"=>"ai_results",
	"help_confidence_score"=>"confidence_score",
	"help_ai_recommendations"=>"ai_recommendations",
	"help_author"=>"author",
