...
/**
* █ ---------------------------------------------------------------------------------------------------------------------
* █ ░FRAMEWORK                                  2025-04-10 06:34:05
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Iris\Views\Image\Creator\index.php]
...
return [
	...
	"label_image"=>"image",
	"label_study"=>"studies",
	"label_capture_date"=>"capture_date",
	"label_eye"=>"eye",
	"label_image_file"=>"image_file",
	"label_image_quality"=>"image_quality",
	"label_operator_comments"=>"operator_comments",
	"label_author"=>"author",
	"label_created_at"=>"created_at",
	"label_updated_at"=>"updated_at",
	"label_deleted_at"=>"deleted_at",
	"placeholder_image"=>"image",
	"placeholder_study"=>"studies",
	"placeholder_capture_date"=>"capture_date",
	"placeholder_eye"=>"eye",
	"placeholder_image_file"=>"image_file",
	"placeholder_image_quality"=>"image_quality",
	"placeholder_operator_comments"=>"operator_comments",
	...
	"help_image"=>"image",
	"help_study"=>"studies",
	"help_capture_date"=>"capture_date",
	"help_eye"=>"eye",
	"help_image_file"=>"image_file",
	"help_image_quality"=>"image_quality",
	"help_operator_comments"=>"operator_comments",
	"help_author"=>"author",
