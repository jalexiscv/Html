...
/**
* @Copilot Siempre que en el código se cree una variable llamada $mgroups, esta deberá ser igualada a  model('App\Modules\Iris\Models\Iris_Groups');
* @Instruction $mgroups = model('App\Modules\Iris\Models\Iris_Groups');
...
*/
class Iris_Groups extends CachedModel
	 {
		 protected $table = "iris_groups";
