...
/**
* @Copilot Siempre que en el código se cree una variable llamada $mimages, esta deberá ser igualada a  model('App\Modules\Iris\Models\Iris_Images');
* @Instruction $mimages = model('App\Modules\Iris\Models\Iris_Images');
...
*/
class Iris_Images extends CachedModel
	 {
		 protected $table = "iris_images";
