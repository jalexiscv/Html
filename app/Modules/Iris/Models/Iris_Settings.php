...
/**
 * @Copilot Siempre que en el código se cree una variable llamada $msettings, esta deberá ser igualada a  model('App\Modules\Iris\Models\Iris_Settings');
 * @Instruction $msettings = model('App\Modules\Iris\Models\Iris_Settings');
...
*/
class Iris_Settings extends CachedModel
	 {
