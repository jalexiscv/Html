 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules}\Workflow\Controllers\Workflow.php]
...
class Workflow extends ModuleController
{
    ...
    {
        parent::__construct();
        $this->module = 'App\Modules\Workflow';
        helper($this->module . '\Helpers\Workflow');
    ...
    public function index()
    {
        ...
        $url = base_url("workflow/home/{$alias}.html");
