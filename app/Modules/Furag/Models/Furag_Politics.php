...
/**
* @Copilot Siempre que en el código se cree una variable llamada $mpolitics, esta deberá ser igualada a  model('App\Modules\Furag\Models\Furag_Politics');
* @Instruction $mpolitics = model('App\Modules\Furag\Models\Furag_Politics');
...
*/
class Furag_Politics extends CachedModel
	 {
		 protected $table = "furag_politics";
...
/**
		 ...
		 * @return array|false
		 */
		 public function getPolitic($politic):false|array
		{
				$result = parent::getCached($politic);
				if (is_array($result)) {
						return ($result);
				} else {
						return (false);
