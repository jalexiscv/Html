...
/**
* @Copilot Siempre que en el código se cree una variable llamada $mquestions, esta deberá ser igualada a  model('App\Modules\Furag\Models\Furag_Questions');
* @Instruction $mquestions = model('App\Modules\Furag\Models\Furag_Questions');
...
*/
class Furag_Questions extends CachedModel
	 {
		 protected $table = "furag_questions";
...
/**
		 ...
		 * @return array|false
		 */
		 public function getQuestion($question):false|array
		{
				$result = parent::getCached($question);
				if (is_array($result)) {
						return ($result);
				} else {
						return (false);
