...
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Furag\Views\Questions\Editor\validator.php]
...
//[Request]-----------------------------------------------------------------------------
$f->set_ValidationRule("question","trim|required");
$f->set_ValidationRule("politic","trim|required");
$f->set_ValidationRule("reference","trim|required");
$f->set_ValidationRule("year","trim|required|integer");
$f->set_ValidationRule("statement","trim|required");
