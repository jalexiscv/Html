...
//[groups]----------------------------------------------------------------------------------------------------------------
$f->groups["g1"]=$f->get_Group(array("legend"=>"","fields"=>($f->fields["politic"].$f->fields["dimension"].$f->fields["reference"])));
...
$card = $bootstrap->get_Card2("create", array(
		 "header-title" => lang("Furag_Politics.edit-title"),
		 "content" =>$f,
		 "header-back" =>$back
));
echo($card);
