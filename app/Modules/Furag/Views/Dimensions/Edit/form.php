...
$r["deleted-at"] = $f->get_Value("deleted-at",$row["deleted-at"]);
...
$f->fields["deleted-at"] = $f->get_FieldText("deleted-at", array("value" => $r["deleted-at"],"proportion"=>"col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$card = $bootstrap->get_Card("create", array(
		 "title" => lang("Furag_Dimensions.edit-title"),
		 "content" =>$f,
		 "header-back" =>$back
));
echo($card);
