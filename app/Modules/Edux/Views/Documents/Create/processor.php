...
$asuccess = "edux/documents-create-success-message.mp3";
$aexist = "edux/documents-create-exist-message.mp3";
if (is_array($row)) {
    $c = $card = $bootstrap->get_Card("duplicate", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Documents.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Documents.create-duplicate-message"),
    ...
    $c = $card = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Documents.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Documents.create-success-message"), $d['document']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
