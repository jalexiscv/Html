...
$r = $model->where('document', $oid)->first();
$name = urldecode($r["name"]);
$message = sprintf(lang("Documents.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Documents.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Documents.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
