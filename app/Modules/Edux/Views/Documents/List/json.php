...
//[Asignations]---------------------------------------------------------------------------------------------------------
$data = array();
$component = '/edux/documents';
foreach ($list as $item) {
    //[Buttons]---------------------------------------------------------------------------------------------------------
    $viewer = "{$component}/view/{$item["document"]}";
    $editor = "{$component}/edit/{$item["document"]}";
    $deleter = "{$component}/delete/{$item["document"]}";
    ...
    $row["appendix"] = $item["appendix"];
    $row["reference"] = $item["reference"];
    $row["legal"] = $item["legal"];
