...
* -----------------------------------------------------------------------------
*/
$f->set_ValidationRule("document", "trim|required");
$f->set_ValidationRule("appendix", "trim|required");
$f->set_ValidationRule("reference", "trim|required");
$f->set_ValidationRule("legal", "trim|required");
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Documents.view-errors-title"));
    $smarty->assign("message", lang("Documents.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "edux/documents-view-errors-message.mp3");
