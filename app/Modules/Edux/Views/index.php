...
$version = round(($server->get_DirectorySize(APPPATH . 'Modules/Edux') / 102400), 6);
$data = $parent->get_Array();
$rviews = array(
    "default" => "{$views}\E404\index",
    "edux-denied" => "{$views}\Denied\index",
    "edux-home" => "{$views}\Home\index",
    "edux-men-home" => "{$views}\Men\Home\index",
    //[Documents]-------------------------------------------------------------------------------------------------------
    "edux-documents-home" => "$views\Documents\Home\index",
    "edux-documents-list" => "$views\Documents\List\index",
    "edux-documents-view" => "$views\Documents\View\index",
    "edux-documents-create" => "$views\Documents\Create\index",
    "edux-documents-edit" => "$views\Documents\Edit\index",
    "edux-documents-delete" => "$views\Documents\Delete\index",
    //[others]----------------------------------------------------------------------------------------------------------
);
