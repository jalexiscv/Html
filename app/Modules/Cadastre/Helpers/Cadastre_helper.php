...
if (!function_exists("generate_cadastre_permissions")) {
     ...
     */
    function generate_cadastre_permissions()
    {
        $permissions = array(
            "cadastre-access",
            /** Tasas * */
...
if (!function_exists("get_cadastre_sidebar")) {
    function get_cadastre_sidebar($active_url = false)
    {
        ...
        $options = array(
            ...
            "sense" => array("text" => "Censo", "href" => "/cadastre/sense/home/" . lpk(), "icon" => "fa-regular fa-clipboard-question", "permission" => "cadastre-access"),
            "tools" => array("text" => "Herramientas", "href" => "/cadastre/tools/home/" . lpk(), "icon" => ICON_TOOLS, "permission" => "cadastre-access"),
        );
    ...
    function get_cadastre_sidebarOLD($active_url = false)
    {
        $lpk = safe_strtolower(pk());
        $options = array(
            "home" => array("text" => lang("App.Home"), "href" => "/cadastre/", "svg" => "home.svg"),
...
if (!function_exists("get_cadastre_messenger_users")) {
    /**
     ...
     */
    function get_cadastre_messenger_users($user)
    {
...
if (!function_exists("get_cadastre_copyright")) {

    function get_cadastre_copyright()
    {
        $gridter = "";
