...
//[Fields]-----------------------------------------------------------------------------
$f->fields["customer"] = $f->get_FieldText("customer", array("value" => $r["customer"], "proportion" => "col-xl-3 col-lg-3 col-md-3 col-sm-6 col-6", "readonly" => true));
$f->fields["registration"] = $f->get_FieldText("registration", array("value" => $r["registration"], "proportion" => "col-xl-3 col-lg-3 col-md-3 col-sm-6 col-6", "readonly" => true));
$f->fields["date"] = $f->get_FieldText("date", array("value" => $r["date"], "proportion" => "col-xl-3 col-lg-3 col-md-3 col-sm-6 col-6", "readonly" => true));
$f->fields["time"] = $f->get_FieldText("time", array("value" => $r["time"], "proportion" => "col-xl-3 col-lg-3 col-md-3 col-sm-6 col-6", "readonly" => true));
