...
$f->fields["names"] = $f->get_FieldText("names", array("value" => $r["names"], "proportion" => "col-12"));
...
$f->fields["longitude"] = $f->get_FieldText("longitude", array("value" => $r["longitude"], "proportion" => "col-6"));
$f->fields["latitude"] = $f->get_FieldText("latitude", array("value" => $r["latitude"], "proportion" => "col-6"));
...
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["names"])));
$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["address"])));
...
$f->groups["g8"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["latitude"] . $f->fields["longitude"])));
//[Buttons]-----------------------------------------------------------------------------
    ...
    $(document).ready(function () {
        if ("geolocation" in navigator) {
            navigator.geolocation.getCurrentPosition((position) => {
                ...
                document.getElementById('<?php echo($f->get_FieldId('latitude'));?>').value = latitude;
                document.getElementById('<?php echo($f->get_FieldId('longitude'));?>').value = longitude;
            ...
            alert("No se puede acceder a la ubicación del dispositivo.");
        }
    });
</script>
