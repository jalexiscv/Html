 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cadastre\Views\Customers\List\json.php]
...
//[Query]---------------------------------------------------------------------------------------------------------------
$list = $mcustomers->get_List($limit, $offset, $search);
$recordsTotal = $mcustomers->get_CountAllResults($search);

//$sql=$mcustomers->getLastQuery()->getQuery();
//[Asignations]---------------------------------------------------------------------------------------------------------
$data = array();
$component = '/cadastre/customers';
foreach ($list as $item) {
    //[Buttons]---------------------------------------------------------------------------------------------------------
    $viewer = "{$component}/view/{$item["customer"]}";
    $editor = "{$component}/edit/{$item["customer"]}";
    $deleter = "{$component}/delete/{$item["customer"]}";
    ...
    //[Fields]----------------------------------------------------------------------------------------------------------
    //$profile = $mprofiles->get_LastProfile($item["customer"]);
    $row["fullname"] = $item["names"];
