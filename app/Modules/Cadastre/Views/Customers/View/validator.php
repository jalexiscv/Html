...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Customers.view-errors-title"));
    $smarty->assign("message", lang("Customers.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "cadastre/customers-view-errors-message.mp3");
