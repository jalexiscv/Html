...
$continue = "/cadastre/resources/list/{$resource["title"]}/";
$edit = "/cadastre/resources/edit/{$resource["resource"]}/";
$asuccess = "cadastre/resources-edit-success-message.mp3";
$file = $request->getFile($f->get_fieldId("file"));
unset($resource['type']);
unset($resource['file']);
//[Processor]-----------------------------------------------------------------------------------------------------------
$path = "/storages/" . md5($server::get_FullName()) . "/cadastre/{$resource['resource']}";
