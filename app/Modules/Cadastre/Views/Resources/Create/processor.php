...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Cadastre\Views\Resources\Creator\processor.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$l["back"] = "/cadastre/resources/list/" . lpk();
$l["edit"] = "/cadastre/resources/edit/{$d["resource"]}";
if (isset($row["resource"])) {
    ...
    $smarty->assign("voice", "cadastre/resources-create-duplicate-message.mp3");
    $c = $smarty->view('alerts/card/warning.tpl');
} else {
    //[Storage]-----------------------------------------------------------------------------------------------------------
    $file = $request->getFile($f->get_fieldId("file"));
    $path = "/storages/" . md5($server::get_FullName()) . "/cadastre/{$d['resource']}";
    ...
    $smarty->assign("continue", $l["back"]);
    $smarty->assign("voice", "cadastre/resources-create-success-message.mp3");
