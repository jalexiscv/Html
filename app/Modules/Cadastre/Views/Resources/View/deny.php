...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Resources.view-denied-title"));
    $smarty->assign("message", lang("Resources.view-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "cadastre/resources-view-denied-message.mp3");
