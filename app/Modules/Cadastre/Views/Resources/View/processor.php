...
if (isset($row["resource"])) {
    ...
    $smarty->assign("edit", base_url("/cadastre/resources/edit/{$d['resource']}/" . lpk()));
    $smarty->assign("continue", base_url("/cadastre/resources/view/{$d["resource"]}/" . lpk()));
    $smarty->assign("voice", "cadastre/resources-view-success-message.mp3");
    ...
    $smarty->assign("continue", base_url("/cadastre/resources"));
    $smarty->assign("voice", "cadastre/resources-view-noexist-message.mp3");
