...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Networks.view-errors-title"));
    $smarty->assign("message", lang("Networks.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "cadastre/networks-view-errors-message.mp3");
