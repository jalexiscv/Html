...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Networks.delete-errors-title"));
    $cerrors->assign("message", lang("Networks.delete-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "cadastre/networks-delete-errors-message.mp3");
