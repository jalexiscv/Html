...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Cadastre\Views\Networks\Delete\index.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$data['model'] = model("App\Modules\Cadastre\Models\Cadastre_Networks");
$data['permissions'] = array('singular' => 'cadastre-networks-delete', "plural" => 'cadastre-networks-delete-all');
