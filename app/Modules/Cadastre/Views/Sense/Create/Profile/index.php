...
if (!empty($profile)) {
    ...
    if (!isset($row['profile'])) {
        $row = $mcp->where('customer', $oid)->orderBy('profile', 'DESC')->first();
    }
} else {
    $row = $mcp->where('customer', $oid)->orderBy('profile', 'DESC')->first();
}
...
$r["citizenship_card"] = $f->get_Value("citizenship_card", $row["citizenship_card"]);
...
$r["realestate_registration"] = $f->get_Value("realestate_registration", $row["realestate_registration"]);
$r["attachment"] = $f->get_Value("attachment", "");
$r["pin"] = $f->get_Value("pin", "");
...
$f->fields["citizenship_card"] = $f->get_FieldText("citizenship_card", array("value" => $r["citizenship_card"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->fields["realestate_registration"] = $f->get_FieldText("realestate_registration", array("value" => $r["realestate_registration"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["attachment"] = $f->get_FieldFile("attachment", array("value" => $r["attachment"], "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12"));
$f->fields["pin"] = $f->get_FieldText("pin", array("value" => $r["pin"], "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12"));
...
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["citizenship_card"] . $f->fields["firstname"] . $f->fields["lastname"])));
$f->groups["g5"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["phone"] . $f->fields["email"] . $f->fields["realestate_registration"])));
$f->groups["g6"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["attachment"] . $f->fields["pin"])));
//[Buttons]-----------------------------------------------------------------------------
