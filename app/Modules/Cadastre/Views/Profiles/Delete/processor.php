...
$vsuccess = "cadastre/profiles-delete-success-message.mp3";
$vnoexist = "cadastre/profiles-delete-noexist-message.mp3";
/* Build */
if (isset($row["profile"])) {
    ...
    $c = $bootstrap->get_Card("duplicate", array(
        ...
        "title" => lang("Profiles.delete-success-title"),
        "text-class" => "text-center",
        "text" => lang("Profiles.delete-success-message"),
    ...
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Profiles.delete-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Profiles.delete-noexist-message"), $d['profile']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $vnoexist,
    ));
