 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cadastre\Views\Profiles\Delete\form.php]
...
$message = sprintf(lang("Profiles.delete-message"), $name);
...
$smarty->assign("header", sprintf(lang("Profiles.delete-title"), $name));
$smarty->assign("header_back", $back);
$smarty->assign("message", sprintf(lang("Profiles.delete-message"), $name));
$smarty->assign("form", $f);
$smarty->assign("continue", null);
$smarty->assign("voice", "cadastre/profiles-delete-errors-message.mp3");
