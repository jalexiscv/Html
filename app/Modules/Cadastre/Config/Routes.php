 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Cadastre\Config\Routes.php]
...
$mdm = model("App\Modules\Cadastre\Models\Cadastre_Modules");
$mdcxm = model("App\Modules\Cadastre\Models\Cadastre_Clients_Modules");
$module = 'cadastre';
...
if ($cxm == "authorized") {
    $routes->group($module,
        ['namespace' => $namespace],
        function ($subroutes) {
            $subroutes->add('/', 'Cadastre::index');
            $subroutes->add('/home', 'Cadastre::index');
            $subroutes->add('home/(:any)', 'Cadastre::home/$1');
    ...
    $routes->group($module,
        ['namespace' => $namespace],
        function ($subroutes) {
            $subroutes->add('(:any)', 'Cadastre::denied');
        }
    );
}
?>