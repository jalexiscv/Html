...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Screens\Views\Networks\Creator\processor.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$l["back"] = "/Screens/networks/list/" . lpk();
$l["edit"] = "/Screens/networks/edit/{$d["network"]}";
if (isset($row["network"])) {
    ...
    $smarty->assign("voice", "Screens/networks-create-duplicate-message.mp3");
    ...
    $smarty->assign("continue", $l["back"]);
    $smarty->assign("voice", "Screens/networks-create-success-message.mp3");
