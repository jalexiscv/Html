...
$continue = "/Screens/networks/list/{$d["reference"]}/";
$edit = "/Screens/networks/edit/{$d["network"]}/";
$asuccess = "Screens/networks-edit-success-message.mp3";
$anoexist = "Screens/networks-edit-noexist-message.mp3";
//[Build]-----------------------------------------------------------------------------
