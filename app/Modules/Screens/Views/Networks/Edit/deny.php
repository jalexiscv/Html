...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Screens\Views\Networks\Editor\deny.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$continue = "/Screens/networks/list/" . lpk();
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Networks.edit-denied-title"));
    $smarty->assign("message", lang("Networks.edit-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "Screens/networks-edit-denied-message.mp3");
