...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\Screens\Views\Networks\List\deny.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$continue = "/Screens/resources/home/" . pk();
if ($authentication->get_LoggedIn()) {
    ...
    $smarty->assign("voice", "Screens/networks-list-denied-message.mp3");
