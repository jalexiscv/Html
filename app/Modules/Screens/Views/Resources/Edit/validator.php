...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Resources.edit-errors-title"));
    $cerrors->assign("message", lang("Resources.edit-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "Screens/resources-edit-errors-message.mp3");
