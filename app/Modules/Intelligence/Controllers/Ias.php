...
class Ias extends ModuleController
{
    ...
    public function view(string $oid)
    {
        ...
        $this->component = $this->views . '\Ias\View';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function list(string $rnd)
    {
        ...
        $this->component = $this->views . '\Ias\List';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function create(string $rnd)
    {
        ...
        $this->component = $this->views . '\Ias\Create';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function edit(string $oid)
    {
        ...
        $this->component = $this->views . '\Ias\Edit';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function delete(string $oid)
    {
        ...
        $this->component = $this->views . '\Ias\Delete';
        return (view($this->viewer, $this->get_Array()));
    }
