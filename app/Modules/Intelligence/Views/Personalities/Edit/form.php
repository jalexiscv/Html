...
//[fields]----------------------------------------------------------------------------------------------------------------
$f->fields["ia"] = $f->get_FieldText("ia", array("value" => $r["ia"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "readonly" => true));
...
$f->fields["prompt"] = $f->get_FieldCode("prompt", array("value" => $r["prompt"], "proportion" => "col-12"));
...
$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["identification"] . $f->fields["user"])));
