...
//[vars]----------------------------------------------------------------------------------------------------------------
$row = $model->get_Ias($oid);
$r["ia"] = $f->get_Value("ia", $row["ia"]);
$r["tech"] = $f->get_Value("tech", $row["tech"]);
$r["name"] = $f->get_Value("name", $row["name"]);
$r["description"] = $f->get_Value("description", $row["description"]);
$r["prompt"] = $f->get_Value("prompt", $row["prompt"]);
...
//[fields]----------------------------------------------------------------------------------------------------------------
$f->fields["ia"] = $f->get_FieldText("ia", array("value" => $r["ia"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["tech"] = $f->get_FieldText("tech", array("value" => $r["tech"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->fields["prompt"] = $f->get_FieldText("prompt", array("value" => $r["prompt"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["description"] . $f->fields["prompt"] . $f->fields["user"])));
$f->groups["g3"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["identification"] . $f->fields["author"] . $f->fields["created_at"])));
