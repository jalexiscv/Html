 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Application\Views\Ias\Creator\form.php]
...
//[vars]----------------------------------------------------------------------------------------------------------------
$r["ia"] = $f->get_Value("ia");
$r["tech"] = $f->get_Value("tech");
$r["name"] = $f->get_Value("name");
$r["description"] = $f->get_Value("description");
$r["prompt"] = $f->get_Value("prompt");
$r["user"] = $f->get_Value("user");
$r["identification"] = $f->get_Value("identification");
...
$f->groups["g3"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["identification"] .)));
