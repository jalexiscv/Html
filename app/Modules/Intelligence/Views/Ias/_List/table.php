...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-25 18:52:10
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Application\Views\Ias\List\table.php]
...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/application/api/ias/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('icon' => ICON_ADD, 'text' => lang('App.Create'), 'href' => '/application/ias/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'ia' => array('text' => lang('App.ia'), 'class' => 'text-center'),
        'tech' => array('text' => lang('App.tech'), 'class' => 'text-center'),
        'name' => array('text' => lang('App.name'), 'class' => 'text-center'),
        'description' => array('text' => lang('App.description'), 'class' => 'text-center'),
        'prompt' => array('text' => lang('App.prompt'), 'class' => 'text-center'),
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang('Ias.list-title'),
    "header-back" => $back,
    "alert" => array("icon" => ICON_INFO, "type" => "info", "title" => lang('Ias.list-title'), "message" => lang('Ias.list-description')),
    "content" => $table,
));
echo($card);
?>
