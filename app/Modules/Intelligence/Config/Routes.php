...
if (strpos($dirName, '_') === false) {
    ...
    if ($cxm == "authorized") {
        $routes->group($module,
            ['namespace' => $namespace],
            function ($subroutes) {
                $subroutes->add('/', 'Intelligence::index');
                $subroutes->add('/home', 'Intelligence::index');
                $subroutes->add('home/(:any)', 'Intelligence::home/$1');
        ...
        $routes->group($module,
            ['namespace' => $namespace],
            function ($subroutes) {
                $subroutes->add('/', 'Intelligence::denied');
                $subroutes->add('(:any)', 'Intelligence::denied');
            }
        );
    }
}
