...
/**
 * Ejemplo: $minstructions = model('App\Modules\Intelligence\Models\Intelligence_Instructions');
 ...
 */
class Intelligence_Instructions extends CachedModel
{
    protected $table = "application_ias_instructions";
    protected $primaryKey = "instruction";
     ...
     * @return array|false
     */
    public function get_Instruction($instruction): false|array
    {
        $result = parent::get_Cached($instruction);
        if (is_array($result)) {
            return ($result);
        } else {
            return (false);
