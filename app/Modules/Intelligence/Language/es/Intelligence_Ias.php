...
return [
    ...
    'list-personalities-title' => 'Lista de personalidades',
    // - Ias fields
    "label_ia" => "Código de la IA",
    "label_tech" => "Tecnología de generacion",
    "label_name" => "Nombre Visible",
    "label_description" => "Descripción",
    "label_prompt" => "Personalidad",
    "label_user" => "user",
    "label_identification" => "Cedula o identificación del usuario",
    "label_author" => "author",
    "label_created_at" => "created_at",
    "label_updated_at" => "updated_at",
    "label_deleted_at" => "deleted_at",
    "placeholder_ia" => "ia",
    "placeholder_tech" => "tech",
    ...
    "help_prompt" => "prompt",
    "help_user" => "user",
    "help_identification" => "identification",
    "help_author" => "author",
