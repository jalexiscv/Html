...
class C4isr_Identifications extends Model
{
    protected $table = "c4isr_identifications";
    ...
    public function regenerate()
    {
        if (!$this->tableExists($this->table)) {
            ...
            $fields = [
                'identification' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'profile' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'country' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'type' => ['type' => 'VARCHAR', 'constraint' => 3, 'null' => FALSE],
