...
class C4isr_Breaches extends Model
{
    protected $table = "c4isr_breaches";
    ...
    public function regenerate()
    {
        if (!$this->tableExists($this->table)) {
            ...
            $fields = [
                ...
                'domain' => ['type' => 'VARCHAR', 'constraint' => 254, 'null' => FALSE],
                ...
                'hacker' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
