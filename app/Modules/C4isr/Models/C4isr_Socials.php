...
class C4isr_Socials extends Model
{
    protected $table = "c4isr_socials";
    protected $primaryKey = "social";
    ...
    public function regenerate()
    {
        if (!$this->tableExists($this->table)) {
            ...
            $fields = [
                'social' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'network' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'profile' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'sid' => ['type' => 'VARCHAR', 'constraint' => 128, 'null' => TRUE],
                'alias' => ['type' => 'VARCHAR', 'constraint' => 128, 'null' => TRUE],
                'firstname' => ['type' => 'VARCHAR', 'constraint' => 128, 'null' => TRUE],
                'lastname' => ['type' => 'VARCHAR', 'constraint' => 254, 'null' => TRUE],
                'married' => ['type' => 'CHAR', 'null' => TRUE],
                'religion' => ['type' => 'CHAR', 'null' => TRUE],
