...
class C4isr_Vulnerabilities extends Model
{
    protected $table = "c4isr_vulnerabilities";
    protected $primaryKey = "vulnerability";
    ...
    public function regenerate()
    {
        if (!$this->tableExists($this->table)) {
            ...
            $fields = [
                'vulnerability' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'partition' => ['type' => 'VARCHAR', 'constraint' => 3, 'null' => TRUE],
                'mail' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => TRUE],
                'alias' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => TRUE],
                'password' => ['type' => 'VARCHAR', 'constraint' => 254, 'null' => TRUE],
                'hash' => ['type' => 'TEXT', 'null' => TRUE],
                'salt' => ['type' => 'VARCHAR', 'constraint' => 128, 'null' => TRUE],
