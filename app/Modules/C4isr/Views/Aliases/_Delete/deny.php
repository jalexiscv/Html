...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\C4isr\Views\Aliases\Delete\deny.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$continue = "/c4isr/aliases";
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Aliases.delete-denied-title"));
    $smarty->assign("message", lang("Aliases.delete-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "c4isr/aliases-delete-denied-message.mp3");
