...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Aliases.edit-errors-title"));
    $cerrors->assign("message", lang("Aliases.edit-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "c4isr/aliases-edit-errors-message.mp3");
