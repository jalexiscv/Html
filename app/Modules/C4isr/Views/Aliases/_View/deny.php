...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Aliases.view-denied-title"));
    $smarty->assign("message", lang("Aliases.view-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "c4isr/aliases-view-denied-message.mp3");
