...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Aliases.view-errors-title"));
    $smarty->assign("message", lang("Aliases.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "c4isr/aliases-view-errors-message.mp3");
