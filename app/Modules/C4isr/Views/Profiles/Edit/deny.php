...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Profiles.edit-denied-title"));
    $smarty->assign("message", lang("Profiles.edit-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "c4isr/profiles-edit-denied-message.mp3");
