...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Profiles.edit-errors-title"));
    $cerrors->assign("message", lang("Profiles.edit-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "c4isr/profiles-edit-errors-message.mp3");
