...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Vulnerabilities.edit-denied-title"));
    $smarty->assign("message", lang("Vulnerabilities.edit-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "c4isr/vulnerabilities-edit-denied-message.mp3");
