...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\C4isr\Views\Vulnerabilities\Creator\form.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
* -----------------------------------------------------------------------------
*/
$r["vulnerability"] = $f->get_Value("vulnerability");
$r["mail"] = $f->get_Value("mail");
$r["alias"] = $f->get_Value("alias");
$r["password"] = $f->get_Value("password");
$r["hash"] = $f->get_Value("hash");
$r["salt"] = $f->get_Value("salt");
...
$smarty->assign("header", lang("Vulnerabilities.create-title"));
