...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\C4isr\Views\Vulnerabilities\Creator\validator.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
* -----------------------------------------------------------------------------
*/
//$f->set_ValidationRule("vulnerability","trim|required");
//$f->set_ValidationRule("mail","trim|required");
//$f->set_ValidationRule("alias","trim|required");
//$f->set_ValidationRule("password","trim|required");
//$f->set_ValidationRule("hash","trim|required");
//$f->set_ValidationRule("salt","trim|required");
...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Vulnerabilities.create-errors-title"));
    $cerrors->assign("message", lang("Vulnerabilities.create-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "c4isr/vulnerabilities-create-errors-message.mp3");
