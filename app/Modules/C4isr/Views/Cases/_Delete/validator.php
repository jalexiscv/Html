...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Cases.delete-errors-title"));
    $cerrors->assign("message", lang("Cases.delete-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "c4isr/cases-delete-errors-message.mp3");
