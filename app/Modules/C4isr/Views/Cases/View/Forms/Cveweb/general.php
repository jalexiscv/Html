...
$vulnerabilities = array(
    array("value" => "eternalblue", "label" => "EternalBlue"),
    array("value" => "bluekeep", "label" => "BlueKeep"),
    array("value" => "proxylogon", "label" => "ProxyLogon"),
    array("value" => "proxyshell", "label" => "ProxyShell"),
);

$authentications = array(
    array("value" => "ftp", "label" => "File Transfer Protocol(FTP)"),
    array("value" => "rfb", "label" => "Remote Framebuffer(RFB)"),
    array("value" => "vnc", "label" => "Virtual Network Computing(VNC)"),
);


$services = array(
    array("value" => "ssh", "label" => "Secure Shell (SSH)"),
    array("value" => "web", "label" => "Web"),
    array("value" => "ftp", "label" => "File Transfer Protocol (FTP)"),
    array("value" => "mysql", "label" => "MySQL"),
    array("value" => "rdp", "label" => "Remote Desktop Protocol (RDP)"),
    array("value" => "all", "label" => "All Services"),
);


$explores = array(
    array("value" => "", "label" => "[ Seleccione un tipo ]"),
    array("value" => "vulnerability", "label" => "Vulnerabilidad"),
    array("value" => "authentication", "label" => "Autenticación"),
    array("value" => "service", "label" => "Servicio"),
    array("value" => "domain", "label" => "Dominio"),
    array("value" => "ip", "label" => "IP"),
);
...
$f->fields["case"] = $f->get_FieldView("case", array("value" => $r["case"], "proportion" => "col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12", "readonly" => true));
$f->fields["country"] = $f->get_FieldSelect("country", array("selected" => $r["country"], "data" => $countries, "proportion" => "col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12"));
$f->fields["explore"] = $f->get_FieldSelect("explore", array("selected" => $r["explore"], "data" => $explores, "proportion" => "col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12"));
$f->fields["variant"] = $f->get_FieldSelect("variant", array("selected" => $r["variant"], "data" => $variants, "proportion" => "col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12"));
//$f->fields["vulnerability"] = $f->get_FieldSelect("vulnerability", array("selected" => $r["vulnerability"], "data" => $vulnerabilities, "proportion" => "col-xl-3 col-lg-32 col-md-3 col-sm-12 col-12"));
//$f->fields["authentication"] = $f->get_FieldSelect("authentication", array("selected" => $r["authentication"], "data" => $authentications, "proportion" => "col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12"));
//$f->fields["service"] = $f->get_FieldSelect("service", array("selected" => $r["service"], "data" => $services, "proportion" => "col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12"));
$f->fields["domain"] = $f->get_FieldText("domain", array("value" => $r["domain"], "proportion" => "col-xl-4 col-lg-10 col-md-10 col-sm-12 col-12 required"));
$f->fields["submit"] = $f->get_FieldSubmit("submit", array("href" => "/c4isr/cases/edit/" . $oid, "value" => lang("App.Search"), "class" => "btn btn-secondary", "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
//[Groups]-----------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["case"] . $f->fields["country"] . $f->fields["explore"])));
$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["variant"] . $f->fields["domain"] . $f->fields["submit"])));
echo($f);
//[View]------------------------------------------------------------------------------
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div id="mwwinfo">waiting cve...</div>
            </div>
        </div>
    </div>
</div>
