...
//$fgeneral = view('App\Modules\C4isr\Views\Cases\View\Forms\Darkweb\general', $data);
$fexpert = view('App\Modules\C4isr\Views\Cases\View\Forms\Darkweb\expert', $data);

$tabs = array(
    //array("id" => "content", "text" => "General", "content" => $fgeneral, "active" => true),
    array("id" => "attachments", "text" => "Experto", "content" => $fexpert, "active" => true),
);
...
$smarty->assign("header", "DARKWEB/{$oid}");
