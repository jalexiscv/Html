...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Cases.edit-errors-title"));
    $cerrors->assign("message", lang("Cases.edit-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "c4isr/cases-edit-errors-message.mp3");
