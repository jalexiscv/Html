...
//[Groups]-----------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["case"] . $f->fields["reference"] . $f->fields["description"])));
$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["status"] . $f->fields["cover"] . $f->fields["author"])));
...
$smarty->assign("header", lang("Cases.edit-title"));
