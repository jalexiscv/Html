...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Cases.edit-denied-title"));
    $smarty->assign("message", lang("Cases.edit-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "c4isr/cases-edit-denied-message.mp3");
