...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Socials.delete-errors-title"));
    $cerrors->assign("message", lang("Socials.delete-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "c4isr/socials-delete-errors-message.mp3");
