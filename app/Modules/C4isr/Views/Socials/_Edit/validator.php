...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\C4isr\Views\Socials\Editor\validator.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Socials.edit-errors-title"));
    $cerrors->assign("message", lang("Socials.edit-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "c4isr/socials-edit-errors-message.mp3");
