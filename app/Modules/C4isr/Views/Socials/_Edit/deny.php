...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Socials.edit-denied-title"));
    $smarty->assign("message", lang("Socials.edit-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "c4isr/socials-edit-denied-message.mp3");
