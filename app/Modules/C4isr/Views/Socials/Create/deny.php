...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Socials.create-denied-title"));
    $smarty->assign("message", lang("Socials.create-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "c4isr/socials-create-denied-message.mp3");
