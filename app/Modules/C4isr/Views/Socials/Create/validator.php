...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\C4isr\Views\Socials\Creator\validator.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
//$f->set_ValidationRule("married","trim|required");
//$f->set_ValidationRule("religion","trim|required");
...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Socials.create-errors-title"));
    $cerrors->assign("message", lang("Socials.create-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "c4isr/socials-create-errors-message.mp3");
