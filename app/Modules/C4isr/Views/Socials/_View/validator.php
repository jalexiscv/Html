...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Socials.view-errors-title"));
    $smarty->assign("message", lang("Socials.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "c4isr/socials-view-errors-message.mp3");
