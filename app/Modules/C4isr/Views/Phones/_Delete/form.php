...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\C4isr\Views\Phones\Delete\form.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$message = sprintf(lang("Phones.delete-message"), $name);
...
$smarty->assign("header", sprintf(lang("Phones.delete-title"), $name));
$smarty->assign("header_back", $back);
$smarty->assign("message", sprintf(lang("Phones.delete-message"), $name));
$smarty->assign("form", $f);
$smarty->assign("continue", null);
$smarty->assign("voice", "c4isr/phones-delete-errors-message.mp3");
