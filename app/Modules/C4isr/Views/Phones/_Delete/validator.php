...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Phones.delete-errors-title"));
    $cerrors->assign("message", lang("Phones.delete-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "c4isr/phones-delete-errors-message.mp3");
