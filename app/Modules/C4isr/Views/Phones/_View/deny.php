...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Phones.view-denied-title"));
    $smarty->assign("message", lang("Phones.view-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "c4isr/phones-view-denied-message.mp3");
