...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Phones.view-errors-title"));
    $smarty->assign("message", lang("Phones.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "c4isr/phones-view-errors-message.mp3");
