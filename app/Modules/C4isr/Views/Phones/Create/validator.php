...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\C4isr\Views\Phones\Creator\validator.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
//$f->set_ValidationRule("area_code","trim|required");
//$f->set_ValidationRule("local_number","trim|required");
//$f->set_ValidationRule("extension","trim|required");
//$f->set_ValidationRule("type","trim|required");
//$f->set_ValidationRule("carrier","trim|required");
$f->set_ValidationRule("normalized_number", "trim|required|numeric|min_length[7]|max_length[16]");
...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Phones.create-errors-title"));
    $cerrors->assign("message", lang("Phones.create-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "c4isr/phones-create-errors-message.mp3");
