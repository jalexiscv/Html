...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Phones.create-denied-title"));
    $smarty->assign("message", lang("Phones.create-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "c4isr/phones-create-denied-message.mp3");
