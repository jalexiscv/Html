...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Intrusions.edit-denied-title"));
    $smarty->assign("message", lang("Intrusions.edit-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "c4isr/intrusions-edit-denied-message.mp3");
