...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Intrusions.edit-errors-title"));
    $cerrors->assign("message", lang("Intrusions.edit-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "c4isr/intrusions-edit-errors-message.mp3");
