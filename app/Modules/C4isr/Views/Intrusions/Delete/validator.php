...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Intrusions.delete-errors-title"));
    $cerrors->assign("message", lang("Intrusions.delete-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "c4isr/intrusions-delete-errors-message.mp3");
