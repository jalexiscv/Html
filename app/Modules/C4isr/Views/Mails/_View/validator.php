...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Mails.view-errors-title"));
    $smarty->assign("message", lang("Mails.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "c4isr/mails-view-errors-message.mp3");
