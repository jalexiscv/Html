...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Mails.view-denied-title"));
    $smarty->assign("message", lang("Mails.view-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "c4isr/mails-view-denied-message.mp3");
