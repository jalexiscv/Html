...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Mails.delete-errors-title"));
    $cerrors->assign("message", lang("Mails.delete-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "c4isr/mails-delete-errors-message.mp3");
