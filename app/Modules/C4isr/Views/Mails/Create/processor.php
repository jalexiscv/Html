...
$d = array(
    ...
    "email" => $strings->get_URLEncode(preg_replace('/[^A-Za-z0-9@._-]/', '', $f->get_Value("email")),),
...
if (isset($row["mail"])) {
    ...
    $profile = $mprofiles->where('profile', $d["profile"])->first();
    if (!isset($profile["profile"])) {
        $profile = array("profile" => $d["profile"], "firstname" => "", "lastname" => "", "author" => $d["author"]);
