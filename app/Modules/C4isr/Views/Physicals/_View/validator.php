...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Physicals.view-errors-title"));
    $smarty->assign("message", lang("Physicals.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "c4isr/physicals-view-errors-message.mp3");
