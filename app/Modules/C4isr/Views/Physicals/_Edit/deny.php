...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Physicals.edit-denied-title"));
    $smarty->assign("message", lang("Physicals.edit-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "c4isr/physicals-edit-denied-message.mp3");
