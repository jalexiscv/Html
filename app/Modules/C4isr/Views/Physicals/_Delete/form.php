...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\C4isr\Views\Physicals\Delete\form.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$message = sprintf(lang("Physicals.delete-message"), $name);
...
$smarty->assign("header", sprintf(lang("Physicals.delete-title"), $name));
$smarty->assign("header_back", $back);
$smarty->assign("message", sprintf(lang("Physicals.delete-message"), $name));
$smarty->assign("form", $f);
$smarty->assign("continue", null);
$smarty->assign("voice", "c4isr/physicals-delete-errors-message.mp3");
