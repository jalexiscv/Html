...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Physicals.delete-errors-title"));
    $cerrors->assign("message", lang("Physicals.delete-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "c4isr/physicals-delete-errors-message.mp3");
