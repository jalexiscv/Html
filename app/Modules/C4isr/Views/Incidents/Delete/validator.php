...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Incidents.delete-errors-title"));
    $cerrors->assign("message", lang("Incidents.delete-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "c4isr/incidents-delete-errors-message.mp3");
