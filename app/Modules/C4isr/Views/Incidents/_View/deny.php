...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Incidents.view-denied-title"));
    $smarty->assign("message", lang("Incidents.view-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "c4isr/incidents-view-denied-message.mp3");
