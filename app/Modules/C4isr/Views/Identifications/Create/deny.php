...
$continue = "/c4isr/profiles/edit/{$oid}";
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Identifications.create-denied-title"));
    $smarty->assign("message", lang("Identifications.create-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "c4isr/identifications-create-denied-message.mp3");
