...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\C4isr\Views\Identifications\Creator\validator.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
* -----------------------------------------------------------------------------
*/
$f->set_ValidationRule("identification", "trim|required");
...
$f->set_ValidationRule("number", "trim|required");
...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Identifications.create-errors-title"));
    $cerrors->assign("message", lang("Identifications.create-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "c4isr/identifications-create-errors-message.mp3");
