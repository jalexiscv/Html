...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Identifications.edit-denied-title"));
    $smarty->assign("message", lang("Identifications.edit-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "c4isr/identifications-edit-denied-message.mp3");
