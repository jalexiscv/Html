...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Identifications.view-errors-title"));
    $smarty->assign("message", lang("Identifications.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "c4isr/identifications-view-errors-message.mp3");
