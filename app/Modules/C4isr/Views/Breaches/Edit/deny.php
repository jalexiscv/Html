...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Breaches.edit-denied-title"));
    $smarty->assign("message", lang("Breaches.edit-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "c4isr/breaches-edit-denied-message.mp3");
