...
$continue = "/c4isr/breaches/list/{$d["domain"]}/";
$edit = "/c4isr/breaches/edit/{$d["breach"]}/";
$asuccess = "c4isr/breaches-edit-success-message.mp3";
$anoexist = "c4isr/breaches-edit-noexist-message.mp3";
//[Build]-----------------------------------------------------------------------------
if (isset($row["breach"])) {
    ...
    $smarty->assign("title", lang("Breaches.edit-success-title"));
    $smarty->assign("message", sprintf(lang("Breaches.edit-success-message"), $d['breach']));
    ...
    $smarty = service("smarty");
    $smarty->set_Mode("bs5x");
    $smarty->assign("title", lang("Breaches.edit-noexist-title"));
    $smarty->assign("message", lang("Breaches.edit-noexist-message"));
    $smarty->assign("continue", $continue);
