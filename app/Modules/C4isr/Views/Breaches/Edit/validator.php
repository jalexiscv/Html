...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Breaches.edit-errors-title"));
    $cerrors->assign("message", lang("Breaches.edit-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "c4isr/breaches-edit-errors-message.mp3");
