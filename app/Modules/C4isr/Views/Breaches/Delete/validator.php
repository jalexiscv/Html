...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Breaches.delete-errors-title"));
    $cerrors->assign("message", lang("Breaches.delete-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "c4isr/breaches-delete-errors-message.mp3");
