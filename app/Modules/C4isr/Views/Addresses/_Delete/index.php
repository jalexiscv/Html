...
* -----------------------------------------------------------------------------
*  ╔═╗╔╗╔╔═╗╔═╗╦╔╗ ╦  ╔═╗
*  ╠═╣║║║╚═╗╚═╗║╠╩╗║  ║╣  [FRAMEWORK][App\Modules\C4isr\Views\Addresses\Delete\index.php]
*  ╩ ╩╝╚╝╚═╝╚═╝╩╚═╝╩═╝╚═╝
* -----------------------------------------------------------------------------
...
$data['model'] = model("App\Modules\C4isr\Models\C4isr_Addresses");
$data['permissions'] = array('singular' => 'c4isr-addresses-delete', "plural" => 'c4isr-addresses-delete-all');
