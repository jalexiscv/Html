...
if ($f->run_Validation()) {
    ...
    $cerrors->assign("title", lang("Addresses.delete-errors-title"));
    $cerrors->assign("message", lang("Addresses.delete-errors-message"));
    $cerrors->assign("errors", $errors);
    $cerrors->assign("continue", null);
    $cerrors->assign("voice", "c4isr/addresses-delete-errors-message.mp3");
