...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Addresses.create-denied-title"));
    $smarty->assign("message", lang("Addresses.create-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "c4isr/addresses-create-denied-message.mp3");
