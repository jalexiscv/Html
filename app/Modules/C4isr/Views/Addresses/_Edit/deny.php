...
if ($authentication->get_LoggedIn()) {
    $smarty->assign("title", lang("Addresses.edit-denied-title"));
    $smarty->assign("message", lang("Addresses.edit-denied-message"));
    $smarty->assign("permissions", $permissions);
    $smarty->assign("continue", $continue);
    $smarty->assign("voice", "c4isr/addresses-edit-denied-message.mp3");
