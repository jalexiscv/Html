...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Addresses.view-errors-title"));
    $smarty->assign("message", lang("Addresses.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "c4isr/addresses-view-errors-message.mp3");
