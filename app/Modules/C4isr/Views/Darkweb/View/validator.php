...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Darkweb.view-errors-title"));
    $smarty->assign("message", lang("Darkweb.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "c4isr/darkweb-view-errors-message.mp3");
