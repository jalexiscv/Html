...
namespace Higgs\Validation\StrictRules;

use Higgs\Helpers\Array\ArrayHelper;
use Higgs\Validation\Rules as NonStrictRules;
use Config\Database;

/**
 * Validation Rules.
 *
 * @see \Higgs\Validation\StrictRules\RulesTest
 */
class Rules
{
